import { unsafeCSS as k, css as V, LitElement as H, html as h, nothing as u } from "lit";
import { BreakpointM as E, BreakpointL as W1, BreakpointXl as J2, BreakpointXs as yt, BreakpointS as wt, BreakpointXxl as _t } from "@ct-infra/tokens";
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const U1 = globalThis, m2 = U1.ShadowRoot && (U1.ShadyCSS === void 0 || U1.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Y2 = Symbol(), A2 = /* @__PURE__ */ new WeakMap();
let kt = class {
  constructor(t, r, o) {
...
const $t = (e) => new kt(typeof e == "string" ? e : e + "", void 0, Y2), xt = (e, t) => {
  if (m2) e.adoptedStyleSheets = t.map((r) => r instanceof CSSStyleSheet ? r : r.styleSheet);
...
}, z2 = m2 ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let r = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ht, defineProperty: Mt, getOwnPropertyDescriptor: Lt, getOwnPropertyNames: Vt, getOwnPropertySymbols: St, getPrototypeOf: Zt } = Object, o1 = globalThis, P2 = o1.trustedTypes, At = P2 ? P2.emptyScript : "", s2 = o1.reactiveElementPolyfillSupport, A1 = (e, t) => e, G1 = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? At : null;
      break;
  ...
  return r;
} }, b2 = (e, t) => !Ht(e, t), O2 = { attribute: !0, type: String, converter: G1, reflect: !1, useDefault: !1, hasChanged: b2 };
...
let x1 = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, r, o) {
    const { get: i, set: a } = Lt(this.prototype, t) ?? { get() {
      return this[r];
    }, set(n) {
      this[r] = n;
    } };
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? O2;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(A1("properties"))) {
      const r = this.properties, o = [...Vt(r), ...St(r)];
  ...
  _$AK(t, r) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const l = o.getPropertyOptions(i), s = typeof l.converter == "function" ? { fromAttribute: l.converter } : ((a = l.converter) == null ? void 0 : a.fromAttribute) !== void 0 ? l.converter : G1;
      this._$Em = i;
  ...
  requestUpdate(t, r, o, i = !1, a) {
    ...
    if (t !== void 0) {
      ...
      if (i === !1 && (a = this[t]), o ?? (o = l.getPropertyOptions(t)), !((o.hasChanged ?? b2)(a, r) || o.useDefault && o.reflect && a === ((n = this._$Ej) == null ? void 0 : n.get(t)) && !this.hasAttribute(l._$Eu(t, o)))) return;
      this.C(t, r, o);
    }
...
x1.elementStyles = [], x1.shadowRootOptions = { mode: "open" }, x1[A1("elementProperties")] = /* @__PURE__ */ new Map(), x1[A1("finalized")] = /* @__PURE__ */ new Map(), s2 == null || s2({ ReactiveElement: x1 }), (o1.reactiveElementVersions ?? (o1.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const zt = { attribute: !0, type: String, converter: G1, reflect: !1, hasChanged: b2 }, Pt = (e = zt, t, r) => {
...
function c(e) {
  return (t, r) => typeof r == "object" ? Pt(e, t, r) : ((o, i, a) => {
    const n = i.hasOwnProperty(a);
    return i.constructor.createProperty(a, o), n ? Object.getOwnPropertyDescriptor(i, a) : void 0;
  })(e, t, r);
}
var Ot = Object.defineProperty, Et = Object.getOwnPropertyDescriptor, B1 = (e, t, r, o) => {
...
var Tt = Object.defineProperty, Bt = Object.getOwnPropertyDescriptor, Q2 = (e, t, r, o) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const z1 = globalThis, E2 = (e) => e, K1 = z1.trustedTypes, T2 = K1 ? K1.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, rt = "$lit$", r1 = `lit$${Math.random().toFixed(9).slice(2)}$`, ot = "?" + r1, Dt = `<${ot}>`, d1 = document, X1 = () => d1.createComment(""), P1 = (e) => e === null || typeof e != "object" && typeof e != "function", f2 = Array.isArray, jt = (e) => f2(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", l2 = `[ 	
\f\r]`, H1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, B2 = /-->/g, I2 = />/g, c1 = RegExp(`>|${l2}(?:([^\\s"'>=/]+)(${l2}*=${l2}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), D2 = /'/g, j2 = /"/g, it = /^(?:script|style|textarea|title)$/i, Nt = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), Rt = Nt(1), C1 = Symbol.for("lit-noChange"), $ = Symbol.for("lit-nothing"), N2 = /* @__PURE__ */ new WeakMap(), l1 = d1.createTreeWalker(d1, 129);
function at(e, t) {
  if (!f2(e) || !e.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return T2 !== void 0 ? T2.createHTML(t) : t;
}
const qt = (e, t) => {
  const r = e.length - 1, o = [];
  let i, a = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", n = H1;
  for (let l = 0; l < r; l++) {
    const s = e[l];
    let C, b, m = -1, v = 0;
    for (; v < s.length && (n.lastIndex = v, b = n.exec(s), b !== null); ) v = n.lastIndex, n === H1 ? b[1] === "!--" ? n = B2 : b[1] !== void 0 ? n = I2 : b[2] !== void 0 ? (it.test(b[2]) && (i = RegExp("</" + b[2], "g")), n = c1) : b[3] !== void 0 && (n = c1) : n === c1 ? b[0] === ">" ? (n = i ?? H1, m = -1) : b[1] === void 0 ? m = -2 : (m = n.lastIndex - b[2].length, C = b[1], n = b[3] === void 0 ? c1 : b[3] === '"' ? j2 : D2) : n === j2 || n === D2 ? n = c1 : n === B2 || n === I2 ? n = H1 : (n = c1, i = void 0);
    const g = n === c1 && e[l + 1].startsWith("/>") ? " " : "";
    a += n === H1 ? s + Dt : m >= 0 ? (o.push(C), s.slice(0, m) + rt + s.slice(m) + r1 + g) : s + r1 + (m === -2 ? l : g);
  }
  return [at(e, a + (e[r] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), o];
};
class O1 {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    this.parts = [];
    let a = 0, n = 0;
    const l = t.length - 1, s = this.parts, [C, b] = qt(t, r);
    if (this.el = O1.createElement(C, o), l1.currentNode = this.el.content, r === 2 || r === 3) {
    ...
    for (; (i = l1.nextNode()) !== null && s.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const m of i.getAttributeNames()) if (m.endsWith(rt)) {
          const v = b[n++], g = i.getAttribute(m).split(r1), S = /([.?@])?(.*)/.exec(v);
          s.push({ type: 1, index: a, name: S[2], strings: g, ctor: S[1] === "." ? Wt : S[1] === "?" ? Gt : S[1] === "@" ? Ft : o2 }), i.removeAttribute(m);
        } else m.startsWith(r1) && (s.push({ type: 6, index: a }), i.removeAttribute(m));
        if (it.test(i.tagName)) {
          const m = i.textContent.split(r1), v = m.length - 1;
          if (v > 0) {
            i.textContent = K1 ? K1.emptyScript : "";
            for (let g = 0; g < v; g++) i.append(m[g], X1()), l1.nextNode(), s.push({ type: 2, index: ++a });
            i.append(m[v], X1());
          }
        }
      } else if (i.nodeType === 8) if (i.data === ot) s.push({ type: 2, index: a });
      else {
        let m = -1;
        for (; (m = i.data.indexOf(r1, m + 1)) !== -1; ) s.push({ type: 7, index: a }), m += r1.length - 1;
      }
      a++;
    }
  }
  static createElement(t, r) {
    const o = d1.createElement("template");
    return o.innerHTML = t, o;
  }
}
function w1(e, t, r = e, o) {
  var n, l;
  if (t === C1) return t;
  let i = o !== void 0 ? (n = r._$Co) == null ? void 0 : n[o] : r._$Cl;
  const a = P1(t) ? void 0 : t._$litDirective$;
  return (i == null ? void 0 : i.constructor) !== a && ((l = i == null ? void 0 : i._$AO) == null || l.call(i, !1), a === void 0 ? i = void 0 : (i = new a(e), i._$AT(e, r, o)), o !== void 0 ? (r._$Co ?? (r._$Co = []))[o] = i : r._$Cl = i), i !== void 0 && (t = w1(e, i._$AS(e, t.values), i, o)), t;
}
class Ut {
  constructor(t, r) {
  ...
  u(t) {
    const { el: { content: r }, parts: o } = this._$AD, i = ((t == null ? void 0 : t.creationScope) ?? d1).importNode(r, !0);
    l1.currentNode = i;
    let a = l1.nextNode(), n = 0, l = 0, s = o[0];
    for (; s !== void 0; ) {
      if (n === s.index) {
        let C;
        s.type === 2 ? C = new r2(a, a.nextSibling, this, t) : s.type === 1 ? C = new s.ctor(a, s.name, s.strings, this, t) : s.type === 6 && (C = new Kt(a, this, t)), this._$AV.push(C), s = o[++l];
      }
...
class r2 {
  ...
  _$AI(t, r = this) {
    t = w1(this, t, r), P1(t) ? t === $ || t == null || t === "" ? (this._$AH !== $ && this._$AR(), this._$AH = $) : t !== this._$AH && t !== C1 && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : jt(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== $ && P1(this._$AH) ? this._$AA.nextSibling.data = t : this.T(d1.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var a;
    const { values: r, _$litType$: o } = t, i = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = O1.createElement(at(o.h, o.h[0]), this.options)), o);
  ...
  _$AC(t) {
    let r = N2.get(t.strings);
    return r === void 0 && N2.set(t.strings, r = new O1(t)), r;
  }
  k(t) {
    f2(this._$AH) || (this._$AH = [], this._$AR());
    const r = this._$AH;
    let o, i = 0;
    for (const a of t) i === r.length ? r.push(o = new r2(this.O(X1()), this.O(X1()), this, this.options)) : o = r[i], o._$AI(a), i++;
    i < r.length && (this._$AR(o && o._$AB.nextSibling, i), r.length = i);
  }
  _$AR(t = this._$AA.nextSibling, r) {
    var o;
    for ((o = this._$AP) == null ? void 0 : o.call(this, !1, !0, r); t !== this._$AB; ) {
      const i = E2(t).nextSibling;
      E2(t).remove(), t = i;
    }
  }
  setConnected(t) {
...
class o2 {
  ...
  _$AI(t, r = this, o, i) {
    ...
    let n = !1;
    if (a === void 0) t = w1(this, t, r, 0), n = !P1(t) || t !== this._$AH && t !== C1, n && (this._$AH = t);
    else {
      const l = t;
      let s, C;
      for (t = a[0], s = 0; s < a.length - 1; s++) C = w1(this, l[o + s], r, s), C === C1 && (C = this._$AH[s]), n || (n = !P1(C) || C !== this._$AH[s]), C === $ ? t = $ : t !== $ && (t += (C ?? "") + a[s + 1]), this._$AH[s] = C;
    }
    n && !i && this.j(t);
  }
  j(t) {
...
const h2 = z1.litHtmlPolyfillSupport;
h2 == null || h2(O1, r2), (z1.litHtmlVersions ?? (z1.litHtmlVersions = [])).push("3.3.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
let J1 = class extends et {
  constructor(t) {
...
const Jt = v2(C2);
var Yt = Object.defineProperty, Qt = Object.getOwnPropertyDescriptor, i2 = (e, t, r, o) => {
  for (var i = o > 1 ? void 0 : o ? Qt(t, r) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (i = (o ? n(t, r, i) : n(i)) || i);
  return o && i && Yt(t, r, i), i;
};
let _1 = class extends H {
  ...
  render() {
    const e = this.name ? It[this.name] : void 0;
    if (!e)
      return u;
...
var t9 = Object.defineProperty, e9 = Object.getOwnPropertyDescriptor, y2 = (e, t, r, o) => {
 ...
 */
const x = (e) => e ?? $;
var r9 = Object.defineProperty, o9 = Object.getOwnPropertyDescriptor, T = (e, t, r, o) => {
...
var i9 = Object.defineProperty, a9 = Object.getOwnPropertyDescriptor, Q = (e, t, r, o) => {
...
var n9 = Object.defineProperty, c9 = Object.getOwnPropertyDescriptor, i1 = (e, t, r, o) => {
...
var s9 = Object.defineProperty, l9 = Object.getOwnPropertyDescriptor, I1 = (e, t, r, o) => {
...
let p1 = class extends H {
  ...
  render() {
    if (!this.content)
      return u;
    const e = this.type in R2 ? this.type : "information", t = R2[e], r = {
      "ct-field-message": !0,
      [`ct-theme-${this.theme}`]: !0,
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const nt = Symbol.for(""), h9 = (e) => {
  if ((e == null ? void 0 : e.r) === nt) return e == null ? void 0 : e._$litStatic$;
}, ct = (e) => ({ _$litStatic$: e, r: nt }), q2 = /* @__PURE__ */ new Map(), d9 = (e) => (t, ...r) => {
  const o = r.length;
  let i, a;
  const n = [], l = [];
  let s, C = 0, b = !1;
  for (; C < o; ) {
    for (s = t[C]; C < o && (a = r[C], (i = h9(a)) !== void 0); ) s += i + t[++C], b = !0;
    C !== o && l.push(a), n.push(s), C++;
  }
  if (C === o && n.push(t[o]), b) {
    const m = n.join("$$lit$$");
    (t = q2.get(m)) === void 0 && (n.raw = n, q2.set(m, t = n)), r = l;
  }
  return e(t, ...r);
}, p2 = d9(Rt);
var C9 = Object.defineProperty, p9 = Object.getOwnPropertyDescriptor, D1 = (e, t, r, o) => {
  for (var i = o > 1 ? void 0 : o ? p9(t, r) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (i = (o ? n(t, r, i) : n(i)) || i);
  return o && i && C9(t, r, i), i;
};
const g9 = ["1", "2", "3", "4", "5", "6"];
let g1 = class extends H {
  constructor() {
    super(...arguments), this.theme = "light", this.content = "", this.level = "2", this.modifierClass = "";
  }
  render() {
    const e = g9.includes(this.level) ? this.level : "2", t = ct(`h${e}`), r = {
      "ct-heading": !0,
      [`ct-theme-${this.theme}`]: !0,
      [`ct-heading--level-${e}`]: !0,
      [this.modifierClass]: !!this.modifierClass
    };
    return this.content ? p2`<${t} class=${L(r)} data-component-name="heading">${this.content}<slot></slot></${t}>` : u;
  }
};
g1.styles = V`
    :host {
...
var u9 = Object.defineProperty, m9 = Object.getOwnPropertyDescriptor, u1 = (e, t, r, o) => {
  for (var i = o > 1 ? void 0 : o ? m9(t, r) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (i = (o ? n(t, r, i) : n(i)) || i);
...
var b9 = Object.defineProperty, v9 = Object.getOwnPropertyDescriptor, t1 = (e, t, r, o) => {
...
let N = class extends H {
  ...
  render() {
    ...
    const e = this.tag === "legend" ? "legend" : "label", t = {
      ...
      [this.modifierClass]: !!this.modifierClass
    }, r = this.required ? p2`<span class="ct-label__required">${this.requiredText}</span>` : u, o = ct(e);
    return p2`
      <${o}
        class=${L(t)}
...
var f9 = Object.defineProperty, y9 = Object.getOwnPropertyDescriptor, B = (e, t, r, o) => {
...
var w9 = Object.defineProperty, _9 = Object.getOwnPropertyDescriptor, G = (e, t, r, o) => {
...
var k9 = Object.defineProperty, $9 = Object.getOwnPropertyDescriptor, a2 = (e, t, r, o) => {
...
var S1 = (e, t = []) => ({
  ...
  extendWith: (...r) => S1(e, [...t, ...r]),
  omit: (...r) => S1(e, t.filter((o) => !r.includes(o))),
  rename: (r) => S1(r, t),
  keys: () => t,
  build: () => [...new Set(t)].reduce(
    (r, o) => Object.assign(r, {
      [o]: {
        selector: [
          `&[data-scope="${y1(e)}"][data-part="${y1(o)}"]`,
          `& [data-scope="${y1(e)}"][data-part="${y1(o)}"]`
        ].join(", "),
        attrs: { "data-scope": y1(e), "data-part": y1(o) }
      }
    }),
    {}
  )
}), y1 = (e) => e.replace(/([A-Z])([A-Z])/g, "$1-$2").replace(/([a-z])([A-Z])/g, "$1-$2").replace(/[\s_]+/g, "-").toLowerCase(), x9 = (e) => e.length === 0, H9 = S1("accordion").parts("root", "item", "itemTrigger", "itemContent", "itemIndicator"), M1 = H9.build(), st = (e) => typeof e == "object" && e !== null, s1 = (e) => e ? "" : void 0, M9 = 9, L9 = (e) => st(e) && e.nodeType === M9, V9 = (e) => st(e) && e === e.window;
function S9(e) {
  if (!e) return !1;
...
function Z9(e) {
  return L9(e) ? e : V9(e) ? e.document : (e == null ? void 0 : e.ownerDocument) ?? document;
}
function lt(e) {
...
var w2 = (e) => ht() && e.test(A9()), z9 = (e) => ht() && e.test(navigator.vendor), P9 = () => w2(/^iPhone/i), O9 = () => w2(/^iPad/i) || dt() && navigator.maxTouchPoints > 1, E9 = () => P9() || O9(), T9 = () => dt() || E9(), dt = () => w2(/^Mac/i), B9 = () => T9() && z9(/apple/i), I9 = {
  Up: "ArrowUp",
  Down: "ArrowDown",
  Esc: "Escape",
  " ": "Space",
...
function D9(e, t = {}) {
  ...
  let i = e.key;
  return i = I9[i] ?? i, r === "rtl" && o === "horizontal" && i in U2 && (i = U2[i]), i;
}
function j9(e, t) {
  return Array.from((e == null ? void 0 : e.querySelectorAll(t)) ?? []);
}
var Ct = (e) => e.id;
function N9(e, t, r = Ct) {
  return e.find((o) => r(o) === t);
}
function pt(e, t, r = Ct) {
  const o = N9(e, t, r);
...
var W9 = (e) => e[0], G9 = (e) => e[e.length - 1], F9 = (e, ...t) => e.concat(t), K9 = (e, ...t) => e.filter((r) => !t.includes(r)), X9 = (e) => typeof e == "string", L1 = (e) => typeof e == "function", J9 = Function.prototype.toString;
J9.call(Object);
var W2 = (...e) => (...t) => {
...
}, t0 = (e) => e.getById(Y1(e)), n2 = (e) => {
  const r = `[data-controls][data-ownedby='${CSS.escape(Y1(e))}']:not([disabled])`;
  return j9(t0(e), r);
}, e0 = (e) => W9(n2(e)), r0 = (e) => G9(n2(e)), o0 = (e, t) => R9(n2(e), Q1(e, t)), i0 = (e, t) => q9(n2(e), Q1(e, t));
function a0(e, t) {
  ...
  return {
    ...
    getItemTriggerProps(v) {
      ...
      return t.button({
        ...
        dir: i("dir"),
        id: Q1(a, g),
        "aria-controls": d2(a, g),
        "data-controls": d2(a, g),
        ...
        onClick(F) {
          S.disabled || (B9() && F.currentTarget.focus(), r({ type: "TRIGGER.CLICK", value: g }));
        },
        onKeyDown(F) {
...
var a1 = ".", ut = "#", F2 = /* @__PURE__ */ new WeakMap(), mt = /* @__PURE__ */ new WeakMap();
function g2(e) {
  return e.join(a1);
}
function n0(e) {
...
function s0(e) {
  return bt(e) ? e.slice(ut.length) : e;
}
function u2(e, t) {
  return e ? `${e}${a1}${t}` : t;
}
function l0(e) {
  const t = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map(), o = (i, a) => {
    t.set(i, a);
    const n = a.id;
    n && (r.has(n) && G2(`[zag-js] Duplicate state id: "${n}"`), r.set(n, i));
    const l = a.states;
    if (l) {
      gt(a.initial, () => `[zag-js] Compound state "${i}" has child states but no "initial" property`), a.initial in l || G2(
...
function j1(e) {
  const t = F2.get(e);
  if (t) return t;
  const { index: r, idIndex: o } = l0(e);
  return F2.set(e, r), mt.set(e, o), r;
}
function h0(e, t) {
  var r;
  return j1(e), (r = mt.get(e)) == null ? void 0 : r.get(t);
}
function _2(e) {
...
function t2(e, t) {
  if (!t) return [];
  const r = j1(e), o = _2(t), i = [], a = [];
  for (const n of o) {
    a.push(n);
    const l = g2(a), s = r.get(l);
    if (!s) break;
...
function X2(e, t, r) {
  const o = String(t);
  if (bt(o)) {
    const i = s0(o), a = h0(e, i);
    return gt(a, () => `[zag-js] Unknown state id: "${i}"`), V1(e, a);
  }
  if (c0(o) && r) {
    const i = u2(r, o.slice(1));
    return V1(e, i);
  }
  if (!n0(o) && r) {
    const i = _2(r);
    for (let a = i.length - 1; a >= 1; a--) {
      const n = i.slice(0, a).join(a1), l = u2(n, o);
      if (K2(e, l)) return V1(e, l);
    }
    if (K2(e, o)) return V1(e, o);
  }
  return V1(e, o);
}
function d0(e, t, r) {
...
var Z1 = /* @__PURE__ */ ((e) => (e.NotStarted = "Not Started", e.Started = "Started", e.Stopped = "Stopped", e))(Z1 || {}), q1 = "__init__";
function b0(e) {
  const t = () => {
    var n;
  ...
  return {
    ...
    getActiveElement: () => lt(t()),
    isActiveElement: S9,
    getById: (n) => t().getElementById(n)
  };
}
var { and: v0, not: f0 } = u0(), y0 = m0({
  props({ props: e }) {
    return {
      collapsible: !1,
      multiple: !1,
  ...
  implementations: {
    ...
    actions: {
      collapse({ context: e, prop: t, event: r }) {
        const o = t("multiple") ? K9(e.get("value"), r.value) : [];
        e.set("value", o);
      },
      expand({ context: e, prop: t, event: r }) {
        const o = t("multiple") ? F9(e.get("value"), r.value) : [r.value];
        e.set("value", o);
      },
      ...
      coarseValue({ context: e, prop: t }) {
        !t("multiple") && e.get("value").length > 1 && (Y9("The value of accordion should be a single value when multiple is false."), e.set("value", [e.get("value")[0]]));
      }
    }
  }
});
...
function _0(e, t, r) {
  ...
  function l(p) {
    const d = p(), _ = d.isEqual ?? ((y, f) => y === f), Z = d.hash ?? ((y) => String(y)), A = { current: d.value !== void 0 ? d.value : d.defaultValue };
    return {
      ...
      set(y) {
        var $1;
        const f = A.current, w = L1(y) ? y(f) : y;
        _(w, f) || (A.current = w, ($1 = d.onChange) == null || $1.call(d, w, f), r());
      },
      invoke(y, f) {
        var w;
  ...
  const s = (L2 = o.context) == null ? void 0 : L2.call(o, {
    prop: n,
    bindable: l,
    scope: a,
    flush: (p) => p(),
  ...
  const m = { current: null }, v = { current: null }, g = { current: { type: "" } }, S = () => ({
    ...
    get: () => e1.get(),
    matches: (...p) => p.some((d) => p0(e1.get(), d)),
    hasTag: (p) => g0(o, e1.get(), p)
  }), f1 = ((V2 = o.refs) == null ? void 0 : V2.call(o, { prop: n, context: C })) ?? {}, R = () => ({
    state: F(),
    context: C,
    event: S(),
    prop: n,
    ...
    if (d)
      for (const A of d) {
        const y = (Z = (_ = o.implementations) == null ? void 0 : _.actions) == null ? void 0 : Z[A];
        y == null || y(R());
      }
  }, $2 = (p) => {
    var d, _, Z;
    return L1(p) ? p(R()) : (Z = (_ = (d = o.implementations) == null ? void 0 : d.guards) == null ? void 0 : _[p]) == null ? void 0 : Z.call(_, R());
  }, x2 = (p) => {
    var Z, A;
    const d = L1(p) ? p(R()) : p;
    if (!d) return;
    const _ = [];
    for (const y of d) {
      const f = (A = (Z = o.implementations) == null ? void 0 : Z.effects) == null ? void 0 : A[y], w = f == null ? void 0 : f(R());
      w && _.push(w);
    }
    return () => _.forEach((y) => y == null ? void 0 : y());
  }, H2 = (p) => U9(p).find((d) => d != null && d.guard ? X9(d.guard) ? !!$2(d.guard) : L1(d.guard) ? d.guard(R()) : !1 : !0), N1 = (p) => {
    var _;
    const d = (_ = o.computed) == null ? void 0 : _[p];
    return d == null ? void 0 : d({ context: C, event: S(), prop: n, refs: f1, scope: a, computed: N1 });
  }, e1 = l(() => ({
    defaultValue: X2(o, o.initialState({ prop: n })),
    onChange(p, d) {
      var A, y;
      const { exiting: _, entering: Z } = C0(o, d, p, (A = m.current) == null ? void 0 : A.reenter);
      if (_.forEach((f) => {
        var w;
        (w = b.get(f.path)) == null || w(), b.delete(f.path);
      }), _.forEach((f) => {
        var w;
        return q((w = f.state) == null ? void 0 : w.exit);
      }), q((y = m.current) == null ? void 0 : y.actions), Z.forEach((f) => {
        var $1;
        const w = x2(($1 = f.state) == null ? void 0 : $1.effects);
        if (w) {
          const Z2 = b.get(f.path);
          b.set(f.path, Z2 ? W2(Z2, w) : w);
        }
      }), d === q1) {
        q(o.entry);
        const f = x2(o.effects);
        if (f) {
          const w = b.get(q1);
          b.set(q1, w ? W2(w, f) : f);
        }
  ...
  let R1 = Z1.NotStarted;
  function vt() {
    R1 = Z1.Started, e1.invoke(e1.initial, q1);
  }
  function ft() {
    R1 = Z1.Stopped, b.forEach((p) => p == null ? void 0 : p()), b = /* @__PURE__ */ new Map(), m.current = null, q(o.exit);
  }
  const M2 = (p) => {
    if (R1 !== Z1.Started) return;
    v.current = g.current, g.current = p;
    const d = e1.get(), { transitions: _, source: Z } = d0(o, d, p.type), A = H2(_);
    if (!A) return;
    m.current = A;
    const y = X2(o, A.target ?? d, Z);
    y !== d ? e1.set(y) : A.reenter ? e1.invoke(d, d) : q(A.actions);
  };
  return (S2 = o.watch) == null || S2.call(o, R()), {
    state: F(),
    send: M2,
    get event() {
      return S();
...
const k0 = w0((e) => e);
var $0 = Object.defineProperty, x0 = Object.getOwnPropertyDescriptor, m1 = (e, t, r, o) => {
  for (var i = o > 1 ? void 0 : o ? x0(t, r) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (i = (o ? n(t, r, i) : n(i)) || i);
  return o && i && $0(t, r, i), i;
};
let H0 = 0;
const M0 = h`
...
let X = class extends H {
  ...
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `ct-accordion-${++H0}`);
  ...
  render() {
    ...
    if (e.forEach((i, a) => {
      ...
      return u;
    const t = a0(this._accordionService, k0), r = t.getRootProps(), o = {
      "ct-accordion": !0,
      [`ct-theme-${this.theme}`]: !0,
...
var L0 = Object.defineProperty, V0 = Object.getOwnPropertyDescriptor, n1 = (e, t, r, o) => {
...
var S0 = Object.defineProperty, Z0 = Object.getOwnPropertyDescriptor, b1 = (e, t, r, o) => {
...
var A0 = Object.defineProperty, z0 = Object.getOwnPropertyDescriptor, v1 = (e, t, r, o) => {
  for (var i = o > 1 ? void 0 : o ? z0(t, r) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (i = (o ? n(t, r, i) : n(i)) || i);
  return o && i && A0(t, r, i), i;
};
const P0 = ["top", "bottom", "both", "none"];
let Y = class extends H {
  ...
  render() {
    if (!this.content)
      return u;
    const e = this.theme === "dark" ? "dark" : "light", t = P0.includes(this.verticalSpacing) ? this.verticalSpacing : "", r = {
      "ct-basic-content": !0,
      [`ct-theme-${e}`]: !0,
...
var O0 = Object.defineProperty, E0 = Object.getOwnPropertyDescriptor, k2 = (e, t, r, o) => {
...
var T0 = Object.defineProperty, B0 = Object.getOwnPropertyDescriptor, c2 = (e, t, r, o) => {
  for (var i = o > 1 ? void 0 : o ? B0(t, r) : t, a = e.length - 1, n; a >= 0; a--)
    (n = e[a]) && (i = (o ? n(t, r, i) : n(i)) || i);
  return o && i && T0(t, r, i), i;
};
let k1 = class extends H {
  constructor() {
...
var I0 = Object.defineProperty, D0 = Object.getOwnPropertyDescriptor, I = (e, t, r, o) => {
...
let O = class extends H {
  ...
  render() {
    ...
    `;
    return this.url ? h`
        <a class=${L(r)} href=${this.url} title=${x(this.title)}>
          ${i}
        </a>
