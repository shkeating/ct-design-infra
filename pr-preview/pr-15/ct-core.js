import { unsafeCSS as H1, css as R, LitElement as P, html as f, nothing as $ } from "lit";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Q2, defineProperty: Y2, getOwnPropertyDescriptor: t9, getOwnPropertyNames: e9, getOwnPropertySymbols: r9, getPrototypeOf: i9 } = Object, D = globalThis, C2 = D.trustedTypes, o9 = C2 ? C2.emptyScript : "", z1 = D.reactiveElementPolyfillSupport, h1 = (e, t) => e, M1 = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? o9 : null;
      break;
...
let n1 = class extends HTMLElement {
  ...
  _$AK(t, r) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      ...
      this._$Em = o;
      const d = s.fromAttribute(r, C.type);
...
n1.elementStyles = [], n1.shadowRootOptions = { mode: "open" }, n1[h1("elementProperties")] = /* @__PURE__ */ new Map(), n1[h1("finalized")] = /* @__PURE__ */ new Map(), z1 == null || z1({ ReactiveElement: n1 }), (D.reactiveElementVersions ?? (D.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var s9 = Object.defineProperty, C9 = Object.getOwnPropertyDescriptor, w1 = (e, t, r, i) => {
...
var d9 = Object.defineProperty, h9 = Object.getOwnPropertyDescriptor, q1 = (e, t, r, i) => {
  for (var o = i > 1 ? void 0 : i ? h9(t, r) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (i ? a(t, r, o) : a(o)) || o);
  return i && o && d9(t, r, o), o;
};
...
var p9 = Object.defineProperty, g9 = Object.getOwnPropertyDescriptor, E1 = (e, t, r, i) => {
...
E1([
  c({ type: String })
], u1.prototype, "heading", 2);
E1([
  c({ type: Boolean })
], u1.prototype, "expanded", 2);
E1([
  c({ type: Boolean })
], u1.prototype, "disabled", 2);
u1 = E1([
  O("ct-accordion-item")
], u1);
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const p1 = globalThis, l2 = (e) => e, L1 = p1.trustedTypes, d2 = L1 ? L1.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, V2 = "$lit$", U = `lit$${Math.random().toFixed(9).slice(2)}$`, L2 = "?" + U, u9 = `<${L2}>`, X = document, k1 = () => X.createComment(""), v1 = (e) => e === null || typeof e != "object" && typeof e != "function", K1 = Array.isArray, v9 = (e) => K1(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", I1 = `[ 	
\f\r]`, a1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, h2 = /-->/g, p2 = />/g, G = RegExp(`>|${I1}(?:([^\\s"'>=/]+)(${I1}*=${I1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), g2 = /'/g, u2 = /"/g, k2 = /^(?:script|style|textarea|title)$/i, f9 = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), w9 = f9(1), J = Symbol.for("lit-noChange"), _ = Symbol.for("lit-nothing"), v2 = /* @__PURE__ */ new WeakMap(), q = X.createTreeWalker(X, 129);
function Z2(e, t) {
...
const m9 = (e, t) => {
  ...
  for (let C = 0; C < r; C++) {
    const s = e[C];
    let d, u, g = -1, v = 0;
    for (; v < s.length && (a.lastIndex = v, u = a.exec(s), u !== null); ) v = a.lastIndex, a === a1 ? u[1] === "!--" ? a = h2 : u[1] !== void 0 ? a = p2 : u[2] !== void 0 ? (k2.test(u[2]) && (o = RegExp("</" + u[2], "g")), a = G) : u[3] !== void 0 && (a = G) : a === G ? u[0] === ">" ? (a = o ?? a1, g = -1) : u[1] === void 0 ? g = -2 : (g = a.lastIndex - u[2].length, d = u[1], a = u[3] === void 0 ? G : u[3] === '"' ? u2 : g2) : a === u2 || a === g2 ? a = G : a === h2 || a === p2 ? a = a1 : (a = G, o = void 0);
    const p = a === G && e[C + 1].startsWith("/>") ? " " : "";
    n += a === a1 ? s + u9 : g >= 0 ? (i.push(d), s.slice(0, g) + V2 + s.slice(g) + U + p) : s + U + (g === -2 ? C : p);
  }
  return [Z2(e, n + (e[r] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), i];
};
class f1 {
  constructor({ strings: t, _$litType$: r }, i) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const C = t.length - 1, s = this.parts, [d, u] = m9(t, r);
    if (this.el = f1.createElement(d, i), q.currentNode = this.el.content, r === 2 || r === 3) {
      const g = this.el.content.firstChild;
      g.replaceWith(...g.childNodes);
    }
    for (; (o = q.nextNode()) !== null && s.length < C; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const g of o.getAttributeNames()) if (g.endsWith(V2)) {
          const v = u[a++], p = o.getAttribute(g).split(U), H = /([.?@])?(.*)/.exec(v);
          s.push({ type: 1, index: n, name: H[2], strings: p, ctor: H[1] === "." ? b9 : H[1] === "?" ? _9 : H[1] === "@" ? $9 : O1 }), o.removeAttribute(g);
      ...
      } else if (o.nodeType === 8) if (o.data === L2) s.push({ type: 2, index: n });
      else {
        let g = -1;
...
function r1(e, t, r = e, i) {
  ...
  const n = v1(t) ? void 0 : t._$litDirective$;
...
class y9 {
  ...
  u(t) {
    ...
    for (; s !== void 0; ) {
      if (a === s.index) {
        let d;
        s.type === 2 ? d = new P1(n, n.nextSibling, this, t) : s.type === 1 ? d = new s.ctor(n, s.name, s.strings, this, t) : s.type === 6 && (d = new H9(n, this, t)), this._$AV.push(d), s = i[++C];
      }
...
class P1 {
  ...
  _$AI(t, r = this) {
    t = r1(this, t, r), v1(t) ? t === _ || t == null || t === "" ? (this._$AH !== _ && this._$AR(), this._$AH = _) : t !== this._$AH && t !== J && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : v9(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== _ && v1(this._$AH) ? this._$AA.nextSibling.data = t : this.T(X.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var n;
    const { values: r, _$litType$: i } = t, o = typeof i == "number" ? this._$AC(t) : (i.el === void 0 && (i.el = f1.createElement(Z2(i.h, i.h[0]), this.options)), i);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(r);
    else {
      const a = new y9(o, this), C = a.u(this.options);
      a.p(r), this.T(C), this._$AH = a;
    }
  }
  _$AC(t) {
    let r = v2.get(t.strings);
    return r === void 0 && v2.set(t.strings, r = new f1(t)), r;
  }
  k(t) {
    K1(this._$AH) || (this._$AH = [], this._$AR());
    const r = this._$AH;
    let i, o = 0;
    for (const n of t) o === r.length ? r.push(i = new P1(this.O(k1()), this.O(k1()), this, this.options)) : i = r[o], i._$AI(n), o++;
...
class O1 {
  ...
  _$AI(t, r = this, i, o) {
    ...
    let a = !1;
    if (n === void 0) t = r1(this, t, r, 0), a = !v1(t) || t !== this._$AH && t !== J, a && (this._$AH = t);
    else {
      const C = t;
      let s, d;
      for (t = n[0], s = 0; s < n.length - 1; s++) d = r1(this, C[i + s], r, s), d === J && (d = this._$AH[s]), a || (a = !v1(d) || d !== this._$AH[s]), d === _ ? t = _ : t !== _ && (t += (d ?? "") + n[s + 1]), this._$AH[s] = d;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
R1 == null || R1(f1, P1), (p1.litHtmlVersions ?? (p1.litHtmlVersions = [])).push("3.3.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const S2 = { ATTRIBUTE: 1, CHILD: 2 }, A2 = (e) => (...t) => ({ _$litDirective$: e, values: t });
class E2 {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const j = A2(class extends E2 {
  constructor(e) {
    var t;
    if (super(e), e.type !== S2.ATTRIBUTE || e.name !== "class" || ((t = e.strings) == null ? void 0 : t.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(e) {
...
}), e1 = (e) => e.replace(/([A-Z])([A-Z])/g, "$1-$2").replace(/([a-z])([A-Z])/g, "$1-$2").replace(/[\s_]+/g, "-").toLowerCase(), x9 = (e) => e.length === 0, M9 = l1("accordion").parts("root", "item", "itemTrigger", "itemContent", "itemIndicator"), s1 = M9.build(), P2 = (e) => typeof e == "object" && e !== null, F = (e) => e ? "" : void 0, V9 = 9, L9 = (e) => P2(e) && e.nodeType === V9, k9 = (e) => P2(e) && e === e.window;
function Z9(e) {
  if (!e) return !1;
...
function S9(e) {
  return L9(e) ? e : k9(e) ? e.document : (e == null ? void 0 : e.ownerDocument) ?? document;
}
function O2(e) {
...
var X1 = (e) => T2() && e.test(A9()), E9 = (e) => T2() && e.test(navigator.vendor), P9 = () => X1(/^iPhone/i), O9 = () => X1(/^iPad/i) || B2() && navigator.maxTouchPoints > 1, T9 = () => P9() || O9(), B9 = () => B2() || T9(), B2 = () => X1(/^Mac/i), z9 = () => B9() && E9(/apple/i), I9 = {
  Up: "ArrowUp",
  Down: "ArrowDown",
  Esc: "Escape",
  " ": "Space",
...
function R9(e, t = {}) {
  ...
  let o = e.key;
  return o = I9[o] ?? o, r === "rtl" && i === "horizontal" && o in f2 && (o = f2[o]), o;
}
function N9(e, t) {
  return Array.from((e == null ? void 0 : e.querySelectorAll(t)) ?? []);
}
var z2 = (e) => e.id;
function U9(e, t, r = z2) {
...
var G9 = (e) => e[0], F9 = (e) => e[e.length - 1], q9 = (e, ...t) => e.concat(t), K9 = (e, ...t) => e.filter((r) => !t.includes(r)), X9 = (e) => typeof e == "string", C1 = (e) => typeof e == "function", J9 = Function.prototype.toString;
J9.call(Object);
var w2 = (...e) => (...t) => {
...
}, t0 = (e) => e.getById(Z1(e)), T1 = (e) => {
  const r = `[data-controls][data-ownedby='${CSS.escape(Z1(e))}']:not([disabled])`;
  return N9(t0(e), r);
}, e0 = (e) => G9(T1(e)), r0 = (e) => F9(T1(e)), i0 = (e, t) => D9(T1(e), S1(e, t)), o0 = (e, t) => j9(T1(e), S1(e, t));
function n0(e, t) {
  const { send: r, context: i, prop: o, scope: n, computed: a } = e, C = i.get("focusedValue"), s = i.get("value"), d = o("multiple");
  function u(v) {
    let p = v;
  ...
  return {
    ...
    getItemTriggerProps(v) {
      ...
      return t.button({
        ...
        onClick(B) {
          H.disabled || (z9() && B.currentTarget.focus(), r({ type: "TRIGGER.CLICK", value: p }));
        },
        onKeyDown(B) {
...
function _2(e, t, r) {
  const i = String(t);
  if (D2(i)) {
    const o = C0(i), n = l0(e, o);
    return R2(n, () => `[zag-js] Unknown state id: "${o}"`), c1(e, n);
  }
  if (s0(i) && r) {
    const o = D1(r, i.slice(1));
    return c1(e, o);
  }
  if (!a0(i) && r) {
    const o = J1(r);
    for (let n = o.length - 1; n >= 1; n--) {
      const a = o.slice(0, n).join(W), C = D1(a, i);
...
function d0(e, t, r) {
  ...
  for (let C = i.length - 1; C >= 0; C--) {
    const s = (n = i[C]) == null ? void 0 : n.state.on, d = s == null ? void 0 : s[r];
    if (d) return { transitions: d, source: (a = i[C]) == null ? void 0 : a.path };
  }
  const o = e.on;
...
function h0(e, t, r, i) {
  ...
  const d = ((v = o.at(-1)) == null ? void 0 : v.path) === ((p = n.at(-1)) == null ? void 0 : p.path);
  return i && d && (C = o.slice().reverse(), s = n), { exiting: C, entering: s };
}
function p0(e, t) {
...
var d1 = /* @__PURE__ */ ((e) => (e.NotStarted = "Not Started", e.Started = "Started", e.Stopped = "Stopped", e))(d1 || {}), $1 = "__init__";
function f0(e) {
  const t = () => {
    var a;
  ...
  implementations: {
    ...
    actions: {
      collapse({ context: e, prop: t, event: r }) {
        const i = t("multiple") ? K9(e.get("value"), r.value) : [];
        e.set("value", i);
      },
      expand({ context: e, prop: t, event: r }) {
        const i = t("multiple") ? q9(e.get("value"), r.value) : [r.value];
        e.set("value", i);
      },
      ...
      coarseValue({ context: e, prop: t }) {
        !t("multiple") && e.get("value").length > 1 && (Q9("The value of accordion should be a single value when multiple is false."), e.set("value", [e.get("value")[0]]));
      }
    }
  }
});
...
function _0(e, t, r) {
  ...
  const i = e, o = t(), n = f0({
    ...
    var x;
    const l = t();
    return (((x = i.props) == null ? void 0 : x.call(i, { props: l, scope: n })) ?? l)[h];
  };
  function C(h) {
    const l = h(), b = l.isEqual ?? ((m, w) => m === w), x = l.hash ?? ((m) => String(m)), M = { current: l.value !== void 0 ? l.value : l.defaultValue };
    return {
  ...
  const g = { current: null }, v = { current: null }, p = { current: { type: "" } }, H = () => ({
    ...
    get: () => N.get(),
    matches: (...h) => h.some((l) => p0(N.get(), l)),
    hasTag: (h) => g0(i, N.get(), h)
  }), t1 = ((i2 = i.refs) == null ? void 0 : i2.call(i, { prop: a, context: d })) ?? {}, A = () => ({
    state: B(),
    context: d,
    event: H(),
    prop: a,
    ...
    var l, b, x;
    return C1(h) ? h(A()) : (x = (b = (l = i.implementations) == null ? void 0 : l.guards) == null ? void 0 : b[h]) == null ? void 0 : x.call(b, A());
  }, Y1 = (h) => {
    var x, M;
    const l = C1(h) ? h(A()) : h;
    if (!l) return;
  ...
  }, t2 = (h) => W9(h).find((l) => l != null && l.guard ? X9(l.guard) ? !!Q1(l.guard) : C1(l.guard) ? l.guard(A()) : !1 : !0), b1 = (h) => {
    var b;
    const l = (b = i.computed) == null ? void 0 : b[h];
    return l == null ? void 0 : l({ context: d, event: H(), prop: a, refs: t1, scope: n, computed: b1 });
  }, N = C(() => ({
    defaultValue: _2(i, i.initialState({ prop: a })),
    onChange(h, l) {
      var M, m;
      const { exiting: b, entering: x } = h0(i, l, h, (M = g.current) == null ? void 0 : M.reenter);
      if (b.forEach((w) => {
        var y;
  ...
  let _1 = d1.NotStarted;
  function W2() {
    _1 = d1.Started, N.invoke(N.initial, $1);
  }
  function G2() {
    _1 = d1.Stopped, u.forEach((h) => h == null ? void 0 : h()), u = /* @__PURE__ */ new Map(), g.current = null, E(i.exit);
  }
  const e2 = (h) => {
    if (_1 !== d1.Started) return;
    v.current = p.current, p.current = h;
    const l = N.get(), { transitions: b, source: x } = d0(i, l, h.type), M = t2(b);
    if (!M) return;
    g.current = M;
...
const $0 = b0((e) => e);
var H0 = Object.defineProperty, x0 = Object.getOwnPropertyDescriptor, Y = (e, t, r, i) => {
  for (var o = i > 1 ? void 0 : i ? x0(t, r) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (i ? a(t, r, o) : a(o)) || o);
  return i && o && H0(t, r, o), o;
};
let M0 = 0;
const V0 = f`
...
let I = class extends P {
  ...
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `ct-accordion-${++M0}`);
    ...
    this._accordionService = _0(y0, () => r, () => this.requestUpdate()), this._accordionService.start();
  }
  disconnectedCallback() {
    var e;
  ...
  render() {
    ...
    if (e.forEach((o, n) => {
      ...
      return $;
    const t = n0(this._accordionService, $0), r = t.getRootProps(), i = {
      "ct-accordion": !0,
...
class j1 extends E2 {
  constructor(t) {
    if (super(t), this.it = _, t.type !== S2.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
W1.directiveName = "unsafeSVG", W1.resultType = 2;
const L0 = A2(W1), K0 = [
  "account",
  "approve",
  "bars",
...
var Z0 = Object.defineProperty, S0 = Object.getOwnPropertyDescriptor, B1 = (e, t, r, i) => {
...
let i1 = class extends P {
  ...
  render() {
    const e = this.name ? k0[this.name] : void 0;
    if (!e)
      return $;
...
var A0 = Object.defineProperty, E0 = Object.getOwnPropertyDescriptor, k = (e, t, r, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const j2 = Symbol.for(""), P0 = (e) => {
  if ((e == null ? void 0 : e.r) === j2) return e == null ? void 0 : e._$litStatic$;
}, O0 = (e) => ({ _$litStatic$: e, r: j2 }), $2 = /* @__PURE__ */ new Map(), T0 = (e) => (t, ...r) => {
  const i = r.length;
  let o, n;
  const a = [], C = [];
  let s, d = 0, u = !1;
  for (; d < i; ) {
    for (s = t[d]; d < i && (n = r[d], (o = P0(n)) !== void 0); ) s += o + t[++d], u = !0;
    d !== i && C.push(n), a.push(s), d++;
  }
  if (d === i && a.push(t[i]), u) {
    const g = a.join("$$lit$$");
...
var z0 = Object.defineProperty, I0 = Object.getOwnPropertyDescriptor, y1 = (e, t, r, i) => {
  for (var o = i > 1 ? void 0 : i ? I0(t, r) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (i ? a(t, r, o) : a(o)) || o);
  return i && o && z0(t, r, o), o;
};
const R0 = ["1", "2", "3", "4", "5", "6"];
let Q = class extends P {
  constructor() {
    super(...arguments), this.theme = "light", this.content = "", this.level = "2", this.modifierClass = "";
  }
  render() {
    const e = R0.includes(this.level) ? this.level : "2", t = O0(`h${e}`), r = {
      "ct-heading": !0,
      [`ct-theme-${this.theme}`]: !0,
      [`ct-heading--level-${e}`]: !0,
      [this.modifierClass]: !!this.modifierClass
    };
    return this.content ? B0`<${t} class=${j(r)} data-component-name="heading">${this.content}<slot></slot></${t}>` : $;
  }
};
Q.styles = R`
    :host {
...
var N0 = Object.defineProperty, U0 = Object.getOwnPropertyDescriptor, Z = (e, t, r, i) => {
  for (var o = i > 1 ? void 0 : i ? U0(t, r) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (i ? a(t, r, o) : a(o)) || o);
  return i && o && N0(t, r, o), o;
};
let L = class extends P {
  ...
  renderContent() {
    ...
    if (!this.label)
      return f`${i}${r}`;
    const o = this.label.trim().split(/\s+/), n = o[o.length - 1] ?? "", a = o.slice(0, -1).join(" "), C = this.iconGroupDisabled || this.iconPlacement === "before" && !this.external, s = this.iconPlacement === "before" ? i : $, d = f`
    ...
    `;
    return C ? f`${s}<span class="ct-link__text">${this.label}</span>${d}${r}` : f`
...
var D0 = Object.defineProperty, j0 = Object.getOwnPropertyDescriptor, T = (e, t, r, i) => {
  for (var o = i > 1 ? void 0 : i ? j0(t, r) : t, n = e.length - 1, a; n >= 0; n--)
    (a = e[n]) && (o = (i ? a(t, r, o) : a(o)) || o);
  return i && o && D0(t, r, o), o;
};
