import { unsafeCSS as D, css as U, LitElement as B, html as y, nothing as S } from "lit";
import { BreakpointM as J, BreakpointL as zt, BreakpointXl as O2, BreakpointXs as _9, BreakpointS as k9, BreakpointXxl as x9 } from "@ct-infra/tokens";
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Tt = globalThis, Pe = Tt.ShadowRoot && (Tt.ShadyCSS === void 0 || Tt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, P2 = Symbol(), Qe = /* @__PURE__ */ new WeakMap();
let $9 = class {
  constructor(e, o, r) {
    if (this._$cssResult$ = !0, r !== P2) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (Pe && e === void 0) {
      ...
      r && (e = Qe.get(o)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), r && Qe.set(o, e));
    }
    return e;
  }
  toString() {
...
const M9 = (t) => new $9(typeof t == "string" ? t : t + "", void 0, P2), L9 = (t, e) => {
  if (Pe) t.adoptedStyleSheets = e.map((o) => o instanceof CSSStyleSheet ? o : o.styleSheet);
...
}, t2 = Pe ? (t) => t : (t) => t instanceof CSSStyleSheet ? ((e) => {
  let o = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: S9, defineProperty: V9, getOwnPropertyDescriptor: H9, getOwnPropertyNames: O9, getOwnPropertySymbols: P9, getPrototypeOf: A9 } = Object, H1 = globalThis, e2 = H1.trustedTypes, E9 = e2 ? e2.emptyScript : "", he = H1.reactiveElementPolyfillSupport, bt = (t, e) => t, Zt = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? E9 : null;
      break;
  ...
  return o;
} }, Ae = (t, e) => !S9(t, e), o2 = { attribute: !0, type: String, converter: Zt, reflect: !1, useDefault: !1, hasChanged: Ae };
...
let ht = class extends HTMLElement {
  ...
  static createProperty(e, o = o2) {
    if (o.state && (o.attribute = !1), this._$Ei(), this.prototype.hasOwnProperty(e) && ((o = Object.create(o)).wrapped = !0), this.elementProperties.set(e, o), !o.noAccessor) {
      const r = Symbol(), i = this.getPropertyDescriptor(e, r, o);
      i !== void 0 && V9(this.prototype, e, i);
    }
  }
  static getPropertyDescriptor(e, o, r) {
    const { get: i, set: n } = H9(this.prototype, e) ?? { get() {
      return this[o];
    }, set(a) {
      this[o] = a;
    } };
    return { get: i, set(a) {
      ...
      n == null || n.call(this, a), this.requestUpdate(e, c, r);
    }, configurable: !0, enumerable: !0 };
  }
  static getPropertyOptions(e) {
    return this.elementProperties.get(e) ?? o2;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(bt("properties"))) {
      const o = this.properties, r = [...O9(o), ...P9(o)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const i of r) o.unshift(t2(i));
    } else e !== void 0 && o.push(t2(e));
    return o;
  }
  static _$Eu(e, o) {
    const r = o.attribute;
  ...
  createRenderRoot() {
    ...
    return L9(e, this.constructor.elementStyles), e;
  }
  connectedCallback() {
    var e;
  ...
  _$ET(e, o) {
    ...
    if (i !== void 0 && r.reflect === !0) {
      const a = (((n = r.converter) == null ? void 0 : n.toAttribute) !== void 0 ? r.converter : Zt).toAttribute(o, r.type);
  ...
  _$AK(e, o) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const c = r.getPropertyOptions(i), s = typeof c.converter == "function" ? { fromAttribute: c.converter } : ((n = c.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? c.converter : Zt;
      this._$Em = i;
      const l = s.fromAttribute(o, c.type);
      this[i] = l ?? ((a = this._$Ej) == null ? void 0 : a.get(i)) ?? l, this._$Em = null;
    }
  }
  requestUpdate(e, o, r, i = !1, n) {
    var a;
    if (e !== void 0) {
      const c = this.constructor;
      if (i === !1 && (n = this[e]), r ?? (r = c.getPropertyOptions(e)), !((r.hasChanged ?? Ae)(n, o) || r.useDefault && r.reflect && n === ((a = this._$Ej) == null ? void 0 : a.get(e)) && !this.hasAttribute(c._$Eu(e, r)))) return;
      this.C(e, o, r);
    }
    this.isUpdatePending === !1 && (this._$ES = this._$EP());
  }
  C(e, o, { useDefault: r, reflect: i, wrapped: n }, a) {
    r && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(e) && (this._$Ej.set(e, a ?? o ?? this[e]), n !== !0 || a !== void 0) || (this._$AL.has(e) || (this.hasUpdated || r || (o = void 0), this._$AL.set(e, o)), i === !0 && this._$Em !== e && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(e));
  }
  async _$EP() {
  ...
  performUpdate() {
    ...
    const o = this._$AL;
    try {
      e = this.shouldUpdate(o), e ? (this.willUpdate(o), (r = this._$EO) == null || r.forEach((i) => {
        var n;
...
ht.elementStyles = [], ht.shadowRootOptions = { mode: "open" }, ht[bt("elementProperties")] = /* @__PURE__ */ new Map(), ht[bt("finalized")] = /* @__PURE__ */ new Map(), he == null || he({ ReactiveElement: ht }), (H1.reactiveElementVersions ?? (H1.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T9 = { attribute: !0, type: String, converter: Zt, reflect: !1, hasChanged: Ae }, z9 = (t = T9, e, o) => {
  const { kind: r, metadata: i } = o;
  let n = globalThis.litPropertyMetadata.get(i);
  if (n === void 0 && globalThis.litPropertyMetadata.set(i, n = /* @__PURE__ */ new Map()), r === "setter" && ((t = Object.create(t)).wrapped = !0), n.set(o.name, t), r === "accessor") {
    const { name: a } = o;
    return { set(c) {
      const s = e.get.call(this);
      e.set.call(this, c), this.requestUpdate(a, s, t, !0, c);
    }, init(c) {
  ...
  if (r === "setter") {
    ...
    return function(c) {
      const s = this[a];
      e.call(this, c), this.requestUpdate(a, s, t, !0, c);
    };
  }
  throw Error("Unsupported decorator location: " + r);
};
function d(t) {
  return (e, o) => typeof o == "object" ? z9(t, e, o) : ((r, i, n) => {
    const a = i.hasOwnProperty(n);
    return i.constructor.createProperty(n, r), a ? Object.getOwnPropertyDescriptor(i, n) : void 0;
  })(t, e, o);
}
var Z9 = Object.defineProperty, R9 = Object.getOwnPropertyDescriptor, Lt = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? R9(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && Z9(e, o, i), i;
};
...
var D9 = Object.defineProperty, B9 = Object.getOwnPropertyDescriptor, A2 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? B9(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && D9(e, o, i), i;
};
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ee = { ATTRIBUTE: 1, CHILD: 2 }, Yt = (t) => (...e) => ({ _$litDirective$: t, values: e });
let Te = class {
  constructor(e) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const yt = globalThis, r2 = (t) => t, Dt = yt.trustedTypes, i2 = Dt ? Dt.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, E2 = "$lit$", V1 = `lit$${Math.random().toFixed(9).slice(2)}$`, T2 = "?" + V1, N9 = `<${T2}>`, N1 = document, Bt = () => N1.createComment(""), wt = (t) => t === null || typeof t != "object" && typeof t != "function", ze = Array.isArray, j9 = (t) => ze(t) || typeof (t == null ? void 0 : t[Symbol.iterator]) == "function", pe = `[ 	
\f\r]`, pt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, n2 = /-->/g, a2 = />/g, R1 = RegExp(`>|${pe}(?:([^\\s"'>=/]+)(${pe}*=${pe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), c2 = /'/g, s2 = /"/g, z2 = /^(?:script|style|textarea|title)$/i, F9 = (t) => (e, ...o) => ({ _$litType$: t, strings: e, values: o }), U9 = F9(1), O1 = Symbol.for("lit-noChange"), j = Symbol.for("lit-nothing"), l2 = /* @__PURE__ */ new WeakMap(), B1 = N1.createTreeWalker(N1, 129);
function Z2(t, e) {
  if (!ze(t) || !t.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return i2 !== void 0 ? i2.createHTML(e) : e;
}
const W9 = (t, e) => {
  const o = t.length - 1, r = [];
  let i, n = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", a = pt;
  for (let c = 0; c < o; c++) {
    const s = t[c];
    let l, h, g = -1, u = 0;
    for (; u < s.length && (a.lastIndex = u, h = a.exec(s), h !== null); ) u = a.lastIndex, a === pt ? h[1] === "!--" ? a = n2 : h[1] !== void 0 ? a = a2 : h[2] !== void 0 ? (z2.test(h[2]) && (i = RegExp("</" + h[2], "g")), a = R1) : h[3] !== void 0 && (a = R1) : a === R1 ? h[0] === ">" ? (a = i ?? pt, g = -1) : h[1] === void 0 ? g = -2 : (g = a.lastIndex - h[2].length, l = h[1], a = h[3] === void 0 ? R1 : h[3] === '"' ? s2 : c2) : a === s2 || a === c2 ? a = R1 : a === n2 || a === a2 ? a = pt : (a = R1, i = void 0);
    const p = a === R1 && t[c + 1].startsWith("/>") ? " " : "";
    n += a === pt ? s + N9 : g >= 0 ? (r.push(l), s.slice(0, g) + E2 + s.slice(g) + V1 + p) : s + V1 + (g === -2 ? c : p);
  }
  return [Z2(t, n + (t[o] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), r];
};
class _t {
  constructor({ strings: e, _$litType$: o }, r) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const c = e.length - 1, s = this.parts, [l, h] = W9(e, o);
    if (this.el = _t.createElement(l, r), B1.currentNode = this.el.content, o === 2 || o === 3) {
      const g = this.el.content.firstChild;
      g.replaceWith(...g.childNodes);
    }
    for (; (i = B1.nextNode()) !== null && s.length < c; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const g of i.getAttributeNames()) if (g.endsWith(E2)) {
          const u = h[a++], p = i.getAttribute(g).split(V1), C = /([.?@])?(.*)/.exec(u);
          s.push({ type: 1, index: n, name: C[2], strings: p, ctor: C[1] === "." ? G9 : C[1] === "?" ? K9 : C[1] === "@" ? X9 : Qt }), i.removeAttribute(g);
        } else g.startsWith(V1) && (s.push({ type: 6, index: n }), i.removeAttribute(g));
        if (z2.test(i.tagName)) {
          const g = i.textContent.split(V1), u = g.length - 1;
          if (u > 0) {
            i.textContent = Dt ? Dt.emptyScript : "";
            for (let p = 0; p < u; p++) i.append(g[p], Bt()), B1.nextNode(), s.push({ type: 2, index: ++n });
            i.append(g[u], Bt());
          }
        }
      } else if (i.nodeType === 8) if (i.data === T2) s.push({ type: 2, index: n });
      else {
        let g = -1;
        for (; (g = i.data.indexOf(V1, g + 1)) !== -1; ) s.push({ type: 7, index: n }), g += V1.length - 1;
      }
      n++;
    }
  }
  static createElement(e, o) {
    const r = N1.createElement("template");
    return r.innerHTML = e, r;
  }
}
function nt(t, e, o = t, r) {
  var a, c;
  if (e === O1) return e;
  let i = r !== void 0 ? (a = o._$Co) == null ? void 0 : a[r] : o._$Cl;
  const n = wt(e) ? void 0 : e._$litDirective$;
  return (i == null ? void 0 : i.constructor) !== n && ((c = i == null ? void 0 : i._$AO) == null || c.call(i, !1), n === void 0 ? i = void 0 : (i = new n(t), i._$AT(t, o, r)), r !== void 0 ? (o._$Co ?? (o._$Co = []))[r] = i : o._$Cl = i), i !== void 0 && (e = nt(t, i._$AS(t, e.values), i, r)), e;
}
class q9 {
  constructor(e, o) {
  ...
  u(e) {
    const { el: { content: o }, parts: r } = this._$AD, i = ((e == null ? void 0 : e.creationScope) ?? N1).importNode(o, !0);
    B1.currentNode = i;
    let n = B1.nextNode(), a = 0, c = 0, s = r[0];
    for (; s !== void 0; ) {
      if (a === s.index) {
        let l;
        s.type === 2 ? l = new Jt(n, n.nextSibling, this, e) : s.type === 1 ? l = new s.ctor(n, s.name, s.strings, this, e) : s.type === 6 && (l = new Y9(n, this, e)), this._$AV.push(l), s = r[++c];
      }
      a !== (s == null ? void 0 : s.index) && (n = B1.nextNode(), a++);
    }
    return B1.currentNode = N1, i;
  }
  p(e) {
    let o = 0;
...
class Jt {
  ...
  constructor(e, o, r, i) {
    this.type = 2, this._$AH = j, this._$AN = void 0, this._$AA = e, this._$AB = o, this._$AM = r, this.options = i, this._$Cv = (i == null ? void 0 : i.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, o = this) {
    e = nt(this, e, o), wt(e) ? e === j || e == null || e === "" ? (this._$AH !== j && this._$AR(), this._$AH = j) : e !== this._$AH && e !== O1 && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : j9(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== j && wt(this._$AH) ? this._$AA.nextSibling.data = e : this.T(N1.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var n;
    const { values: o, _$litType$: r } = e, i = typeof r == "number" ? this._$AC(e) : (r.el === void 0 && (r.el = _t.createElement(Z2(r.h, r.h[0]), this.options)), r);
    if (((n = this._$AH) == null ? void 0 : n._$AD) === i) this._$AH.p(o);
    else {
      const a = new q9(i, this), c = a.u(this.options);
      a.p(o), this.T(c), this._$AH = a;
    }
  }
  _$AC(e) {
    let o = l2.get(e.strings);
    return o === void 0 && l2.set(e.strings, o = new _t(e)), o;
  }
  k(e) {
    ze(this._$AH) || (this._$AH = [], this._$AR());
    const o = this._$AH;
    let r, i = 0;
    for (const n of e) i === o.length ? o.push(r = new Jt(this.O(Bt()), this.O(Bt()), this, this.options)) : r = o[i], r._$AI(n), i++;
...
class Qt {
  ...
  constructor(e, o, r, i, n) {
    this.type = 1, this._$AH = j, this._$AN = void 0, this.element = e, this.name = o, this._$AM = i, this.options = n, r.length > 2 || r[0] !== "" || r[1] !== "" ? (this._$AH = Array(r.length - 1).fill(new String()), this.strings = r) : this._$AH = j;
  }
  _$AI(e, o = this, r, i) {
    const n = this.strings;
    let a = !1;
    if (n === void 0) e = nt(this, e, o, 0), a = !wt(e) || e !== this._$AH && e !== O1, a && (this._$AH = e);
    else {
      const c = e;
      let s, l;
      for (e = n[0], s = 0; s < n.length - 1; s++) l = nt(this, c[r + s], o, s), l === O1 && (l = this._$AH[s]), a || (a = !wt(l) || l !== this._$AH[s]), l === j ? e = j : e !== j && (e += (l ?? "") + n[s + 1]), this._$AH[s] = l;
    }
    a && !i && this.j(e);
  }
  j(e) {
...
class X9 extends Qt {
  constructor(e, o, r, i, n) {
    super(e, o, r, i, n), this.type = 5;
  }
  _$AI(e, o = this) {
    if ((e = nt(this, e, o, 0) ?? j) === O1) return;
    const r = this._$AH, i = e === j && r !== j || e.capture !== r.capture || e.once !== r.once || e.passive !== r.passive, n = e !== j && (r === j || i);
...
ge == null || ge(_t, Jt), (yt.litHtmlVersions ?? (yt.litHtmlVersions = [])).push("3.3.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
let It = class extends Te {
  constructor(e) {
    if (super(e), this.it = j, e.type !== Ee.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(e) {
...
_e.directiveName = "unsafeSVG", _e.resultType = 2;
const Q9 = Yt(_e);
var t0 = Object.defineProperty, e0 = Object.getOwnPropertyDescriptor, te = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? e0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && t0(e, o, i), i;
};
let at = class extends B {
  ...
  render() {
    const t = this.name ? I9[this.name] : void 0;
    if (!t)
      return S;
    const e = ["ct-icon", this.size ? `ct-icon--size-${this.size}` : "", this.modifierClass].filter(Boolean).join(" "), o = t.replace(
      /^<svg /,
...
var o0 = Object.defineProperty, r0 = Object.getOwnPropertyDescriptor, Ze = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? r0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && o0(e, o, i), i;
};
...
Ze([
  d({ type: String })
], kt.prototype, "complexity", 2);
Ze([
  d({ type: Boolean })
], kt.prototype, "fluid", 2);
kt = Ze([
  I("ct-region")
], kt);
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const F = Yt(class extends Te {
  constructor(t) {
    var e;
    if (super(t), t.type !== Ee.ATTRIBUTE || t.name !== "class" || ((e = t.strings) == null ? void 0 : e.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(t) {
  ...
  update(t, [e]) {
    ...
    for (const n of this.st) n in e || (o.remove(n), this.st.delete(n));
    for (const n in e) {
      const a = !!e[n];
 ...
 */
const P = (t) => t ?? j;
var i0 = Object.defineProperty, n0 = Object.getOwnPropertyDescriptor, t1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? n0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && i0(e, o, i), i;
};
let K = class extends B {
  ...
  render() {
    ...
    }, e = this.icon ? y`<ct-icon class="ct-button__icon" name=${this.icon}></ct-icon>` : S, o = this.label ? y`<span class="ct-button__text">${this.label}</span>` : S, r = y`
      ${this.iconPlacement === "before" ? e : S}
      ${o}
      <slot></slot>
      ${this.iconPlacement === "after" ? e : S}
    `;
...
var a0 = Object.defineProperty, c0 = Object.getOwnPropertyDescriptor, $1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? c0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && a0(e, o, i), i;
};
let a1 = class extends B {
  constructor() {
  ...
  render() {
    if (!this.content)
      return S;
    const t = ["default", "input", "link"].includes(this.kind) ? this.kind : "default", e = ["large", "regular", "small"].includes(this.size) ? this.size : "regular", o = {
      "ct-chip": !0,
      [`ct-theme-${this.theme}`]: !0,
      [`ct-chip--${t}`]: !0,
      [`ct-chip--${e}`]: !0,
      active: this.selected
    }, r = y`<span class="ct-chip__text">${this.content}</span>`;
    return t === "input" ? y`
        <label class=${F(o)} data-component-name="chip">
          <input
      ...
      ` : y`
      <span class=${F(o)} ?disabled=${this.disabled} data-component-name="chip">
        ${r}
      </span>
    `;
  }
...
var s0 = Object.defineProperty, l0 = Object.getOwnPropertyDescriptor, E1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? l0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && s0(e, o, i), i;
};
let h1 = class extends B {
  constructor() {
   ...
   */
  renderContent() {
    const t = this.newWindow ? y`<span class="ct-visually-hidden">(Opens in a new tab/window)</span>` : S;
    if (!this.external)
      return y`<span class="ct-content-link__text">${this.text}</span>${t}`;
    const e = this.text.trim().split(/\s+/), o = e[e.length - 1] ?? "", r = e.slice(0, -1).join(" "), i = y`<ct-icon class="ct-content-link__icon" name="upper-right-arrow"></ct-icon>`;
    return y`
...
], h1.prototype, "linkTitle", 2);
E1([
  d({ type: Boolean, attribute: "new-window" })
], h1.prototype, "newWindow", 2);
E1([
  d({ type: Boolean })
], h1.prototype, "external", 2);
E1([
  d({ type: String, attribute: "modifier-class" })
...
var d0 = Object.defineProperty, h0 = Object.getOwnPropertyDescriptor, St = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? h0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && d0(e, o, i), i;
};
const d2 = {
...
let j1 = class extends B {
  ...
  render() {
    if (!this.content)
      return S;
    const t = this.type in d2 ? this.type : "information", e = d2[t], o = {
      "ct-field-message": !0,
      [`ct-theme-${this.theme}`]: !0,
    ...
    return y`
      <div class=${F(o)} data-component-name="field-message">
...
St([
  d({ type: String })
], j1.prototype, "theme", 2);
St([
  d({ type: String })
], j1.prototype, "type", 2);
St([
  d({ type: String })
], j1.prototype, "content", 2);
St([
  d({ type: String, attribute: "modifier-class" })
], j1.prototype, "modifierClass", 2);
j1 = St([
  I("ct-field-message")
], j1);
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const R2 = Symbol.for(""), p0 = (t) => {
  if ((t == null ? void 0 : t.r) === R2) return t == null ? void 0 : t._$litStatic$;
}, D2 = (t) => ({ _$litStatic$: t, r: R2 }), h2 = /* @__PURE__ */ new Map(), g0 = (t) => (e, ...o) => {
  const r = o.length;
  let i, n;
  const a = [], c = [];
  let s, l = 0, h = !1;
  for (; l < r; ) {
    for (s = e[l]; l < r && (n = o[l], (i = p0(n)) !== void 0); ) s += i + e[++l], h = !0;
    l !== r && c.push(n), a.push(s), l++;
  }
  if (l === r && a.push(e[r]), h) {
    const g = a.join("$$lit$$");
    (e = h2.get(g)) === void 0 && (a.raw = a, h2.set(g, e = a)), o = c;
  }
  return t(e, ...o);
}, ke = g0(U9);
var u0 = Object.defineProperty, C0 = Object.getOwnPropertyDescriptor, Vt = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? C0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && u0(e, o, i), i;
};
const f0 = ["1", "2", "3", "4", "5", "6"];
let F1 = class extends B {
  constructor() {
    super(...arguments), this.theme = "light", this.content = "", this.level = "2", this.modifierClass = "";
  }
  render() {
    const t = f0.includes(this.level) ? this.level : "2", e = D2(`h${t}`), o = {
      "ct-heading": !0,
      [`ct-theme-${this.theme}`]: !0,
      [`ct-heading--level-${t}`]: !0,
      [this.modifierClass]: !!this.modifierClass
    };
    return this.content ? ke`<${e} class=${F(o)} data-component-name="heading">${this.content}<slot></slot></${e}>` : S;
  }
};
F1.styles = U`
    :host {
...
Vt([
  d({ type: String })
], F1.prototype, "content", 2);
Vt([
  d({ type: String })
], F1.prototype, "level", 2);
Vt([
  d({ type: String, attribute: "modifier-class" })
...
var m0 = Object.defineProperty, v0 = Object.getOwnPropertyDescriptor, K1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? v0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && m0(e, o, i), i;
};
let y1 = class extends B {
  constructor() {
...
K1([
  d({ type: Number })
], y1.prototype, "width", 2);
K1([
  d({ type: Number })
], y1.prototype, "height", 2);
K1([
  d({ type: String, attribute: "modifier-class" })
...
var b0 = Object.defineProperty, y0 = Object.getOwnPropertyDescriptor, M1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? y0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && b0(e, o, i), i;
};
let c1 = class extends B {
  ...
  render() {
    ...
    const t = this.tag === "legend" ? "legend" : "label", e = {
      ...
      [this.modifierClass]: !!this.modifierClass
    }, o = this.required ? ke`<span class="ct-label__required">${this.requiredText}</span>` : S, r = D2(t);
    return ke`
      <${r}
        class=${F(e)}
        for=${P(t === "label" ? this.for : void 0)}
        data-component-name="label"
      >${this.content}${this.required ? " " : S}${o}</${r}>
    `;
  }
};
c1.styles = U`
...
M1([
  d({ type: Boolean })
], c1.prototype, "required", 2);
M1([
  d({ type: String, attribute: "required-text" })
], c1.prototype, "requiredText", 2);
M1([
  d({ type: String })
], c1.prototype, "for", 2);
M1([
...
var w0 = Object.defineProperty, _0 = Object.getOwnPropertyDescriptor, e1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? _0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && w0(e, o, i), i;
};
let X = class extends B {
   ...
   */
  renderContent() {
    const t = this.external && this.iconSingleOnly ? "upper-right-arrow" : this.icon, e = !!t || this.external, o = this.newWindow ? y`<span class="ct-visually-hidden">(Opens in a new tab/window)</span>` : S;
    if (!e)
      return y`<span class="ct-link__text">${this.label}</span>${o}`;
    const r = t ? y`<ct-icon class="ct-link__icon" name=${t}></ct-icon>` : S;
    if (!this.label)
      return y`${r}${o}`;
    const i = this.label.trim().split(/\s+/), n = i[i.length - 1] ?? "", a = i.slice(0, -1).join(" "), c = this.iconGroupDisabled || this.iconPlacement === "before" && !this.external, s = this.iconPlacement === "before" ? r : S, l = y`
      ${this.iconPlacement === "after" ? r : S}
      ${this.external && !this.iconSingleOnly ? y`<ct-icon class="ct-link__icon ct-link__icon--external" name="upper-right-arrow"></ct-icon>` : S}
    `;
    return c ? y`${s}<span class="ct-link__text">${this.label}</span>${l}${o}` : y`
      ${s}<span class="ct-link__text">${a} </span
      ><span class="ct-link__group"><span class="ct-link__text">${n}</span> ${l}</span
      >${o}
    `;
  }
  render() {
    ...
    return !this.label && !this.icon ? S : y`
      <a
        class=${F(e)}
...
], X.prototype, "iconGroupDisabled", 2);
e1([
  d({ type: Boolean, attribute: "icon-single-only" })
], X.prototype, "iconSingleOnly", 2);
e1([
  d({ type: String, attribute: "modifier-class" })
...
var k0 = Object.defineProperty, x0 = Object.getOwnPropertyDescriptor, f1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? x0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && k0(e, o, i), i;
};
let n1 = class extends B {
  ...
  render() {
    ...
    const t = {
      ...
      [this.modifierClass]: !!this.modifierClass
    }, e = this.icon ? y`<ct-icon class="ct-tag__icon" name=${this.icon} size="small"></ct-icon>` : S, o = y`<span class="ct-tag__text">${this.label}</span>`, r = this.url && this.newWindow ? y`<span class="ct-visually-hidden">(Opens in a new tab/window)</span>` : S, i = this.external ? y`<ct-icon class="ct-tag__icon" name="upper-right-arrow" size="small"></ct-icon>` : S, n = y`
      ${this.iconPlacement === "before" ? e : S}
      ${o}
      ${this.iconPlacement === "after" ? e : S}
      ${r}
    ...
    return this.url ? y`
      ...
      ` : y`
      <span class=${F(t)} data-component-name="tag">
        ${n}
      </span>
    `;
  }
...
f1([
  d({ type: String })
], n1.prototype, "variant", 2);
f1([
  d({ type: String })
], n1.prototype, "label", 2);
f1([
  d({ type: String })
], n1.prototype, "icon", 2);
f1([
  d({ type: String, attribute: "icon-placement" })
], n1.prototype, "iconPlacement", 2);
f1([
  d({ type: String })
], n1.prototype, "url", 2);
f1([
  d({ type: Boolean, attribute: "new-window" })
], n1.prototype, "newWindow", 2);
f1([
  d({ type: Boolean })
], n1.prototype, "external", 2);
f1([
  d({ type: String, attribute: "modifier-class" })
...
var $0 = Object.defineProperty, M0 = Object.getOwnPropertyDescriptor, ee = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? M0(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && $0(e, o, i), i;
};
...
var ot = (t, e = []) => ({
  ...
  extendWith: (...o) => ot(t, [...e, ...o]),
  omit: (...o) => ot(t, e.filter((r) => !o.includes(r))),
  rename: (o) => ot(o, e),
  keys: () => e,
  build: () => [...new Set(e)].reduce(
    (o, r) => Object.assign(o, {
      [r]: {
        selector: [
          `&[data-scope="${tt(t)}"][data-part="${tt(r)}"]`,
          `& [data-scope="${tt(t)}"][data-part="${tt(r)}"]`
        ].join(", "),
        attrs: { "data-scope": tt(t), "data-part": tt(r) }
      }
    }),
    {}
  )
}), tt = (t) => t.replace(/([A-Z])([A-Z])/g, "$1-$2").replace(/([a-z])([A-Z])/g, "$1-$2").replace(/[\s_]+/g, "-").toLowerCase(), L0 = (t) => t.length === 0, S0 = ot("accordion").parts("root", "item", "itemTrigger", "itemContent", "itemIndicator"), gt = S0.build(), V0 = Object.defineProperty, H0 = (t, e, o) => e in t ? V0(t, e, { enumerable: !0, configurable: !0, writable: !0, value: o }) : t[e] = o, ue = (t, e, o) => H0(t, typeof e != "symbol" ? e + "" : e, o), oe = (t) => typeof t == "object" && t !== null, l1 = (t) => t ? "" : void 0, O0 = 1, P0 = 9, A0 = 11, Ht = (t) => oe(t) && t.nodeType === O0 && typeof t.nodeName == "string", B2 = (t) => oe(t) && t.nodeType === P0, E0 = (t) => oe(t) && t === t.window, I2 = (t) => Ht(t) ? t.localName || "" : "#document";
function T0(t) {
  return ["html", "body", "#document"].includes(I2(t));
}
var z0 = (t) => oe(t) && t.nodeType !== void 0, xe = (t) => z0(t) && t.nodeType === A0 && "host" in t;
function Z0(t) {
  if (!t) return !1;
...
function X1(t) {
  return B2(t) ? t : E0(t) ? t.document : (t == null ? void 0 : t.ownerDocument) ?? document;
}
function R0(t) {
  return X1(t).documentElement;
}
function p1(t) {
  var e;
  return xe(t) ? p1(t.host) : B2(t) ? t.defaultView ?? window : Ht(t) ? ((e = t.ownerDocument) == null ? void 0 : e.defaultView) ?? window : window;
}
function Re(t) {
  let e = t.activeElement;
  for (; e != null && e.shadowRoot; ) {
    const o = e.shadowRoot.activeElement;
    if (!o || o === e) break;
    e = o;
  }
  return e;
...
function D0(t) {
  if (I2(t) === "html") return t;
  const e = t.assignedSlot || t.parentNode || xe(t) && t.host || R0(t);
  return xe(e) ? e.host : e;
}
var Ce = /* @__PURE__ */ new WeakMap();
function B0(t) {
  return Ce.has(t) || Ce.set(t, p1(t).getComputedStyle(t)), Ce.get(t);
}
...
function N0() {
  const t = navigator.userAgentData;
  return t && Array.isArray(t.brands) ? t.brands.map(({ brand: e, version: o }) => `${e}/${o}`).join(" ") : navigator.userAgent;
}
var Be = (t) => De() && t.test(I0()), j0 = (t) => De() && t.test(N0()), F0 = (t) => De() && t.test(navigator.vendor), U0 = () => Be(/^iPhone/i), W0 = () => Be(/^iPad/i) || Ie() && navigator.maxTouchPoints > 1, q0 = () => U0() || W0(), G0 = () => Ie() || q0(), Ie = () => Be(/^Mac/i), K0 = () => G0() && F0(/apple/i), X0 = () => j0(/Android/i);
function Y0(t) {
  var e, o, r;
  return ((e = t.composedPath) == null ? void 0 : e.call(t)) ?? ((r = (o = t.nativeEvent) == null ? void 0 : o.composedPath) == null ? void 0 : r.call(o));
}
function N2(t) {
  const e = Y0(t);
...
function J0(t) {
  return ro(t).isComposing || t.keyCode === 229;
}
function Q0(t) {
  return t.pointerType === "" && t.isTrusted ? !0 : X0() && t.pointerType ? t.type === "click" && t.buttons === 1 : t.detail === 0 && !t.pointerType;
}
var to = (t) => t.button === 0, eo = {
  Up: "ArrowUp",
  Down: "ArrowDown",
  Esc: "Escape",
  " ": "Space",
...
function oo(t, e = {}) {
  const { dir: o = "ltr", orientation: r = "horizontal" } = e;
  let i = t.key;
  return i = eo[i] ?? i, o === "rtl" && r === "horizontal" && i in p2 && (i = p2[i]), i;
}
function ro(t) {
...
var fe = (t, e, o, r) => {
  ...
  return i == null || i.addEventListener(e, o, r), () => {
    i == null || i.removeEventListener(e, o, r);
  };
}, io = class j2 {
  constructor() {
    ue(this, "id", null), ue(this, "fn_cleanup"), ue(this, "cleanup", () => {
      this.cancel();
    });
  }
  static create() {
...
function F2(t) {
  const e = D0(t);
  return T0(e) ? X1(e).body : Ht(e) && W2(e) ? e : F2(e);
}
function U2(t, e = []) {
  const o = F2(t), r = o === t.ownerDocument.body, i = p1(o);
  return r ? e.concat(i, i.visualViewport || [], W2(o) ? o : []) : e.concat(o, U2(o, []));
}
var ao = /auto|scroll|overlay|hidden|clip/, co = /* @__PURE__ */ new Set(["inline", "contents"]);
function W2(t) {
  const e = p1(t), { overflow: o, overflowX: r, overflowY: i, display: n } = e.getComputedStyle(t);
  return ao.test(o + i + r) && !co.has(n);
}
function q2(t, e) {
  return Array.from((t == null ? void 0 : t.querySelectorAll(e)) ?? []);
}
var G2 = (t) => t.id;
function so(t, e, o = G2) {
  return t.find((r) => o(r) === e);
}
function K2(t, e, o = G2) {
  const r = so(t, e, o);
  return r ? t.indexOf(r) : -1;
}
function lo(t, e, o = !0) {
  let r = K2(t, e);
  return r = o ? (r + 1) % t.length : Math.min(r + 1, t.length - 1), t[r];
}
function ho(t, e, o = !0) {
  let r = K2(t, e);
  return r === -1 ? o ? t[t.length - 1] : null : (r = o ? (r - 1 + t.length) % t.length : Math.max(0, r - 1), t[r]);
}
function po(t) {
  return t == null ? [] : Array.isArray(t) ? t : [t];
}
var go = (t) => t[0], uo = (t) => t[t.length - 1], Co = (t, ...e) => t.concat(e), fo = (t, ...e) => t.filter((o) => !e.includes(o)), mo = (t) => t != null && typeof t == "object", vo = (t) => typeof t == "string", et = (t) => typeof t == "function", bo = (t) => t == null, yo = (t, e) => Object.prototype.hasOwnProperty.call(t, e), wo = (t) => Object.prototype.toString.call(t), X2 = Function.prototype.toString, _o = X2.call(Object), ko = (t) => {
  if (!mo(t) || wo(t) != "[object Object]" || Mo(t)) return !1;
  const e = Object.getPrototypeOf(t);
  if (e === null) return !0;
  const o = yo(e, "constructor") && e.constructor;
  return typeof o == "function" && o instanceof o && X2.call(o) == _o;
}, xo = (t) => typeof t == "object" && t !== null && "$$typeof" in t && "props" in t, $o = (t) => typeof t == "object" && t !== null && "__v_isVNode" in t, Mo = (t) => xo(t) || $o(t), Y2 = () => {
}, g2 = (...t) => (...e) => {
...
function J2(t) {
  if (!ko(t) || t === void 0) return t;
  const e = Reflect.ownKeys(t).filter((r) => typeof r == "string"), o = {};
  for (const r of e) {
    const i = t[r];
    i !== void 0 && (o[r] = J2(i));
  }
...
function Lo(t, e = Object.is) {
  let o = { ...t };
  const r = /* @__PURE__ */ new Set(), i = (h) => (r.add(h), () => r.delete(h)), n = () => {
    r.forEach((h) => h());
  };
  return {
    subscribe: i,
...
function Vo(t, e, o) {
  ...
  for (const i of e)
    t[i] == null && r.push(i);
  if (r.length > 0)
    throw new Error(`[zag-js] missing required props: ${r.join(", ")}`);
}
var Nt = (t) => {
  var e;
  ...
  var o, r;
  return ((r = (o = t.ids) == null ? void 0 : o.item) == null ? void 0 : r.call(o, e)) ?? `accordion:${t.id}:item:${e}`;
}, me = (t, e) => {
  var o, r;
  return ((r = (o = t.ids) == null ? void 0 : o.itemContent) == null ? void 0 : r.call(o, e)) ?? `accordion:${t.id}:content:${e}`;
}, jt = (t, e) => {
  var o, r;
  return ((r = (o = t.ids) == null ? void 0 : o.itemTrigger) == null ? void 0 : r.call(o, e)) ?? `accordion:${t.id}:trigger:${e}`;
}, Oo = (t) => t.getById(Nt(t)), re = (t) => {
  const o = `[data-controls][data-ownedby='${CSS.escape(Nt(t))}']:not([disabled])`;
  return q2(Oo(t), o);
}, Po = (t) => go(re(t)), Ao = (t) => uo(re(t)), Eo = (t, e) => lo(re(t), jt(t, e)), To = (t, e) => ho(re(t), jt(t, e));
function zo(t, e) {
  const { send: o, context: r, prop: i, scope: n, computed: a } = t, c = r.get("focusedValue"), s = r.get("value"), l = i("multiple");
  function h(u) {
    let p = u;
    !l && p.length > 1 && (p = [p[0]]), o({ type: "VALUE.SET", value: p });
  }
  function g(u) {
    return {
  ...
  return {
    ...
    getItemProps(u) {
      ...
      return e.element({
        ...
        "data-focus": l1(p.focused),
        "data-disabled": l1(p.disabled),
        "data-orientation": i("orientation")
      });
    },
    getItemContentProps(u) {
      const p = g(u);
      return e.element({
        ...gt.itemContent.attrs,
        dir: i("dir"),
        role: "region",
        id: me(n, u.value),
        "aria-labelledby": jt(n, u.value),
        hidden: !p.expanded,
        "data-state": p.expanded ? "open" : "closed",
        "data-disabled": l1(p.disabled),
        "data-focus": l1(p.focused),
    ...
    getItemTriggerProps(u) {
      ...
      return e.button({
        ...
        "data-focus": l1(C.focused),
        "data-ownedby": Nt(n),
        onFocus() {
          C.disabled || o({ type: "TRIGGER.FOCUS", value: p });
        },
        onBlur() {
          C.disabled || o({ type: "TRIGGER.BLUR" });
        },
        onClick(f) {
          C.disabled || (K0() && f.currentTarget.focus(), o({ type: "TRIGGER.CLICK", value: p }));
        },
        onKeyDown(f) {
          if (f.defaultPrevented || C.disabled) return;
          const _ = {
            ArrowDown() {
              a("isHorizontal") || o({ type: "GOTO.NEXT", value: p });
            },
            ArrowUp() {
              a("isHorizontal") || o({ type: "GOTO.PREV", value: p });
            },
            ArrowRight() {
              a("isHorizontal") && o({ type: "GOTO.NEXT", value: p });
            },
...
var T1 = ".", t9 = "#", C2 = /* @__PURE__ */ new WeakMap(), e9 = /* @__PURE__ */ new WeakMap();
function $e(t) {
  return t.join(T1);
}
function Zo(t) {
...
function o9(t) {
  return t.startsWith(t9);
}
function Ro(t) {
  return t.startsWith(T1);
}
function Do(t) {
  return o9(t) ? t.slice(t9.length) : t;
}
function Me(t, e) {
  return t ? `${t}${T1}${e}` : e;
}
function Bo(t) {
  const e = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map(), r = (i, n) => {
    e.set(i, n);
    const a = n.id;
    a && (o.has(a) && u2(`[zag-js] Duplicate state id: "${a}"`), o.set(a, i));
    const c = n.states;
    if (c) {
      Q2(n.initial, () => `[zag-js] Compound state "${i}" has child states but no "initial" property`), n.initial in c || u2(
  ...
  for (const [i, n] of Object.entries(t.states))
    n && r(i, n);
  return { index: e, idIndex: o };
}
function Ot(t) {
  const e = C2.get(t);
  if (e) return e;
  const { index: o, idIndex: r } = Bo(t);
  return C2.set(t, o), e9.set(t, r), o;
}
function Io(t, e) {
  var o;
  return Ot(t), (o = e9.get(t)) == null ? void 0 : o.get(e);
}
function Ne(t) {
  return t ? String(t).split(T1).filter(Boolean) : [];
}
function Ft(t, e) {
  if (!e) return [];
  const o = Ot(t), r = Ne(e), i = [], n = [];
  for (const a of r) {
    n.push(a);
    const c = $e(n), s = o.get(c);
    if (!s) break;
...
function ut(t, e) {
  ...
  for (; a != null && a.initial; ) {
    const c = `${n}${T1}${a.initial}`, s = o.get(c);
    if (!s) break;
    n = c, a = s;
  }
  return n;
...
function m2(t, e, o) {
  const r = String(e);
  if (o9(r)) {
    const i = Do(r), n = Io(t, i);
    return Q2(n, () => `[zag-js] Unknown state id: "${i}"`), ut(t, n);
  }
  if (Ro(r) && o) {
    const i = Me(o, r.slice(1));
    return ut(t, i);
  }
  if (!Zo(r) && o) {
    const i = Ne(o);
    for (let n = i.length - 1; n >= 1; n--) {
      const a = i.slice(0, n).join(T1), c = Me(a, r);
      if (f2(t, c)) return ut(t, c);
    }
    if (f2(t, r)) return ut(t, r);
  }
  return ut(t, r);
}
function No(t, e, o) {
  ...
  for (let c = r.length - 1; c >= 0; c--) {
    const s = (n = r[c]) == null ? void 0 : n.state.on, l = s == null ? void 0 : s[o];
    if (l) return { transitions: l, source: (a = r[c]) == null ? void 0 : a.path };
  }
  const i = t.on;
...
function jo(t, e, o, r) {
  var h, g, u, p;
  const i = e ? Ft(t, e) : [], n = Ft(t, o);
  let a = 0;
  for (; a < i.length && a < n.length && ((h = i[a]) == null ? void 0 : h.path) === ((g = n[a]) == null ? void 0 : g.path); )
    a += 1;
  let c = i.slice(a).reverse(), s = n.slice(a);
  const l = ((u = i.at(-1)) == null ? void 0 : u.path) === ((p = n.at(-1)) == null ? void 0 : p.path);
  return r && l && (c = i.slice().reverse(), s = n), { exiting: c, entering: s };
}
function Fo(t, e) {
  return t ? t === e || t.startsWith(`${e}${T1}`) : !1;
}
function Uo(t, e, o) {
  return Ft(t, e).some((r) => {
    var i;
...
function r9() {
  return {
    and: (...t) => function(o) {
      return t.every((r) => o.guard(r));
    },
    or: (...t) => function(o) {
      return t.some((r) => o.guard(r));
    },
    not: (t) => function(o) {
      return !o.guard(t);
    }
...
var vt = /* @__PURE__ */ ((t) => (t.NotStarted = "Not Started", t.Started = "Started", t.Stopped = "Stopped", t))(vt || {}), Pt = "__init__";
function Wo(t) {
  const e = () => {
    var a;
  ...
  return {
    ...
    getActiveElement: () => Re(e()),
    isActiveElement: Z0,
    getById: (a) => e().getElementById(a)
  };
}
var { and: qo, not: Go } = r9(), Ko = i9({
  props({ props: t }) {
    return {
      collapsible: !1,
      multiple: !1,
  ...
  context({ prop: t, bindable: e }) {
    return {
      focusedValue: e(() => ({
        ...
        onChange(o) {
          var r;
          (r = t("onFocusChange")) == null || r({ value: o });
        }
      })),
      value: e(() => ({
        ...
        onChange(o) {
          var r;
          (r = t("onValueChange")) == null || r({ value: o });
        }
      }))
    };
  },
  ...
  implementations: {
    ...
    actions: {
      collapse({ context: t, prop: e, event: o }) {
        const r = e("multiple") ? fo(t.get("value"), o.value) : [];
        t.set("value", r);
      },
      expand({ context: t, prop: e, event: o }) {
        const r = e("multiple") ? Co(t.get("value"), o.value) : [o.value];
        t.set("value", r);
      },
      ...
      coarseValue({ context: t, prop: e }) {
        !e("multiple") && t.get("value").length > 1 && (So("The value of accordion should be a single value when multiple is false."), t.set("value", [t.get("value")[0]]));
      }
    }
  }
});
function Xo(t) {
  return new Proxy({}, {
    get(e, o) {
      return o === "style" ? (r) => t({ style: r }).style : t;
    }
  });
}
function n9(t, e, o) {
  ...
  const r = t, i = e(), n = Wo({
    ...
    var O;
    const b = e();
    return (((O = r.props) == null ? void 0 : O.call(r, { props: b, scope: n })) ?? b)[w];
  };
  function c(w) {
    const b = w(), H = b.isEqual ?? ((E, T) => E === T), O = b.hash ?? ((E) => String(E)), A = { current: b.value !== void 0 ? b.value : b.defaultValue };
    return {
      initial: b.defaultValue,
      ref: A,
      get: () => A.current,
      set(E) {
        var dt;
        const T = A.current, R = et(E) ? E(T) : E;
        H(R, T) || (A.current = R, (dt = b.onChange) == null || dt.call(b, R, T), o());
      },
      invoke(E, T) {
        var R;
        (R = b.onChange) == null || R.call(b, E, T);
      },
      hash: O
    };
  }
  c.cleanup = (w) => {
    ...
    const b = { current: w };
    return { get: () => b.current, set: (H) => b.current = H };
  };
  const s = (N = r.context) == null ? void 0 : N.call(r, {
    prop: a,
    bindable: c,
    scope: n,
    flush: (w) => w(),
    ...
    set: (w, b) => s == null ? void 0 : s[w].set(b),
    initial: (w) => s == null ? void 0 : s[w].initial,
    hash: (w) => {
      const b = s == null ? void 0 : s[w].get();
      return s == null ? void 0 : s[w].hash(b);
    }
  };
  ...
  const g = { current: null }, u = { current: null }, p = { current: { type: "" } }, C = () => ({
    ...
    get: () => V.get(),
    matches: (...w) => w.some((b) => Fo(V.get(), b)),
    hasTag: (w) => Uo(r, V.get(), w)
  }), _ = ((G = r.refs) == null ? void 0 : G.call(r, { prop: a, context: l })) ?? {}, m = () => ({
    state: f(),
    context: l,
    event: C(),
    prop: a,
    ...
    if (b)
      for (const A of b) {
        const E = (O = (H = r.implementations) == null ? void 0 : H.actions) == null ? void 0 : O[A];
        E == null || E(m());
      }
  }, M = (w) => {
    var b, H, O;
    return et(w) ? w(m()) : (O = (H = (b = r.implementations) == null ? void 0 : b.guards) == null ? void 0 : H[w]) == null ? void 0 : O.call(H, m());
  }, $ = (w) => {
    var O, A;
    const b = et(w) ? w(m()) : w;
    if (!b) return;
    const H = [];
    for (const E of b) {
      const T = (A = (O = r.implementations) == null ? void 0 : O.effects) == null ? void 0 : A[E], R = T == null ? void 0 : T(m());
      R && H.push(R);
    }
    return () => H.forEach((E) => E == null ? void 0 : E());
  }, L = (w) => po(w).find((b) => b != null && b.guard ? vo(b.guard) ? !!M(b.guard) : et(b.guard) ? b.guard(m()) : !1 : !0), k = (w) => {
    var H;
    const b = (H = r.computed) == null ? void 0 : H[w];
    return b == null ? void 0 : b({ context: l, event: C(), prop: a, refs: _, scope: n, computed: k });
  }, V = c(() => ({
    defaultValue: m2(r, r.initialState({ prop: a })),
    onChange(w, b) {
      var A, E;
      const { exiting: H, entering: O } = jo(r, b, w, (A = g.current) == null ? void 0 : A.reenter);
      if (H.forEach((T) => {
        var R;
        (R = h.get(T.path)) == null || R(), h.delete(T.path);
      }), H.forEach((T) => {
        var R;
        return v((R = T.state) == null ? void 0 : R.exit);
      }), v((E = g.current) == null ? void 0 : E.actions), O.forEach((T) => {
        var dt;
        const R = $((dt = T.state) == null ? void 0 : dt.effects);
        if (R) {
          const Je = h.get(T.path);
          h.set(T.path, Je ? g2(Je, R) : R);
        }
      }), b === Pt) {
        v(r.entry);
        const T = $(r.effects);
      ...
      O.forEach((T) => {
        var R;
        return v((R = T.state) == null ? void 0 : R.entry);
      });
    }
  }));
  let Z = vt.NotStarted;
  function q() {
    Z = vt.Started, V.invoke(V.initial, Pt);
  }
  function x() {
    Z = vt.Stopped, h.forEach((w) => w == null ? void 0 : w()), h = /* @__PURE__ */ new Map(), g.current = null, v(r.exit);
  }
  const z = (w) => {
    if (Z !== vt.Started) return;
    u.current = p.current, p.current = w;
    const b = V.get(), { transitions: H, source: O } = No(r, b, w.type), A = L(H);
    if (!A) return;
    g.current = A;
    const E = m2(r, A.target ?? b, O);
    E !== b ? V.set(E) : A.reenter ? V.invoke(b, b) : v(A.actions);
  };
  return (W = r.watch) == null || W.call(r, m()), {
    state: f(),
    send: z,
    get event() {
      return C();
    },
    context: { get: l.get, set: l.set },
    prop: a,
    scope: n,
    refs: _,
    computed: k,
...
const a9 = Xo((t) => t);
var Yo = Object.defineProperty, Jo = Object.getOwnPropertyDescriptor, Y1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? Jo(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && Yo(e, o, i), i;
};
let Qo = 0;
const tr = y`
...
let w1 = class extends B {
  ...
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `ct-accordion-${++Qo}`);
    const e = this._items().map((r, i) => ({ item: r, value: `panel-${i}` })).filter(({ item: r }) => this.expandAll || r.expanded).map(({ value: r }) => r), o = {
      id: this.id,
    ...
    this._accordionService = n9(Ko, () => o, () => this.requestUpdate()), this._accordionService.start();
  }
  disconnectedCallback() {
    var t;
  ...
  render() {
    ...
    if (t.forEach((i, n) => {
      ...
      return S;
    const e = zo(this._accordionService, a9), o = e.getRootProps(), r = {
      "ct-accordion": !0,
      [`ct-theme-${this.theme}`]: !0,
    ...
    return y`
      <div class=${F(r)} id=${o.id} data-orientation=${o["data-orientation"]}>
  ...
  renderPanel(t, e, o) {
    const r = t.getItemProps({ value: o, disabled: e.disabled }), i = t.getItemTriggerProps({ value: o, disabled: e.disabled }), n = t.getItemContentProps({ value: o, disabled: e.disabled });
    return y`
      <li
...
var er = Object.defineProperty, or = Object.getOwnPropertyDescriptor, z1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? or(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
...
z1([
  d({ type: String })
], g1.prototype, "created", 2);
z1([
  d({ type: String })
], g1.prototype, "changed", 2);
z1([
  d({ type: String })
], g1.prototype, "icon", 2);
g1 = z1([
  I("ct-attachment-file")
], g1);
var rr = Object.defineProperty, ir = Object.getOwnPropertyDescriptor, J1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? ir(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && rr(e, o, i), i;
};
let _1 = class extends B {
  constructor() {
    ...
    return y`
      <div class=${F(e)}>
        <div class="ct-attachment__wrapper">
          ...
          ${this.title || this.content ? y`
                <div class="ct-attachment__inner">
                  ${this.title ? y`<ct-heading theme=${this.theme} level="4" content=${this.title} modifier-class="ct-attachment__title"></ct-heading>` : S}
                  ${this.content ? y`<p class="ct-attachment__content">${this.content}</p>` : S}
                </div>
              ` : S}
          <ul class="ct-attachment__links">
            ${t.map((o) => this.renderFile(o))}
          </ul>
  ...
  renderFile(t) {
    const e = t.icon || "download-file", o = t.ext && t.size ? `(${t.ext}, ${t.size})` : t.ext || t.size ? `(${t.ext || t.size})` : "";
    return y`
      <li class="ct-attachment__links__item">
        ...
        <div class="ct-attachment__links__link__wrapper">
          ...
          ></ct-link>
          ${o ? y`<span class="ct-attachment__links__link__extension">${o}</span>` : S}
          ${t.changed ? y`<p class="ct-attachment__links__link__changed">LAST UPDATED: ${t.changed}</p>` : S}
        </div>
      </li>
    `;
  }
...
J1([
  d({ type: String })
], _1.prototype, "theme", 2);
J1([
  d({ type: String })
], _1.prototype, "title", 2);
J1([
  d({ type: String })
], _1.prototype, "content", 2);
J1([
  d({ type: Boolean, attribute: "with-background" })
], _1.prototype, "withBackground", 2);
J1([
  d({ type: String, attribute: "vertical-spacing" })
], _1.prototype, "verticalSpacing", 2);
J1([
  d({ type: String, attribute: "modifier-class" })
...
var nr = Object.defineProperty, ar = Object.getOwnPropertyDescriptor, Q1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? ar(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && nr(e, o, i), i;
};
const cr = ["top", "bottom", "both", "none"];
let k1 = class extends B {
  constructor() {
  ...
  render() {
    if (!this.content)
      return S;
    const t = this.theme === "dark" ? "dark" : "light", e = cr.includes(this.verticalSpacing) ? this.verticalSpacing : "", o = {
      "ct-basic-content": !0,
      [`ct-theme-${t}`]: !0,
    ...
    return y`
      <div class=${F(o)} data-component-name="basic-content">
        ${this.flush ? r : y`<div class="ct-basic-content__container">${r}</div>`}
      </div>
    `;
  }
};
k1.styles = U`
    ...
    @media (min-width: ${D(_9)}) {
      .ct-basic-content__container {
        max-width: 320px;
      }
    }
    @media (min-width: ${D(k9)}) {
      .ct-basic-content__container {
        max-width: 528px;
      }
    }
...
Q1([
  d({ type: String })
], k1.prototype, "theme", 2);
Q1([
  d({ type: String })
], k1.prototype, "content", 2);
Q1([
  d({ type: Boolean })
], k1.prototype, "flush", 2);
Q1([
  d({ type: String, attribute: "vertical-spacing" })
], k1.prototype, "verticalSpacing", 2);
Q1([
  d({ type: Boolean, attribute: "with-background" })
], k1.prototype, "withBackground", 2);
Q1([
  d({ type: String, attribute: "modifier-class" })
], k1.prototype, "modifierClass", 2);
k1 = Q1([
  I("ct-basic-content")
], k1);
var sr = Object.defineProperty, lr = Object.getOwnPropertyDescriptor, je = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? lr(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && sr(e, o, i), i;
};
...
Ut = je([
  I("ct-breadcrumb-item")
], Ut);
var dr = Object.defineProperty, hr = Object.getOwnPropertyDescriptor, ie = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? hr(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && dr(e, o, i), i;
};
let ct = class extends B {
  ...
  renderFullLinks(t) {
    ...
    return y`
      ...
      return y`
            <li>
              ${i ? this.renderActiveCrumb(o) : this.renderCrumbLink(o)}
              ${n ? y`<ct-icon
   ...
   */
  renderActiveCrumb(t) {
    return !this.activeIsLink || !t.url ? y`<span class="ct-breadcrumb__links__link--active" aria-current="location">${t.text}</span>` : y`
      <a
  ...
  render() {
    ...
    return y`
      <nav class=${F(e)} aria-label="breadcrumb">
...
ie([
  d({ type: Boolean, attribute: "active-is-link" })
], ct.prototype, "activeIsLink", 2);
ie([
  d({ type: String, attribute: "modifier-class" })
...
var pr = Object.defineProperty, gr = Object.getOwnPropertyDescriptor, o1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? gr(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && pr(e, o, i), i;
};
let Y = class extends B {
  ...
  renderImage(t, e, o) {
    return t ? y`<img class="ct-logo__image ${o}" src=${t} alt=${e} />` : S;
  }
  renderLogoGroup(t, e, o, r, i) {
    return !e && !r ? S : y`
      <span class="${t}">
        ${this.renderImage(e, o, "ct-logo__image--mobile")}
  ...
  render() {
    ...
    const o = {
      ...
      ${r ? y`<span class="ct-logo__stripe"></span>` : S}
      ${r ? this.renderLogoGroup("ct-logo__secondary", this.secondaryMobileUrl, this.secondaryMobileAlt, this.secondaryDesktopUrl, this.secondaryDesktopAlt) : S}
    `;
    return this.url ? y`
        <a class=${F(o)} href=${this.url} title=${P(this.title)}>
          ${i}
        </a>
      ` : y`<div class=${F(o)}>${i}</div>`;
  }
};
Y.styles = U`
    :host {
...
o1([
  d({ type: String, attribute: "primary-mobile-url" })
], Y.prototype, "primaryMobileUrl", 2);
o1([
  d({ type: String, attribute: "primary-mobile-alt" })
], Y.prototype, "primaryMobileAlt", 2);
o1([
  d({ type: String, attribute: "primary-desktop-url" })
], Y.prototype, "primaryDesktopUrl", 2);
o1([
  d({ type: String, attribute: "primary-desktop-alt" })
], Y.prototype, "primaryDesktopAlt", 2);
o1([
  d({ type: String, attribute: "secondary-mobile-url" })
], Y.prototype, "secondaryMobileUrl", 2);
o1([
  d({ type: String, attribute: "secondary-mobile-alt" })
], Y.prototype, "secondaryMobileAlt", 2);
o1([
  d({ type: String, attribute: "secondary-desktop-url" })
], Y.prototype, "secondaryDesktopUrl", 2);
o1([
  d({ type: String, attribute: "secondary-desktop-alt" })
], Y.prototype, "secondaryDesktopAlt", 2);
o1([
  d({ type: String, attribute: "modifier-class" })
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const c9 = "important", ur = " !" + c9, At = Yt(class extends Te {
  constructor(t) {
    var e;
    if (super(t), t.type !== Ee.ATTRIBUTE || t.name !== "style" || ((e = t.strings) == null ? void 0 : e.length) > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
  }
  render(t) {
  ...
  update(t, [e]) {
    ...
    for (const r in e) {
      ...
      if (i != null) {
        this.ft.add(r);
        const n = typeof i == "string" && i.endsWith(ur);
        r.includes("-") || n ? o.setProperty(r, n ? i.slice(0, -11) : i, n ? c9 : "") : o[r] = i;
      }
    }
    return O1;
  }
});
var Cr = ot("tooltip").parts("trigger", "arrow", "arrowTip", "positioner", "content"), Ct = Cr.build();
function fr(t) {
  return !(t.metaKey || !Ie() && t.altKey || t.ctrlKey || t.key === "Control" || t.key === "Shift" || t.key === "Meta");
}
var mr = /* @__PURE__ */ new Set(["checkbox", "radio", "range", "color", "file", "image", "button", "submit", "reset"]);
function vr(t, e, o) {
  const r = o ? N2(o) : null, i = X1(r), n = p1(r), a = Re(i);
  return t = t || a instanceof n.HTMLInputElement && !mr.has(a == null ? void 0 : a.type) || a instanceof n.HTMLTextAreaElement || a instanceof n.HTMLElement && a.isContentEditable, !(t && e === "keyboard" && o instanceof n.KeyboardEvent && !Reflect.has(yr, o.key));
}
var U1 = null, Le = /* @__PURE__ */ new Set(), Wt = /* @__PURE__ */ new Map(), W1 = !1, Se = !1, br = !1, yr = {
  Tab: !0,
  Escape: !0
};
function Fe(t, e) {
...
function qt(t) {
  W1 = !0, fr(t) && (U1 = "keyboard", Fe("keyboard", t));
}
function i1(t) {
  U1 = "pointer", (t.type === "mousedown" || t.type === "pointerdown") && (W1 = !0, Fe("pointer", t));
}
function s9(t) {
  Q0(t) && (W1 = !0, U1 = "virtual");
}
function l9(t) {
  const e = N2(t);
  e === p1(e) || e === X1(e) || br || !t.isTrusted || (!W1 && !Se && (U1 = "virtual", Fe("virtual", t)), W1 = !1, Se = !1);
}
function d9() {
  W1 = !1, Se = !0;
}
function wr(t) {
  if (typeof window > "u" || Wt.get(p1(t)))
    return;
  const e = p1(t), o = X1(t);
  let r = e.HTMLElement.prototype.focus;
  function i() {
    W1 = !0, r.apply(this, arguments);
  }
  try {
  ...
  o.addEventListener("keydown", qt, !0), o.addEventListener("keyup", qt, !0), o.addEventListener("click", s9, !0), e.addEventListener("focus", l9, !0), e.addEventListener("blur", d9, !1), typeof e.PointerEvent < "u" ? (o.addEventListener("pointerdown", i1, !0), o.addEventListener("pointermove", i1, !0), o.addEventListener("pointerup", i1, !0)) : (o.addEventListener("mousedown", i1, !0), o.addEventListener("mousemove", i1, !0), o.addEventListener("mouseup", i1, !0)), e.addEventListener(
    "beforeunload",
    () => {
      _r(t);
    },
...
var _r = (t, e) => {
  const o = p1(t), r = X1(t), i = Wt.get(o);
  if (i) {
    try {
    ...
    r.removeEventListener("keydown", qt, !0), r.removeEventListener("keyup", qt, !0), r.removeEventListener("click", s9, !0), o.removeEventListener("focus", l9, !0), o.removeEventListener("blur", d9, !1), typeof o.PointerEvent < "u" ? (r.removeEventListener("pointerdown", i1, !0), r.removeEventListener("pointermove", i1, !0), r.removeEventListener("pointerup", i1, !0)) : (r.removeEventListener("mousedown", i1, !0), r.removeEventListener("mousemove", i1, !0), r.removeEventListener("mouseup", i1, !0)), Wt.delete(o);
  }
};
function Ve() {
  return U1 === "keyboard" || U1 === "virtual";
}
function kr(t = {}) {
  const { isTextInput: e, autoFocus: o, onChange: r, root: i } = t;
  wr(i), r == null || r({ isFocusVisible: o || Ve(), modality: U1 });
  const n = (a, c) => {
    vr(!!e, a, c) && (r == null || r({ isFocusVisible: Ve(), modality: a }));
  };
  return Le.add(n), () => {
    Le.delete(n);
  };
}
const xr = ["top", "right", "bottom", "left"], P1 = Math.min, v1 = Math.max, Gt = Math.round, Et = Math.floor, b1 = (t) => ({
  x: t,
  y: t
}), $r = {
  left: "right",
...
function Mr(t, e, o) {
  o === void 0 && (o = !1);
  const r = st(t), i = qe(t), n = We(i);
  let a = i === "x" ? r === (o ? "end" : "start") ? "right" : "left" : r === "start" ? "bottom" : "top";
  return e.reference[n] > e.floating[n] && (a = Kt(a)), [a, Kt(a)];
}
function Lr(t) {
  const e = Kt(t);
  return [He(t), e, He(e)];
...
const v2 = ["left", "right"], b2 = ["right", "left"], Sr = ["top", "bottom"], Vr = ["bottom", "top"];
function Hr(t, e, o) {
  switch (t) {
    case "top":
    case "bottom":
      return o ? e ? b2 : v2 : e ? v2 : b2;
    case "left":
    case "right":
      return e ? Sr : Vr;
    default:
...
function Or(t, e, o, r) {
  const i = st(t);
  let n = Hr(A1(t), o === "start", r);
  return i && (n = n.map((a) => a + "-" + i), e && (n = n.concat(n.map(He)))), n;
}
function Kt(t) {
  const e = A1(t);
...
function y2(t, e, o) {
  ...
  const n = d1(e), a = qe(e), c = We(a), s = A1(e), l = n === "y", h = r.x + r.width / 2 - i.width / 2, g = r.y + r.height / 2 - i.height / 2, u = r[c] / 2 - i[c] / 2;
  let p;
  switch (s) {
    case "top":
      p = {
  ...
  const C = st(e);
  return C && (p[a] += u * (C === "end" ? 1 : -1) * (o && l ? -1 : 1)), p;
}
async function Ar(t, e) {
  ...
  const {
    ...
    altBoundary: u = !1,
    padding: p = 0
  } = x1(e, t), C = p9(p), _ = c[u ? g === "floating" ? "reference" : "floating" : g], m = Xt(await n.getClippingRect({
    element: (o = await (n.isElement == null ? void 0 : n.isElement(_))) == null || o ? _ : _.contextElement || await (n.getDocumentElement == null ? void 0 : n.getDocumentElement(c.floating)),
    boundary: l,
    rootBoundary: h,
    strategy: s
  })), v = g === "floating" ? {
  ...
  } : a.reference, M = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(c.floating)), $ = await (n.isElement == null ? void 0 : n.isElement(M)) && await (n.getScale == null ? void 0 : n.getScale(M)) || {
    x: 1,
    y: 1
  }, L = Xt(n.convertOffsetParentRelativeRectToViewportRelativeRect ? await n.convertOffsetParentRelativeRectToViewportRelativeRect({
    elements: c,
    rect: v,
    offsetParent: M,
    strategy: s
  ...
  return {
    top: (m.top - L.top + C.top) / $.y,
    bottom: (L.bottom - m.bottom + C.bottom) / $.y,
    left: (m.left - L.left + C.left) / $.x,
    right: (L.right - m.right + C.right) / $.x
  };
}
const Er = 50, Tr = async (t, e, o) => {
  const {
    placement: r = "bottom",
    strategy: i = "absolute",
    middleware: n = [],
    platform: a
  } = o, c = a.detectOverflow ? a : {
    ...a,
    detectOverflow: Ar
  }, s = await (a.isRTL == null ? void 0 : a.isRTL(e));
  ...
  for (let f = 0; f < n.length; f++) {
    ...
    h = M ?? h, g = $ ?? g, C[m] = {
      ...C[m],
      ...L
    }, k && p < Er && (p++, typeof k == "object" && (k.placement && (u = k.placement), k.rects && (l = k.rects === !0 ? await a.getElementRects({
      reference: t,
      floating: e,
      strategy: i
    }) : k.rects), {
  ...
  async fn(e) {
    ...
    const g = p9(h), u = {
      x: o,
      y: r
    }, p = qe(i), C = We(p), f = await a.getDimensions(l), _ = p === "y", m = _ ? "top" : "left", v = _ ? "bottom" : "right", M = _ ? "clientHeight" : "clientWidth", $ = n.reference[C] + n.reference[p] - u[p] - n.floating[C], L = u[p] - n.reference[p], k = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(l));
    let V = k ? k[M] : 0;
    (!V || !await (a.isElement == null ? void 0 : a.isElement(k))) && (V = c.floating[M] || n.floating[C]);
    const Z = $ / 2 - L / 2, q = V / 2 - f[C] / 2 - 1, x = P1(g[m], q), z = P1(g[v], q), N = V - f[C] - z, G = V / 2 - f[C] / 2 + Z, W = h9(x, G, N), w = !s.arrow && st(i) != null && G !== W && n.reference[C] / 2 - (G < x ? x : z) - f[C] / 2 < 0, b = w ? G < x ? G - x : G - N : 0;
    return {
      [p]: u[p] + b,
      data: {
        [p]: W,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((o = n.arrow) != null && o.alignmentOffset)
        return {};
      const m = A1(i), v = d1(c), M = A1(c) === c, $ = await (s.isRTL == null ? void 0 : s.isRTL(l.floating)), L = u || (M || !f ? [Kt(c)] : Lr(c)), k = C !== "none";
      !u && k && L.push(...Or(c, f, C, $));
      const V = [c, ...L], Z = await s.detectOverflow(e, _), q = [];
      ...
      if (x = [...x, {
        ...
        var z, N;
        const W = (((z = n.flip) == null ? void 0 : z.index) || 0) + 1, w = V[W];
        if (w && (!(g === "alignment" ? v !== d1(w) : !1) || // We leave the current main axis only if every placement on that axis
        // overflows the main axis.
        x.every((O) => d1(O.placement) === v ? O.overflows[0] > 0 : !0)))
          return {
            data: {
              index: W,
              overflows: x
        ...
        let b = (N = x.filter((H) => H.overflows[0] <= 0).sort((H, O) => H.overflows[1] - O.overflows[1])[0]) == null ? void 0 : N.placement;
        if (!b)
          switch (p) {
            case "bestFit": {
              var G;
              const H = (G = x.filter((O) => {
                if (k) {
                  const A = d1(O.placement);
                  return A === v || // Create a bias to the `y` side axis due to horizontal
                  // reading directions favoring greater width.
                  A === "y";
                }
                return !0;
              }).map((O) => [O.placement, O.overflows.filter((A) => A > 0).reduce((A, E) => A + E, 0)]).sort((O, A) => O[1] - A[1])[0]) == null ? void 0 : G[0];
              H && (b = H);
              break;
            }
...
}, g9 = /* @__PURE__ */ new Set(["left", "top"]);
async function Dr(t, e) {
  const {
    placement: o,
    platform: r,
    elements: i
  } = t, n = await (r.isRTL == null ? void 0 : r.isRTL(i.floating)), a = A1(o), c = st(o), s = d1(o) === "y", l = g9.has(a) ? -1 : 1, h = n && s ? -1 : 1, g = x1(e, t);
  let {
    mainAxis: u,
    crossAxis: p,
    alignmentAxis: C
...
const Br = function(t) {
  return t === void 0 && (t = 0), {
    ...
    async fn(e) {
      ...
      return a === ((o = c.offset) == null ? void 0 : o.placement) && (r = c.arrow) != null && r.alignmentOffset ? {} : {
        x: i + s.x,
        y: n + s.y,
        data: {
          ...s,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        x: o,
        y: r
      }, g = await n.detectOverflow(e, l), u = d1(i), p = Ue(u);
      let C = h[p], f = h[u];
      const _ = (v, M) => h9(M + g[v === "y" ? "top" : "left"], M, M - g[v === "y" ? "bottom" : "right"]);
      a && (C = _(p, C)), c && (f = _(u, f));
      const m = s.fn({
        ...e,
        [p]: C,
  ...
  return t === void 0 && (t = {}), {
    ...
    fn(e) {
      ...
      let f = u[C], _ = u[p];
      const m = x1(l, e), v = typeof m == "number" ? {
        mainAxis: m,
        crossAxis: 0
      } : {
        mainAxis: (o = m.mainAxis) != null ? o : 0,
        crossAxis: (r = m.crossAxis) != null ? r : 0
      };
      if (h) {
        const L = C === "y" ? "height" : "width", k = c.reference[C] - c.floating[L] + v.mainAxis, V = c.reference[C] + c.reference[L] - v.mainAxis;
        f < k ? f = k : f > V && (f = V);
      }
      if (g) {
        var M, $;
        const L = C === "y" ? "width" : "height", k = g9.has(A1(a)), V = c.reference[p] - c.floating[L] + (k && ((M = s.offset) == null ? void 0 : M[p]) || 0) + (k ? 0 : v.crossAxis), Z = c.reference[p] + c.reference[L] + (k ? 0 : (($ = s.offset) == null ? void 0 : $[p]) || 0) - (k ? v.crossAxis : 0);
        _ < V ? _ = V : _ > Z && (_ = Z);
      }
      return {
        [C]: f,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        ...c
      } = x1(t, e), s = await i.detectOverflow(e, c), l = A1(o), h = st(o), g = d1(o) === "y", {
        width: u,
        height: p
      } = r.floating;
      let C, f;
      l === "top" || l === "bottom" ? (C = l, f = h === (await (i.isRTL == null ? void 0 : i.isRTL(n.floating)) ? "start" : "end") ? "left" : "right") : (f = l, C = h === "end" ? "top" : "bottom");
      const _ = p - s.top - s.bottom, m = u - s.left - s.right, v = P1(p - s[C], _), M = P1(u - s[f], m), $ = e.middlewareData.shift, L = !$;
      let k = v, V = M;
      $ != null && $.enabled.x && (V = m), $ != null && $.enabled.y && (k = _), L && !h && (g ? V = u - 2 * v1(s.left, s.right) : k = p - 2 * v1(s.top, s.bottom)), await a({
        ...e,
        availableWidth: V,
        availableHeight: k
      });
      const Z = await i.getDimensions(n.floating);
      return u !== Z.width || p !== Z.height ? {
        reset: {
          rects: !0
        }
      } : {};
...
function lt(t) {
  return u9(t) ? (t.nodeName || "").toLowerCase() : "#document";
}
function Q(t) {
  var e;
...
function L1(t) {
  var e;
  return (e = (u9(t) ? t.ownerDocument : t.document) || window.document) == null ? void 0 : e.documentElement;
}
function u9(t) {
  return ne() ? t instanceof Node || t instanceof Q(t).Node : !1;
}
function u1(t) {
  return ne() ? t instanceof Element || t instanceof Q(t).Element : !1;
}
function Z1(t) {
  return ne() ? t instanceof HTMLElement || t instanceof Q(t).HTMLElement : !1;
}
function k2(t) {
  return !ne() || typeof ShadowRoot > "u" ? !1 : t instanceof ShadowRoot || t instanceof Q(t).ShadowRoot;
}
function ae(t) {
  const {
    overflow: e,
...
const Ur = /transform|translate|scale|rotate|perspective|filter/, Wr = /paint|layout|strict|content/, D1 = (t) => !!t && t !== "none";
let ve;
function Ge(t) {
  const e = u1(t) ? C1(t) : t;
  return D1(e.transform) || D1(e.translate) || D1(e.scale) || D1(e.rotate) || D1(e.perspective) || !Ke() && (D1(e.backdropFilter) || D1(e.filter)) || Ur.test(e.willChange || "") || Wr.test(e.contain || "");
}
function qr(t) {
  let e = q1(t);
  for (; Z1(e) && !$t(e); ) {
...
function $t(t) {
  return /^(html|body|#document)$/.test(lt(t));
}
function C1(t) {
...
function q1(t) {
  ...
  const e = (
    ...
    k2(t) && t.host || // Fallback.
    L1(t)
  );
  return k2(e) ? e.host : e;
}
function C9(t) {
  const e = q1(t);
  return $t(e) ? (t.ownerDocument || t).body : Z1(e) && ae(e) ? e : C9(e);
}
function Mt(t, e, o) {
  var r;
  e === void 0 && (e = []), o === void 0 && (o = !0);
  const i = C9(t), n = i === ((r = t.ownerDocument) == null ? void 0 : r.body), a = Q(i);
  if (n) {
    const c = Oe(a);
    return e.concat(a, a.visualViewport || [], ae(i) ? i : [], c && o ? Mt(c) : []);
  } else
    return e.concat(i, Mt(i, [], o));
}
function Oe(t) {
...
function f9(t) {
  ...
  const i = Z1(t), n = i ? t.offsetWidth : o, a = i ? t.offsetHeight : r, c = Gt(o) !== n || Gt(r) !== a;
  return c && (o = n, r = a), {
    width: o,
    height: r,
    $: c
...
function Xe(t) {
  return u1(t) ? t : t.contextElement;
}
function it(t) {
  const e = Xe(t);
  if (!Z1(e))
  ...
  let a = (n ? Gt(o.width) : o.width) / r, c = (n ? Gt(o.height) : o.height) / i;
  return (!a || !Number.isFinite(a)) && (a = 1), (!c || !Number.isFinite(c)) && (c = 1), {
    x: a,
    y: c
  };
}
const Gr = /* @__PURE__ */ b1(0);
function m9(t) {
  const e = Q(t);
  return !Ke() || !e.visualViewport ? Gr : {
    x: e.visualViewport.offsetLeft,
    y: e.visualViewport.offsetTop
  };
}
function Kr(t, e, o) {
  return e === void 0 && (e = !1), !!o && e && o === Q(t);
}
function G1(t, e, o, r) {
  e === void 0 && (e = !1), o === void 0 && (o = !1);
  const i = t.getBoundingClientRect(), n = Xe(t);
  let a = b1(1);
  e && (r ? u1(r) && (a = it(r)) : a = it(t));
  const c = Kr(n, o, r) ? m9(n) : b1(0);
  let s = (i.left + c.x) / a.x, l = (i.top + c.y) / a.y, h = i.width / a.x, g = i.height / a.y;
  if (n && r) {
    const u = Q(n), p = u1(r) ? Q(r) : r;
    let C = u, f = Oe(C);
    for (; f && p !== C; ) {
      const _ = it(f), m = f.getBoundingClientRect(), v = C1(f), M = m.left + (f.clientLeft + parseFloat(v.paddingLeft)) * _.x, $ = m.top + (f.clientTop + parseFloat(v.paddingTop)) * _.y;
      s *= _.x, l *= _.y, h *= _.x, g *= _.y, s += M, l += $, C = Q(f), f = Oe(C);
    }
  }
  return Xt({
    width: h,
...
function le(t, e) {
  const o = se(t).scrollLeft;
  return e ? e.left + o : G1(L1(t)).left + o;
}
function v9(t, e) {
  const o = t.getBoundingClientRect(), r = o.left + e.scrollLeft - le(t, o), i = o.top + e.scrollTop;
  return {
    x: r,
    y: i
  };
...
function Xr(t) {
  ...
  const n = i === "fixed", a = L1(r), c = e ? ce(e.floating) : !1;
  if (r === a || c && n)
    return o;
  let s = {
    scrollLeft: 0,
  ...
  const h = b1(0), g = Z1(r);
  if ((g || !n) && ((lt(r) !== "body" || ae(a)) && (s = se(r)), g)) {
    const p = G1(r);
    l = it(r), h.x = p.x + r.clientLeft, h.y = p.y + r.clientTop;
  }
  const u = a && !g && !n ? v9(a, s) : b1(0);
  return {
    width: o.width * l.x,
    height: o.height * l.y,
    x: o.x * l.x - s.scrollLeft * l.x + h.x + u.x,
    y: o.y * l.y - s.scrollTop * l.y + h.y + u.y
  };
}
function Yr(t) {
...
function Jr(t) {
  const e = se(t), o = t.ownerDocument.body, r = v1(t.scrollWidth, t.clientWidth, o.scrollWidth, o.clientWidth), i = v1(t.scrollHeight, t.clientHeight, o.scrollHeight, o.clientHeight);
  let n = -e.scrollLeft + le(t);
  const a = -e.scrollTop;
  return C1(o).direction === "rtl" && (n += v1(t.clientWidth, o.clientWidth) - r), {
    width: r,
    height: i,
    x: n,
    y: a
...
function ti(t, e, o) {
  o === void 0 && (o = "viewport");
  const r = o === "layoutViewport", i = Q(t), n = L1(t), a = i.visualViewport;
  let c = n.clientWidth, s = n.clientHeight, l = 0, h = 0;
  if (a) {
    const u = !Ke() || e === "fixed";
    r ? u || (l = -a.offsetLeft, h = -a.offsetTop) : (c = a.width, s = a.height, u && (l = a.offsetLeft, h = a.offsetTop));
  }
  if (le(n) <= 0) {
    const u = n.ownerDocument, p = u.body, C = getComputedStyle(p), f = u.compatMode === "CSS1Compat" && parseFloat(C.marginLeft) + parseFloat(C.marginRight) || 0, _ = Math.abs(n.clientWidth - p.clientWidth - f), m = getComputedStyle(n).scrollbarGutter === "stable both-edges" ? _ / 2 : _;
    m <= Qr && (c -= m);
  }
  return {
    width: c,
...
function ei(t, e) {
  const o = G1(t, !0, e === "fixed"), r = o.top + t.clientTop, i = o.left + t.clientLeft, n = it(t), a = t.clientWidth * n.x, c = t.clientHeight * n.y, s = i * n.x, l = r * n.y;
  return {
    width: a,
    height: c,
    x: s,
...
function oi(t, e) {
  ...
  if (o)
    return o;
  let r = Mt(t, [], !1).filter((c) => u1(c) && lt(c) !== "body"), i = null;
  const n = C1(t).position === "fixed";
  let a = n ? q1(t) : t;
  for (; u1(a) && !$t(a); ) {
    const c = C1(a), s = Ge(a), l = i ? i.position : n ? "fixed" : "";
    !s && (l === "fixed" || l === "absolute" && c.position === "static") ? r = r.filter((g) => g !== a) : i = c, a = q1(a);
  }
  return e.set(t, r), r;
}
function ri(t) {
  ...
  const a = [...o === "clippingAncestors" ? ce(e) ? [] : oi(e, this._c) : [].concat(o), r], c = x2(e, a[0], i);
  let s = c.top, l = c.right, h = c.bottom, g = c.left;
  for (let u = 1; u < a.length; u++) {
    const p = x2(e, a[u], i);
    s = v1(p.top, s), l = P1(p.right, l), h = P1(p.bottom, h), g = v1(p.left, g);
  }
  return {
    width: l - g,
    height: h - s,
...
function ni(t, e, o) {
  const r = Z1(e), i = L1(e), n = o === "fixed", a = G1(t, !0, n, e);
  let c = {
    scrollLeft: 0,
    scrollTop: 0
  };
  const s = b1(0);
  if ((r || !n) && ((lt(e) !== "body" || ae(i)) && (c = se(e)), r)) {
    const u = G1(e, !0, n, e);
    s.x = u.x + e.clientLeft, s.y = u.y + e.clientTop;
  }
  !r && i && (s.x = le(i));
  const l = i && !r && !n ? v9(i, c) : b1(0), h = a.left + c.scrollLeft - s.x - l.x, g = a.top + c.scrollTop - s.y - l.y;
  return {
    x: h,
    y: g,
    width: a.width,
...
function be(t) {
  return C1(t).position === "static";
}
function $2(t, e) {
  if (!Z1(t) || C1(t).position === "fixed")
    return null;
  if (e)
    return e(t);
  let o = t.offsetParent;
  return L1(t) === o && (o = o.ownerDocument.body), o;
}
function b9(t, e) {
  const o = Q(t);
  if (ce(t))
  ...
  for (; r && Fr(r) && be(r); )
    r = $2(r, e);
  return r && $t(r) && be(r) && !Ge(r) ? o : r || qr(t) || o;
}
const ai = async function(t) {
  const e = this.getOffsetParent || b9, o = this.getDimensions, r = await o(t.floating);
  return {
...
function li(t, e, o) {
  ...
  function c(h, g) {
    ...
    if (h || e(), !f || !_)
      return;
    const m = Et(C), v = Et(n.clientWidth - (p + f)), M = Et(n.clientHeight - (C + _)), $ = Et(p), k = {
      rootMargin: -m + "px " + -v + "px " + -M + "px " + -$ + "px",
      threshold: v1(0, P1(1, g)) || 1
    };
    let V = !0;
    function Z(q) {
      const x = q[0].intersectionRatio;
      if (!y9(u, t.getBoundingClientRect()))
        return c();
      if (x !== g) {
        if (!V)
          return c();
        x ? c(!1, x) : i = setTimeout(() => {
          c(!1, 1e-7);
        }, 1e3);
      }
      V = !1;
    ...
    try {
      ...
      r = new IntersectionObserver(Z, k);
    }
    r.observe(t);
  }
  const s = Q(t), l = () => c(o);
  return s.addEventListener("resize", l), c(!0), () => {
    s.removeEventListener("resize", l), a();
  };
}
function di(t, e, o, r) {
  r === void 0 && (r = {});
  const {
    ...
    animationFrame: s = !1
  } = r, l = Xe(t), h = i || n ? [...l ? Mt(l) : [], ...e ? Mt(e) : []] : [];
  h.forEach((m) => {
    i && m.addEventListener("scroll", o), n && m.addEventListener("resize", o);
  });
  const g = l && c ? li(l, o, n) : null;
  let u = -1, p = null;
  a && (p = new ResizeObserver((m) => {
    let [v] = m;
    v && v.target === l && p && e && (p.unobserve(e), cancelAnimationFrame(u), u = requestAnimationFrame(() => {
      var M;
  ...
  function _() {
    const m = G1(t);
    f && !y9(f, m) && o(), f = m, C = requestAnimationFrame(_);
  }
  return o(), () => {
    var m;
    h.forEach((v) => {
      i && v.removeEventListener("scroll", o), n && v.removeEventListener("resize", o);
    }), g == null || g(), (m = p) == null || m.disconnect(), p = null, s && cancelAnimationFrame(C);
  };
}
const hi = Br, pi = Ir, gi = Zr, ui = jr, Ci = Rr, fi = zr, mi = Nr, vi = (t, e, o) => {
  const r = /* @__PURE__ */ new Map(), i = o ?? {}, n = {
    ...si,
    ...i.platform,
    _c: r
  };
...
function M2(t = 0, e = 0, o = 0, r = 0) {
  if (typeof DOMRect == "function")
    return new DOMRect(t, e, o, r);
  const i = {
    x: t,
    y: e,
    width: o,
...
function bi(t) {
  if (!t) return M2();
  const { x: e, y: o, width: r, height: i } = t;
  return M2(e, o, r, i);
}
function yi(t, e) {
  return {
    contextElement: Ht(t) ? t : t == null ? void 0 : t.contextElement,
    getBoundingClientRect: () => {
      const o = t, r = e == null ? void 0 : e(o);
      return r || !o ? bi(r) : o.getBoundingClientRect();
    }
  };
}
var ft = (t) => ({ variable: t, reference: `var(${t})` }), m1 = {
  arrowSize: ft("--arrow-size"),
  arrowSizeHalf: ft("--arrow-size-half"),
  arrowBg: ft("--arrow-background"),
  transformOrigin: ft("--transform-origin"),
  arrowOffset: ft("--arrow-offset")
}, wi = (t) => t === "top" || t === "bottom" ? "y" : "x";
function _i(t, e) {
  return {
    name: "transformOrigin",
    fn(o) {
      var q, x, z, N;
      const { elements: r, middlewareData: i, placement: n, rects: a, y: c } = o, s = n.split("-")[0], l = wi(s), h = ((q = i.arrow) == null ? void 0 : q.x) || 0, g = ((x = i.arrow) == null ? void 0 : x.y) || 0, u = (e == null ? void 0 : e.clientWidth) || 0, p = (e == null ? void 0 : e.clientHeight) || 0, C = h + u / 2, f = g + p / 2, _ = Math.abs(((z = i.shift) == null ? void 0 : z.y) || 0), m = a.reference.height / 2, v = p / 2, M = ((N = t.offset) == null ? void 0 : N.mainAxis) ?? t.gutter, $ = typeof M == "number" ? M + v : M ?? v, L = _ > $, k = {
        top: `${C}px calc(100% + ${$}px)`,
        bottom: `${C}px ${-$}px`,
        left: `calc(100% + ${$}px) ${f}px`,
        right: `${-$}px ${f}px`
      }[s], V = `${C}px ${a.reference.y + m - c}px`, Z = !!t.overlap && l === "y" && L;
      return r.floating.style.setProperty(
        m1.transformOrigin.variable,
        Z ? V : k
      ), {
        data: {
          transformOrigin: Z ? V : k
        }
      };
    }
  };
...
var ki = {
  ...
  if (t)
    return {
      name: "shiftArrow",
      fn({ placement: e, middlewareData: o }) {
        if (!o.arrow) return {};
        const { x: r, y: i } = o.arrow, n = e.split("-")[0];
        return Object.assign(t.style, {
          left: r != null ? `${r}px` : "",
          top: i != null ? `${i}px` : "",
          [n]: `calc(100% + ${m1.arrowOffset.reference})`
        }), {};
      }
    };
};
function $i(t) {
  const [e, o] = t.split("-");
  return { side: e, align: o, hasAlign: o != null };
}
function Mi(t) {
  return t.split("-")[0];
}
...
function Si(t, e, o) {
  const r = t || e.createElement("div");
  return fi({ element: r, padding: o.arrowPadding });
}
function Vi(t, e) {
  if (!bo(e.offset ?? e.gutter))
    return hi(({ placement: o }) => {
      var l, h;
      const r = ((t == null ? void 0 : t.clientHeight) || 0) / 2, i = ((l = e.offset) == null ? void 0 : l.mainAxis) ?? e.gutter, n = typeof i == "number" ? i + r : i ?? r, { hasAlign: a } = $i(o), c = a ? void 0 : e.shift, s = ((h = e.offset) == null ? void 0 : h.crossAxis) ?? c;
      return J2({
        crossAxis: s,
        mainAxis: n,
...
function Pi(t) {
  ...
  let e, o, r, i;
  return ui(() => {
    const n = de(t.boundary);
    return {
      padding: t.overflowPadding,
      ...n ? { boundary: n } : void 0,
      apply({ elements: a, rects: c, availableHeight: s, availableWidth: l }) {
        const h = a.floating, g = Math.round(c.reference.width), u = Math.round(c.reference.height);
        l = Math.floor(l), s = Math.floor(s), rt(e, g) || (h.style.setProperty("--reference-width", `${g}px`), e = g), rt(o, u) || (h.style.setProperty("--reference-height", `${u}px`), o = u), rt(r, l) || (h.style.setProperty("--available-width", `${l}px`), r = l), rt(i, s) || (h.style.setProperty("--available-height", `${s}px`), i = s);
      }
    };
  });
}
function Ai(t) {
  if (t.hideWhenDetached)
    return Ci(() => ({
      ...
      boundary: de(t.boundary) ?? "clippingAncestors"
    }));
}
function Ei(t) {
...
function S2(t, e) {
  if (!t) return Y2;
  const o = new Map(e.map((r) => [r, t.style.getPropertyValue(r)]));
  return () => {
    o.forEach((r, i) => {
      r ? t.style.setProperty(i, r) : t.style.removeProperty(i);
    }), t.style.length === 0 && t.removeAttribute("style");
  };
}
function V2(t) {
  return t == null ? null : Ht(t) ? t : typeof t == "object" && t && "contextElement" in t && t.contextElement ? t.contextElement : t;
}
function Zi(t, e, o = {}) {
  const r = () => (typeof e == "function" ? e() : e) ?? null, i = () => {
    var z;
    const x = typeof t == "function" ? t() : t;
    return ((z = o.getAnchorElement) == null ? void 0 : z.call(o)) ?? x;
  }, n = () => {
    const x = i();
    return !x && !o.getAnchorRect ? null : yi(x, o.getAnchorRect);
  }, a = Object.assign({}, Li, o);
  let c = [], s = null, l, h;
  function g(x) {
    l == null || l(), h == null || h(), s = x, l = a.restoreStyles ? S2(x, Ti) : void 0;
    const z = x.querySelector("[data-part=arrow]");
    h = a.restoreStyles ? S2(z, zi) : void 0, c = [
      Vi(z, a),
      Hi(a),
      Oi(a),
      Si(z, x.ownerDocument, a),
      xi(z),
      _i(
  ...
  let _, m, v = !1, M, $, L = Y2;
  const k = Ei(a.listeners);
  function V() {
    if (!a.listeners) return;
    const x = i(), z = n(), N = r();
    if (!z || !N) return;
    (V2(x) !== V2(M) || N !== $) && (L(), M = x, $ = N, L = di(z, N, q, k));
  }
  async function Z() {
    var b;
    V();
    ...
    const z = n();
    if (!z) return;
    const N = await vi(z, x, {
      placement: u,
      middleware: c,
      strategy: p
    });
    C == null || C(N);
    const G = p1(x), W = L2(G, N.x), w = L2(G, N.y);
    if (rt(_, W) || (x.style.setProperty("--x", `${W}px`), _ = W), rt(m, w) || (x.style.setProperty("--y", `${w}px`), m = w), a.hideWhenDetached && (((b = N.middlewareData.hide) == null ? void 0 : b.referenceHidden) ? (x.style.setProperty("visibility", "hidden"), x.style.setProperty("pointer-events", "none")) : (x.style.removeProperty("visibility"), x.style.removeProperty("pointer-events"))), !v) {
      const H = x.firstElementChild;
      H && (x.style.setProperty("--z-index", B0(H).zIndex), v = !0);
    }
  }
  async function q() {
    o.updatePosition ? (await o.updatePosition({ updatePosition: Z, floatingElement: r() }), f == null || f({ placed: !0 })) : await Z();
  }
  return q(), () => {
    L(), h == null || h(), l == null || l(), f == null || f({ placed: !1 });
  };
}
function ye(t, e, o = {}) {
  const { defer: r, ...i } = o, n = r ? no : (c) => c(), a = [];
  return a.push(
    n(() => {
      a.push(Zi(t, e, i));
    })
...
function Di(t = {}) {
  const { placement: e, sameWidth: o, fitViewport: r, strategy: i = "absolute" } = t;
  return {
    arrow: {
      position: "absolute",
      width: m1.arrowSize.reference,
      height: m1.arrowSize.reference,
      [m1.arrowSizeHalf.variable]: `calc(${m1.arrowSize.reference} / 2)`,
      [m1.arrowOffset.variable]: `calc(${m1.arrowSizeHalf.reference} * -1)`
    },
    arrowTip: {
      // @ts-expect-error - Fix this
      transform: e ? Ri[e.split("-")[0]] : void 0,
      background: m1.arrowBg.reference,
      top: "0",
      left: "0",
      width: "100%",
      height: "100%",
    ...
    floating: {
      ...
      width: o ? "var(--reference-width)" : void 0,
...
var Ye = (t, e) => {
  var r;
  const o = (r = t.ids) == null ? void 0 : r.trigger;
  return o != null ? et(o) ? o(e) : o : e ? `tooltip:${t.id}:trigger:${e}` : `tooltip:${t.id}:trigger`;
}, Bi = (t) => {
  var e;
...
}, Ni = (t) => t.getById(Ye(t)), we = (t) => t.getById(w9(t)), ji = (t) => q2(t.getRootNode(), `[data-scope="tooltip"][data-part="trigger"][data-ownedby="${t.id}"]`), mt = (t, e) => e == null ? Ni(t) ?? ji(t)[0] : t.getById(Ye(t, e)), r1 = Lo({
  id: null,
  prevId: null,
  instant: !1
});
function Fi(t, e) {
  const { state: o, context: r, send: i, scope: n, prop: a, event: c } = t, s = a("id"), l = !!a("aria-label"), h = o.matches("open", "closing"), g = r.get("triggerValue"), u = r.get("currentPlacement"), p = u ? Mi(u) : void 0, C = Bi(n), f = a("disabled"), _ = Di({
    ...a("positioning"),
    placement: u
  });
  return {
    open: h,
    setOpen(m) {
      o.matches("open", "closing") !== m && i({ type: m ? "open" : "close" });
    },
    triggerValue: g,
    setTriggerValue(m) {
      i({ type: "triggerValue.set", value: m ?? void 0 });
    },
    reposition(m = {}) {
      i({ type: "positioning.set", options: m });
    },
    getTriggerProps(m = {}) {
      const { value: v } = m, M = v == null ? !1 : g === v, $ = Ye(n, v);
      return e.button({
        ...Ct.trigger.attrs,
        id: $,
        "data-ownedby": n.id,
        ...
        onClick(L) {
          if (L.defaultPrevented || f || !a("closeOnClick")) return;
          const k = h && v != null && !M;
          i({ type: k ? "triggerValue.set" : "close", src: "trigger.click", value: v, triggerId: $ });
        },
        onFocus(L) {
          if (L.defaultPrevented || f || !Ve()) return;
          const k = h && v != null && !M;
          i({ type: k ? "triggerValue.set" : "open", src: "trigger.focus", value: v, triggerId: $ });
        },
        onBlur(L) {
          if (L.defaultPrevented || f || s !== r1.get("id")) return;
          const k = L.relatedTarget ?? n.getDoc().activeElement;
          (k == null ? void 0 : k.closest(`[data-ownedby="${n.id}"]`)) != null || i({ type: "close", src: "trigger.blur", value: v, triggerId: $ });
        },
        onPointerDown(L) {
          L.defaultPrevented || f || to(L) && a("closeOnPointerDown") && s === r1.get("id") && i({ type: "close", src: "trigger.pointerdown", value: v, triggerId: $ });
        },
        onPointerMove(L) {
          if (L.defaultPrevented || f || L.pointerType === "touch") return;
          const k = h && v != null && !M;
          i({ type: k ? "triggerValue.set" : "pointer.move", value: v, triggerId: $ });
        },
        onPointerOver(L) {
          L.defaultPrevented || f || L.pointerType !== "touch" && i({ type: "pointer.move", value: v, triggerId: $ });
        },
        onPointerLeave() {
    ...
    getContentProps() {
      const m = r1.get("id") === s, v = r1.get("prevId") === s, M = r1.get("instant") && (h && m || v);
      return e.element({
        ...Ct.content.attrs,
        dir: a("dir"),
        hidden: !h,
...
var { and: Ui, not: H2 } = r9(), Wi = i9({
  initialState: ({ prop: t }) => t("open") || t("defaultOpen") ? "open" : "closed",
  props({ props: t }) {
    Vo(t, ["id"]);
    const e = t.closeOnClick ?? !0, o = t.closeOnPointerDown ?? e;
    return {
      openDelay: 400,
      closeDelay: 150,
      closeOnEscape: !0,
  ...
  context: ({ bindable: t, prop: e, scope: o }) => ({
    ...
    triggerValue: t(() => ({
      ...
      onChange(r) {
        ...
        if (!i) return;
        const n = mt(o, r);
        i({ value: r, triggerElement: n });
      }
    }))
  }),
  watch({ track: t, action: e, prop: o }) {
    t([() => o("disabled")], () => {
      e(["closeIfDisabled"]);
    }), t([() => o("open")], () => {
      e(["toggleVisibility"]);
  ...
  states: {
    closed: {
      ...
      on: {
        ...
        "pointer.move": [
          {
            guard: Ui("noVisibleTooltip", H2("hasPointerMoveOpened")),
            target: "opening",
            actions: ["setTriggerValue"]
          },
          {
            guard: H2("hasPointerMoveOpened"),
            target: "open",
  ...
  implementations: {
    guards: {
      noVisibleTooltip: () => r1.get("id") === null,
      isVisible: ({ prop: t }) => t("id") === r1.get("id"),
    ...
    actions: {
      setGlobalId: ({ prop: t }) => {
        const e = r1.get("id"), o = e !== null && e !== t("id");
        r1.update({ id: t("id"), prevId: o ? e : null, instant: o });
      },
      clearGlobalId: ({ prop: t }) => {
        t("id") === r1.get("id") && r1.update({ id: null, prevId: null, instant: !1 });
      },
      invokeOnOpen: ({ prop: t }) => {
        var e;
      ...
      reposition: ({ context: t, event: e, prop: o, scope: r }) => {
        if (e.type !== "positioning.set") return;
        ye(() => mt(r, t.get("triggerValue")), () => we(r), {
          ...o("positioning"),
          ...e.options,
          listeners: !1,
          onComplete(a) {
      ...
      repositionImmediate: ({ context: t, event: e, prop: o, scope: r }) => {
        const i = e.value ?? t.get("triggerValue");
        return ye(() => mt(r, i), () => we(r), {
          ...o("positioning"),
          onComplete(c) {
      ...
      toggleVisibility: ({ prop: t, event: e, send: o }) => {
        queueMicrotask(() => {
          o({
      ...
      setPointerMoveOpened: ({ context: t, event: e }) => {
        var r;
        const o = e.triggerId ?? ((r = e.previousEvent) == null ? void 0 : r.triggerId);
        t.set("hasPointerMoveOpened", o ?? null);
      },
    ...
    effects: {
      trackFocusVisible: ({ scope: t }) => {
        var e;
        return kr({ root: (e = t.getRootNode) == null ? void 0 : e.call(t) });
      },
      trackPositioning: ({ context: t, prop: e, scope: o }) => (t.get("currentPlacement") || t.set("currentPlacement", e("positioning").placement), ye(() => mt(o, t.get("triggerValue")), () => we(o), {
        ...e("positioning"),
        defer: !0,
        onComplete(n) {
      ...
      trackPointerlockChange: ({ send: t, scope: e }) => {
        const o = e.getDoc();
        return fe(o, "pointerlockchange", () => t({ type: "close", src: "pointerlock:change" }), !1);
      },
      trackScroll: ({ send: t, prop: e, scope: o, context: r }) => {
        if (!e("closeOnScroll")) return;
        const i = r.get("triggerValue"), n = mt(o, i);
        if (!n) return;
        const c = U2(n).map((s) => fe(s, "scroll", () => {
      ...
      trackStore: ({ prop: t, send: e }) => {
        ...
        return queueMicrotask(() => {
          o = r1.subscribe(() => {
            r1.get("id") !== t("id") && e({ type: "close", src: "id.change" });
          });
        }), () => o == null ? void 0 : o();
      },
      trackEscapeKey: ({ send: t, prop: e }) => e("closeOnEscape") ? fe(document, "keydown", (r) => {
        J0(r) || r.key === "Escape" && (r.stopPropagation(), t({ type: "close", src: "keydown.escape" }));
      }, !0) : void 0,
      waitForOpenDelay: ({ send: t, prop: e, event: o }) => {
        const r = setTimeout(() => {
          t({ type: "after.openDelay", previousEvent: o });
        }, e("openDelay"));
        return () => clearTimeout(r);
      },
      waitForCloseDelay: ({ send: t, prop: e, event: o }) => {
        const r = setTimeout(() => {
          t({ type: "after.closeDelay", previousEvent: o });
        }, e("closeDelay"));
        return () => clearTimeout(r);
      }
    }
  }
}), qi = Object.defineProperty, Gi = Object.getOwnPropertyDescriptor, S1 = (t, e, o, r) => {
  for (var i = r > 1 ? void 0 : r ? Gi(e, o) : e, n = t.length - 1, a; n >= 0; n--)
    (a = t[n]) && (i = (r ? a(e, o, i) : a(i)) || i);
  return r && i && qi(e, o, i), i;
};
const Ki = {
  auto: "bottom",
...
let Xi = 0, s1 = class extends B {
  ...
  connectedCallback() {
    super.connectedCallback(), this.id || (this.id = `ct-tooltip-${++Xi}`);
    const t = {
      id: this.id,
      getRootNode: () => this.shadowRoot ?? document,
      interactive: !0,
      ...
      positioning: {
        placement: Ki[this.position] ?? "bottom",
        flip: !0,
        gutter: 24
      }
    };
    this._tooltipService = n9(Wi, () => t, () => this.requestUpdate()), this._tooltipService.start();
  }
  disconnectedCallback() {
    var t;
  ...
  render() {
    if (!this.content || !this._tooltipService)
      return S;
    const t = Fi(this._tooltipService, a9), e = t.getTriggerProps(), o = t.getPositionerProps(), r = t.getContentProps(), i = t.getArrowProps(), n = t.getArrowTipProps(), a = {
      "ct-tooltip": !0,
      [`ct-theme-${this.theme}`]: !0,
      [this.modifierClass]: !!this.modifierClass
    };
    return y`
      <div class=${F(a)} data-component-name="tooltip">
        <button
          type="button"
        ...
        >
          <div
            ...
            role=${P(r.role)}
            ?hidden=${r.hidden}
            data-state=${P(r["data-state"])}
            style=${At(r.style)}
            @pointerenter=${r.onPointerEnter}
            @pointerleave=${r.onPointerLeave}
          >
...
S1([
  d({ type: String })
], s1.prototype, "position", 2);
S1([
  d({ type: String })
], s1.prototype, "icon", 2);
S1([
  d({ type: String, attribute: "icon-size" })
], s1.prototype, "iconSize", 2);
S1([
  d({ type: String })
...
export {
  w1 as CtAccordion,
  xt as CtAccordionItem,
  _1 as CtAttachment,
  g1 as CtAttachmentFile,
  k1 as CtBasicContent,
  ct as CtBreadcrumb,
  Ut as CtBreadcrumbItem,
  K as CtButton,
  a1 as CtChip,
  h1 as CtContentLink,
  j1 as CtFieldMessage,
  F1 as CtHeading,
  at as CtIcon,
  y1 as CtImage,
  c1 as CtLabel,
