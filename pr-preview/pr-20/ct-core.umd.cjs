(function(c,s){typeof exports=="object"&&typeof module<"u"?s(exports,require("lit"),require("@ct-infra/tokens")):typeof define=="function"&&define.amd?define(["exports","lit","@ct-infra/tokens"],s):(c=typeof globalThis<"u"?globalThis:c||self,s(c.CtCore={},c.lit,c.tokens))})(this,function(c,s,z){"use strict";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const m1=globalThis,A1=m1.ShadowRoot&&(m1.ShadyCSS===void 0||m1.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,W1=Symbol(),q1=new WeakMap;let N2=class{constructor(t,r,i){if(this._$cssResult$=!0,i!==W1)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(A1&&t===void 0){const i=r!==void 0&&r.length===1;i&&(t=q1.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&q1.set(r,t))}return t}toString(){return this.cssText}};const j2=e=>new N2(typeof e=="string"?e:e+"",void 0,W1),U2=(e,t)=>{if(A1)e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of t){const i=document.createElement("style"),o=m1.litNonce;o!==void 0&&i.setAttribute("nonce",o),i.textContent=r.cssText,e.appendChild(i)}},K1=A1?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const i of t.cssRules)r+=i.cssText;return j2(r)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:F2,defineProperty:G2,getOwnPropertyDescriptor:W2,getOwnPropertyNames:q2,getOwnPropertySymbols:K2,getPrototypeOf:X2}=Object,I=globalThis,X1=I.trustedTypes,J2=X1?X1.emptyScript:"",E1=I.reactiveElementPolyfillSupport,e1=(e,t)=>e,f1={toAttribute(e,t){switch(t){case Boolean:e=e?J2:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},P1=(e,t)=>!F2(e,t),J1={attribute:!0,type:String,converter:f1,reflect:!1,useDefault:!1,hasChanged:P1};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),I.litPropertyMetadata??(I.litPropertyMetadata=new WeakMap);let r1=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,r=J1){if(r.state&&(r.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((r=Object.create(r)).wrapped=!0),this.elementProperties.set(t,r),!r.noAccessor){const i=Symbol(),o=this.getPropertyDescriptor(t,i,r);o!==void 0&&G2(this.prototype,t,o)}}static getPropertyDescriptor(t,r,i){const{get:o,set:n}=W2(this.prototype,t)??{get(){return this[r]},set(a){this[r]=a}};return{get:o,set(a){const h=o==null?void 0:o.call(this);n==null||n.call(this,a),this.requestUpdate(t,h,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??J1}static _$Ei(){if(this.hasOwnProperty(e1("elementProperties")))return;const t=X2(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(e1("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(e1("properties"))){const r=this.properties,i=[...q2(r),...K2(r)];for(const o of i)this.createProperty(o,r[o])}const t=this[Symbol.metadata];if(t!==null){const r=litPropertyMetadata.get(t);if(r!==void 0)for(const[i,o]of r)this.elementProperties.set(i,o)}this._$Eh=new Map;for(const[r,i]of this.elementProperties){const o=this._$Eu(r,i);o!==void 0&&this._$Eh.set(o,r)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const r=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const o of i)r.unshift(K1(o))}else t!==void 0&&r.push(K1(t));return r}static _$Eu(t,r){const i=r.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var t;this._$ES=new Promise(r=>this.enableUpdating=r),this._$AL=new Map,this._$E_(),this.requestUpdate(),(t=this.constructor.l)==null||t.forEach(r=>r(this))}addController(t){var r;(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&((r=t.hostConnected)==null||r.call(t))}removeController(t){var r;(r=this._$EO)==null||r.delete(t)}_$E_(){const t=new Map,r=this.constructor.elementProperties;for(const i of r.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return U2(t,this.constructor.elementStyles),t}connectedCallback(){var t;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(t=this._$EO)==null||t.forEach(r=>{var i;return(i=r.hostConnected)==null?void 0:i.call(r)})}enableUpdating(t){}disconnectedCallback(){var t;(t=this._$EO)==null||t.forEach(r=>{var i;return(i=r.hostDisconnected)==null?void 0:i.call(r)})}attributeChangedCallback(t,r,i){this._$AK(t,i)}_$ET(t,r){var n;const i=this.constructor.elementProperties.get(t),o=this.constructor._$Eu(t,i);if(o!==void 0&&i.reflect===!0){const a=(((n=i.converter)==null?void 0:n.toAttribute)!==void 0?i.converter:f1).toAttribute(r,i.type);this._$Em=t,a==null?this.removeAttribute(o):this.setAttribute(o,a),this._$Em=null}}_$AK(t,r){var n,a;const i=this.constructor,o=i._$Eh.get(t);if(o!==void 0&&this._$Em!==o){const h=i.getPropertyOptions(o),C=typeof h.converter=="function"?{fromAttribute:h.converter}:((n=h.converter)==null?void 0:n.fromAttribute)!==void 0?h.converter:f1;this._$Em=o;const g=C.fromAttribute(r,h.type);this[o]=g??((a=this._$Ej)==null?void 0:a.get(o))??g,this._$Em=null}}requestUpdate(t,r,i,o=!1,n){var a;if(t!==void 0){const h=this.constructor;if(o===!1&&(n=this[t]),i??(i=h.getPropertyOptions(t)),!((i.hasChanged??P1)(n,r)||i.useDefault&&i.reflect&&n===((a=this._$Ej)==null?void 0:a.get(t))&&!this.hasAttribute(h._$Eu(t,i))))return;this.C(t,r,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,r,{useDefault:i,reflect:o,wrapped:n},a){i&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,a??r??this[t]),n!==!0||a!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(r=void 0),this._$AL.set(t,r)),o===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(r){Promise.reject(r)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var i;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[n,a]of this._$Ep)this[n]=a;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[n,a]of o){const{wrapped:h}=a,C=this[n];h!==!0||this._$AL.has(n)||C===void 0||this.C(n,void 0,a,C)}}let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),(i=this._$EO)==null||i.forEach(o=>{var n;return(n=o.hostUpdate)==null?void 0:n.call(o)}),this.update(r)):this._$EM()}catch(o){throw t=!1,this._$EM(),o}t&&this._$AE(r)}willUpdate(t){}_$AE(t){var r;(r=this._$EO)==null||r.forEach(i=>{var o;return(o=i.hostUpdated)==null?void 0:o.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(r=>this._$ET(r,this[r]))),this._$EM()}updated(t){}firstUpdated(t){}};r1.elementStyles=[],r1.shadowRootOptions={mode:"open"},r1[e1("elementProperties")]=new Map,r1[e1("finalized")]=new Map,E1==null||E1({ReactiveElement:r1}),(I.reactiveElementVersions??(I.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Y2={attribute:!0,type:String,converter:f1,reflect:!1,hasChanged:P1},Q2=(e=Y2,t,r)=>{const{kind:i,metadata:o}=r;let n=globalThis.litPropertyMetadata.get(o);if(n===void 0&&globalThis.litPropertyMetadata.set(o,n=new Map),i==="setter"&&((e=Object.create(e)).wrapped=!0),n.set(r.name,e),i==="accessor"){const{name:a}=r;return{set(h){const C=t.get.call(this);t.set.call(this,h),this.requestUpdate(a,C,e,!0,h)},init(h){return h!==void 0&&this.C(a,void 0,e,h),h}}}if(i==="setter"){const{name:a}=r;return function(h){const C=this[a];t.call(this,h),this.requestUpdate(a,C,e,!0,h)}}throw Error("Unsupported decorator location: "+i)};function l(e){return(t,r)=>typeof r=="object"?Q2(e,t,r):((i,o,n)=>{const a=o.hasOwnProperty(n);return o.constructor.createProperty(n,i),a?Object.getOwnPropertyDescriptor(o,n):void 0})(e,t,r)}var t9=Object.defineProperty,e9=Object.getOwnPropertyDescriptor,i1=(e,t,r,i)=>{for(var o=i>1?void 0:i?e9(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&t9(t,r,o),o};c.ctGridItem=class extends s.LitElement{constructor(){super(...arguments),this.span=12,this.spanM=6,this.spanL=6,this.spanXl=4}updated(t){["span","spanM","spanL","spanXl"].forEach(i=>{if(t.has(i)){const o=i.replace(/[A-Z]/g,n=>"-"+n.toLowerCase());this.style.setProperty(`--grid-item-${o}`,this[i].toString())}})}render(){return s.html`<slot></slot>`}},c.ctGridItem.styles=s.css`
    :host {
      display: block;
    ...
    @media (min-width: ${s.unsafeCSS(z.BreakpointM)}) {
      :host {
        grid-column: span var(--grid-item-span-m, var(--grid-item-span));
      }
    }

    @media (min-width: ${s.unsafeCSS(z.BreakpointL)}) {
      :host {
        grid-column: span var(--grid-item-span-l, var(--grid-item-span-m));
      }
    }

    @media (min-width: ${s.unsafeCSS(z.BreakpointXl)}) {
      :host {
        grid-column: span var(--grid-item-span-xl, var(--grid-item-span-l));
      }
    }
  `,i1([l({type:Number})],c.ctGridItem.prototype,"span",2),i1([l({type:Number})],c.ctGridItem.prototype,"spanM",2),i1([l({type:Number})],c.ctGridItem.prototype,"spanL",2),i1([l({type:Number})],c.ctGridItem.prototype,"spanXl",2),c.ctGridItem=i1([M("ct-grid-item")],c.ctGridItem);var r9=Object.defineProperty,i9=Object.getOwnPropertyDescriptor,Y1=(e,t,r,i)=>{for(var o=i>1?void 0:i?i9(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&r9(t,r,o),o};c.ctGrid=class extends s.LitElement{constructor(){super(...arguments),this.gap="200"}render(){return s.html`<slot></slot>`}},c.ctGrid.styles=s.css`
    :host {
      display: grid;
  ...
  `,Y1([l({type:String})],c.ctGrid.prototype,"gap",2),c.ctGrid=Y1([M("ct-grid")],c.ctGrid);var o9=Object.defineProperty,n9=Object.getOwnPropertyDescriptor,z1=(e,t,r,i)=>{for(var o=i>1?void 0:i?n9(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&o9(t,r,o),o};c.ctRegion=class extends s.LitElement{constructor(){super(...arguments),this.complexity="standard",this.fluid=!1}render(){return s.html`
  ...
  `,z1([l({type:String})],c.ctRegion.prototype,"complexity",2),z1([l({type:Boolean})],c.ctRegion.prototype,"fluid",2),c.ctRegion=z1([M("ct-region")],c.ctRegion);var a9=Object.defineProperty,c9=Object.getOwnPropertyDescriptor,y1=(e,t,r,i)=>{for(var o=i>1?void 0:i?c9(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&a9(t,r,o),o};c.CtAccordionItem=class extends s.LitElement{constructor(){super(...arguments),this.heading="",this.expanded=!1,this.disabled=!1}render(){return s.html`<slot></slot>`}},y1([l({type:String})],c.CtAccordionItem.prototype,"heading",2),y1([l({type:Boolean})],c.CtAccordionItem.prototype,"expanded",2),y1([l({type:Boolean})],c.CtAccordionItem.prototype,"disabled",2),c.CtAccordionItem=y1([M("ct-accordion-item")],c.CtAccordionItem);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const o1=globalThis,Q1=e=>e,b1=o1.trustedTypes,t2=b1?b1.createPolicy("lit-html",{createHTML:e=>e}):void 0,e2="$lit$",R=`lit$${Math.random().toFixed(9).slice(2)}$`,r2="?"+R,s9=`<${r2}>`,F=document,w1=()=>F.createComment(""),n1=e=>e===null||typeof e!="object"&&typeof e!="function",O1=Array.isArray,l9=e=>O1(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",T1=`[ 	
\f\r]`,a1=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,i2=/-->/g,o2=/>/g,G=RegExp(`>|${T1}(?:([^\\s"'>=/]+)(${T1}*=${T1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),n2=/'/g,a2=/"/g,c2=/^(?:script|style|textarea|title)$/i,C9=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),h9=C9(1),W=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),s2=new WeakMap,q=F.createTreeWalker(F,129);function l2(e,t){if(!O1(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return t2!==void 0?t2.createHTML(t):t}const d9=(e,t)=>{const r=e.length-1,i=[];let o,n=t===2?"<svg>":t===3?"<math>":"",a=a1;for(let h=0;h<r;h++){const C=e[h];let g,m,v=-1,f=0;for(;f<C.length&&(a.lastIndex=f,m=a.exec(C),m!==null);)f=a.lastIndex,a===a1?m[1]==="!--"?a=i2:m[1]!==void 0?a=o2:m[2]!==void 0?(c2.test(m[2])&&(o=RegExp("</"+m[2],"g")),a=G):m[3]!==void 0&&(a=G):a===G?m[0]===">"?(a=o??a1,v=-1):m[1]===void 0?v=-2:(v=a.lastIndex-m[2].length,g=m[1],a=m[3]===void 0?G:m[3]==='"'?a2:n2):a===a2||a===n2?a=G:a===i2||a===o2?a=a1:(a=G,o=void 0);const u=a===G&&e[h+1].startsWith("/>")?" ":"";n+=a===a1?C+s9:v>=0?(i.push(g),C.slice(0,v)+e2+C.slice(v)+R+u):C+R+(v===-2?h:u)}return[l2(e,n+(e[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class c1{constructor({strings:t,_$litType$:r},i){let o;this.parts=[];let n=0,a=0;const h=t.length-1,C=this.parts,[g,m]=d9(t,r);if(this.el=c1.createElement(g,i),q.currentNode=this.el.content,r===2||r===3){const v=this.el.content.firstChild;v.replaceWith(...v.childNodes)}for(;(o=q.nextNode())!==null&&C.length<h;){if(o.nodeType===1){if(o.hasAttributes())for(const v of o.getAttributeNames())if(v.endsWith(e2)){const f=m[a++],u=o.getAttribute(v).split(R),k=/([.?@])?(.*)/.exec(f);C.push({type:1,index:n,name:k[2],strings:u,ctor:k[1]==="."?p9:k[1]==="?"?u9:k[1]==="@"?v9:$1}),o.removeAttribute(v)}else v.startsWith(R)&&(C.push({type:6,index:n}),o.removeAttribute(v));if(c2.test(o.tagName)){const v=o.textContent.split(R),f=v.length-1;if(f>0){o.textContent=b1?b1.emptyScript:"";for(let u=0;u<f;u++)o.append(v[u],w1()),q.nextNode(),C.push({type:2,index:++n});o.append(v[f],w1())}}}else if(o.nodeType===8)if(o.data===r2)C.push({type:2,index:n});else{let v=-1;for(;(v=o.data.indexOf(R,v+1))!==-1;)C.push({type:7,index:n}),v+=R.length-1}n++}}static createElement(t,r){const i=F.createElement("template");return i.innerHTML=t,i}}function Y(e,t,r=e,i){var a,h;if(t===W)return t;let o=i!==void 0?(a=r._$Co)==null?void 0:a[i]:r._$Cl;const n=n1(t)?void 0:t._$litDirective$;return(o==null?void 0:o.constructor)!==n&&((h=o==null?void 0:o._$AO)==null||h.call(o,!1),n===void 0?o=void 0:(o=new n(e),o._$AT(e,r,i)),i!==void 0?(r._$Co??(r._$Co=[]))[i]=o:r._$Cl=o),o!==void 0&&(t=Y(e,o._$AS(e,t.values),o,i)),t}class g9{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:r},parts:i}=this._$AD,o=((t==null?void 0:t.creationScope)??F).importNode(r,!0);q.currentNode=o;let n=q.nextNode(),a=0,h=0,C=i[0];for(;C!==void 0;){if(a===C.index){let g;C.type===2?g=new _1(n,n.nextSibling,this,t):C.type===1?g=new C.ctor(n,C.name,C.strings,this,t):C.type===6&&(g=new m9(n,this,t)),this._$AV.push(g),C=i[++h]}a!==(C==null?void 0:C.index)&&(n=q.nextNode(),a++)}return q.currentNode=F,o}p(t){let r=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,r),r+=i.strings.length-2):i._$AI(t[r])),r++}}class _1{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,r,i,o){this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=i,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=Y(this,t,r),n1(t)?t===$||t==null||t===""?(this._$AH!==$&&this._$AR(),this._$AH=$):t!==this._$AH&&t!==W&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):l9(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==$&&n1(this._$AH)?this._$AA.nextSibling.data=t:this.T(F.createTextNode(t)),this._$AH=t}$(t){var n;const{values:r,_$litType$:i}=t,o=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=c1.createElement(l2(i.h,i.h[0]),this.options)),i);if(((n=this._$AH)==null?void 0:n._$AD)===o)this._$AH.p(r);else{const a=new g9(o,this),h=a.u(this.options);a.p(r),this.T(h),this._$AH=a}}_$AC(t){let r=s2.get(t.strings);return r===void 0&&s2.set(t.strings,r=new c1(t)),r}k(t){O1(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let i,o=0;for(const n of t)o===r.length?r.push(i=new _1(this.O(w1()),this.O(w1()),this,this.options)):i=r[o],i._$AI(n),o++;o<r.length&&(this._$AR(i&&i._$AB.nextSibling,o),r.length=o)}_$AR(t=this._$AA.nextSibling,r){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,r);t!==this._$AB;){const o=Q1(t).nextSibling;Q1(t).remove(),t=o}}setConnected(t){var r;this._$AM===void 0&&(this._$Cv=t,(r=this._$AP)==null||r.call(this,t))}}class $1{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,i,o,n){this.type=1,this._$AH=$,this._$AN=void 0,this.element=t,this.name=r,this._$AM=o,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=$}_$AI(t,r=this,i,o){const n=this.strings;let a=!1;if(n===void 0)t=Y(this,t,r,0),a=!n1(t)||t!==this._$AH&&t!==W,a&&(this._$AH=t);else{const h=t;let C,g;for(t=n[0],C=0;C<n.length-1;C++)g=Y(this,h[i+C],r,C),g===W&&(g=this._$AH[C]),a||(a=!n1(g)||g!==this._$AH[C]),g===$?t=$:t!==$&&(t+=(g??"")+n[C+1]),this._$AH[C]=g}a&&!o&&this.j(t)}j(t){t===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class p9 extends $1{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===$?void 0:t}}class u9 extends $1{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==$)}}class v9 extends $1{constructor(t,r,i,o,n){super(t,r,i,o,n),this.type=5}_$AI(t,r=this){if((t=Y(this,t,r,0)??$)===W)return;const i=this._$AH,o=t===$&&i!==$||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==$&&(i===$||o);o&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var r;typeof this._$AH=="function"?this._$AH.call(((r=this.options)==null?void 0:r.host)??this.element,t):this._$AH.handleEvent(t)}}class m9{constructor(t,r,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Y(this,t)}}const B1=o1.litHtmlPolyfillSupport;B1==null||B1(c1,_1),(o1.litHtmlVersions??(o1.litHtmlVersions=[])).push("3.3.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const C2={ATTRIBUTE:1,CHILD:2},h2=e=>(...t)=>({_$litDirective$:e,values:t});class d2{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,i){this._$Ct=t,this._$AM=r,this._$Ci=i}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const x=h2(class extends d2{constructor(e){var t;if(super(e),e.type!==C2.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var i,o;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(n=>n!=="")));for(const n in t)t[n]&&!((i=this.nt)!=null&&i.has(n))&&this.st.add(n);return this.render(t)}const r=e.element.classList;for(const n of this.st)n in t||(r.remove(n),this.st.delete(n));for(const n in t){const a=!!t[n];a===this.st.has(n)||(o=this.nt)!=null&&o.has(n)||(a?(r.add(n),this.st.add(n)):(r.remove(n),this.st.delete(n)))}return W}});var s1=(e,t=[])=>({parts:(...r)=>{if(f9(t))return s1(e,r);throw new Error("createAnatomy().parts(...) should only be called once. Did you mean to use .extendWith(...) ?")},extendWith:(...r)=>s1(e,[...t,...r]),omit:(...r)=>s1(e,t.filter(i=>!r.includes(i))),rename:r=>s1(r,t),keys:()=>t,build:()=>[...new Set(t)].reduce((r,i)=>Object.assign(r,{[i]:{selector:[`&[data-scope="${Q(e)}"][data-part="${Q(i)}"]`,`& [data-scope="${Q(e)}"][data-part="${Q(i)}"]`].join(", "),attrs:{"data-scope":Q(e),"data-part":Q(i)}}}),{})}),Q=e=>e.replace(/([A-Z])([A-Z])/g,"$1-$2").replace(/([a-z])([A-Z])/g,"$1-$2").replace(/[\s_]+/g,"-").toLowerCase(),f9=e=>e.length===0,y9=s1("accordion").parts("root","item","itemTrigger","itemContent","itemIndicator"),l1=y9.build(),g2=e=>typeof e=="object"&&e!==null,K=e=>e?"":void 0,b9=9,w9=e=>g2(e)&&e.nodeType===b9,_9=e=>g2(e)&&e===e.window;function $9(e){if(!e)return!1;const t=e.getRootNode();return p2(t)===e}function k9(e){return w9(e)?e:_9(e)?e.document:(e==null?void 0:e.ownerDocument)??document}function p2(e){let t=e.activeElement;for(;t!=null&&t.shadowRoot;){const r=t.shadowRoot.activeElement;if(!r||r===t)break;t=r}return t}var u2=()=>typeof document<"u";function L9(){const e=navigator.userAgentData;return(e==null?void 0:e.platform)??navigator.platform}var I1=e=>u2()&&e.test(L9()),H9=e=>u2()&&e.test(navigator.vendor),M9=()=>I1(/^iPhone/i),V9=()=>I1(/^iPad/i)||v2()&&navigator.maxTouchPoints>1,x9=()=>M9()||V9(),S9=()=>v2()||x9(),v2=()=>I1(/^Mac/i),Z9=()=>S9()&&H9(/apple/i),A9={Up:"ArrowUp",Down:"ArrowDown",Esc:"Escape"," ":"Space",",":"Comma",Left:"ArrowLeft",Right:"ArrowRight"},m2={ArrowLeft:"ArrowRight",ArrowRight:"ArrowLeft"};function E9(e,t={}){const{dir:r="ltr",orientation:i="horizontal"}=t;let o=e.key;return o=A9[o]??o,r==="rtl"&&i==="horizontal"&&o in m2&&(o=m2[o]),o}function P9(e,t){return Array.from((e==null?void 0:e.querySelectorAll(t))??[])}var f2=e=>e.id;function z9(e,t,r=f2){return e.find(i=>r(i)===t)}function y2(e,t,r=f2){const i=z9(e,t,r);return i?e.indexOf(i):-1}function O9(e,t,r=!0){let i=y2(e,t);return i=r?(i+1)%e.length:Math.min(i+1,e.length-1),e[i]}function T9(e,t,r=!0){let i=y2(e,t);return i===-1?r?e[e.length-1]:null:(i=r?(i-1+e.length)%e.length:Math.max(0,i-1),e[i])}function B9(e){return e==null?[]:Array.isArray(e)?e:[e]}var I9=e=>e[0],R9=e=>e[e.length-1],D9=(e,...t)=>e.concat(t),N9=(e,...t)=>e.filter(r=>!t.includes(r)),j9=e=>typeof e=="string",C1=e=>typeof e=="function",U9=Function.prototype.toString;U9.call(Object);var b2=(...e)=>(...t)=>{e.forEach(function(r){r==null||r(...t)})};function F9(...e){const t=e.length===1?e[0]:e[1];(e.length===2?e[0]:!0)&&process.env.NODE_ENV!=="production"&&console.warn(t)}function w2(...e){const t=e.length===1?e[0]:e[1];if((e.length===2?e[0]:!0)&&process.env.NODE_ENV!=="production")throw new Error(t)}function _2(e,t){if(e==null)throw new Error(t())}var k1=e=>{var t;return((t=e.ids)==null?void 0:t.root)??`accordion:${e.id}`},G9=(e,t)=>{var r,i;return((i=(r=e.ids)==null?void 0:r.item)==null?void 0:i.call(r,t))??`accordion:${e.id}:item:${t}`},R1=(e,t)=>{var r,i;return((i=(r=e.ids)==null?void 0:r.itemContent)==null?void 0:i.call(r,t))??`accordion:${e.id}:content:${t}`},L1=(e,t)=>{var r,i;return((i=(r=e.ids)==null?void 0:r.itemTrigger)==null?void 0:i.call(r,t))??`accordion:${e.id}:trigger:${t}`},W9=e=>e.getById(k1(e)),H1=e=>{const r=`[data-controls][data-ownedby='${CSS.escape(k1(e))}']:not([disabled])`;return P9(W9(e),r)},q9=e=>I9(H1(e)),K9=e=>R9(H1(e)),X9=(e,t)=>O9(H1(e),L1(e,t)),J9=(e,t)=>T9(H1(e),L1(e,t));function Y9(e,t){const{send:r,context:i,prop:o,scope:n,computed:a}=e,h=i.get("focusedValue"),C=i.get("value"),g=o("multiple");function m(f){let u=f;!g&&u.length>1&&(u=[u[0]]),r({type:"VALUE.SET",value:u})}function v(f){return{expanded:C.includes(f.value),focused:h===f.value,disabled:!!(f.disabled??o("disabled"))}}return{focusedValue:h,value:C,setValue:m,getItemState:v,getRootProps(){return t.element({...l1.root.attrs,dir:o("dir"),id:k1(n),"data-orientation":o("orientation")})},getItemProps(f){const u=v(f);return t.element({...l1.item.attrs,dir:o("dir"),id:G9(n,f.value),"data-state":u.expanded?"open":"closed","data-focus":K(u.focused),"data-disabled":K(u.disabled),"data-orientation":o("orientation")})},getItemContentProps(f){const u=v(f);return t.element({...l1.itemContent.attrs,dir:o("dir"),role:"region",id:R1(n,f.value),"aria-labelledby":L1(n,f.value),hidden:!u.expanded,"data-state":u.expanded?"open":"closed","data-disabled":K(u.disabled),"data-focus":K(u.focused),"data-orientation":o("orientation")})},getItemIndicatorProps(f){const u=v(f);return t.element({...l1.itemIndicator.attrs,dir:o("dir"),"aria-hidden":!0,"data-state":u.expanded?"open":"closed","data-disabled":K(u.disabled),"data-focus":K(u.focused),"data-orientation":o("orientation")})},getItemTriggerProps(f){const{value:u}=f,k=v(f);return t.button({...l1.itemTrigger.attrs,type:"button",dir:o("dir"),id:L1(n,u),"aria-controls":R1(n,u),"data-controls":R1(n,u),"aria-expanded":k.expanded,disabled:k.disabled,"data-orientation":o("orientation"),"data-state":k.expanded?"open":"closed","data-focus":K(k.focused),"data-ownedby":k1(n),onFocus(){k.disabled||r({type:"TRIGGER.FOCUS",value:u})},onBlur(){k.disabled||r({type:"TRIGGER.BLUR"})},onClick(B){k.disabled||(Z9()&&B.currentTarget.focus(),r({type:"TRIGGER.CLICK",value:u}))},onKeyDown(B){if(B.defaultPrevented||k.disabled)return;const t1={ArrowDown(){a("isHorizontal")||r({type:"GOTO.NEXT",value:u})},ArrowUp(){a("isHorizontal")||r({type:"GOTO.PREV",value:u})},ArrowRight(){a("isHorizontal")&&r({type:"GOTO.NEXT",value:u})},ArrowLeft(){a("isHorizontal")&&r({type:"GOTO.PREV",value:u})},Home(){r({type:"GOTO.FIRST",value:u})},End(){r({type:"GOTO.LAST",value:u})}},E=E9(B,{dir:o("dir"),orientation:o("orientation")}),P=t1[E];P&&(P(B),B.preventDefault())}})}}}var D=".",$2="#",k2=new WeakMap,L2=new WeakMap;function D1(e){return e.join(D)}function Q9(e){return e.includes(D)}function H2(e){return e.startsWith($2)}function t0(e){return e.startsWith(D)}function e0(e){return H2(e)?e.slice($2.length):e}function N1(e,t){return e?`${e}${D}${t}`:t}function r0(e){const t=new Map,r=new Map,i=(o,n)=>{t.set(o,n);const a=n.id;a&&(r.has(a)&&w2(`[zag-js] Duplicate state id: "${a}"`),r.set(a,o));const h=n.states;if(h){_2(n.initial,()=>`[zag-js] Compound state "${o}" has child states but no "initial" property`),n.initial in h||w2(`[zag-js] Compound state "${o}" has initial "${String(n.initial)}" which is not a child state`);for(const[C,g]of Object.entries(h)){if(!g)continue;const m=N1(o,C);i(m,g)}}};for(const[o,n]of Object.entries(e.states))n&&i(o,n);return{index:t,idIndex:r}}function h1(e){const t=k2.get(e);if(t)return t;const{index:r,idIndex:i}=r0(e);return k2.set(e,r),L2.set(e,i),r}function i0(e,t){var r;return h1(e),(r=L2.get(e))==null?void 0:r.get(t)}function j1(e){return e?String(e).split(D).filter(Boolean):[]}function M1(e,t){if(!t)return[];const r=h1(e),i=j1(t),o=[],n=[];for(const a of i){n.push(a);const h=D1(n),C=r.get(h);if(!C)break;o.push({path:h,state:C})}return o}function d1(e,t){const r=h1(e),i=j1(t);if(!i.length)return t;const o=[];for(const h of i){o.push(h);const C=D1(o);if(!r.has(C))return t}let n=D1(o),a=r.get(n);for(;a!=null&&a.initial;){const h=`${n}${D}${a.initial}`,C=r.get(h);if(!C)break;n=h,a=C}return n}function M2(e,t){return h1(e).has(t)}function V2(e,t,r){const i=String(t);if(H2(i)){const o=e0(i),n=i0(e,o);return _2(n,()=>`[zag-js] Unknown state id: "${o}"`),d1(e,n)}if(t0(i)&&r){const o=N1(r,i.slice(1));return d1(e,o)}if(!Q9(i)&&r){const o=j1(r);for(let n=o.length-1;n>=1;n--){const a=o.slice(0,n).join(D),h=N1(a,i);if(M2(e,h))return d1(e,h)}if(M2(e,i))return d1(e,i)}return d1(e,i)}function o0(e,t,r){var n,a;const i=M1(e,t);for(let h=i.length-1;h>=0;h--){const C=(n=i[h])==null?void 0:n.state.on,g=C==null?void 0:C[r];if(g)return{transitions:g,source:(a=i[h])==null?void 0:a.path}}const o=e.on;return{transitions:o==null?void 0:o[r],source:void 0}}function n0(e,t,r,i){var m,v,f,u;const o=t?M1(e,t):[],n=M1(e,r);let a=0;for(;a<o.length&&a<n.length&&((m=o[a])==null?void 0:m.path)===((v=n[a])==null?void 0:v.path);)a+=1;let h=o.slice(a).reverse(),C=n.slice(a);const g=((f=o.at(-1))==null?void 0:f.path)===((u=n.at(-1))==null?void 0:u.path);return i&&g&&(h=o.slice().reverse(),C=n),{exiting:h,entering:C}}function a0(e,t){return e?e===t||e.startsWith(`${t}${D}`):!1}function c0(e,t,r){return M1(e,t).some(i=>{var o;return(o=i.state.tags)==null?void 0:o.includes(r)})}function s0(){return{and:(...e)=>function(r){return e.every(i=>r.guard(i))},or:(...e)=>function(r){return e.some(i=>r.guard(i))},not:e=>function(r){return!r.guard(e)}}}function l0(e){return h1(e),e}var g1=(e=>(e.NotStarted="Not Started",e.Started="Started",e.Stopped="Stopped",e))(g1||{}),V1="__init__";function C0(e){const t=()=>{var a;return((a=e.getRootNode)==null?void 0:a.call(e))??document},r=()=>k9(t());return{...e,getRootNode:t,getDoc:r,getWin:()=>r().defaultView??window,getActiveElement:()=>p2(t()),isActiveElement:$9,getById:a=>t().getElementById(a)}}var{and:h0,not:d0}=s0(),g0=l0({props({props:e}){return{collapsible:!1,multiple:!1,orientation:"vertical",defaultValue:[],...e}},initialState(){return"idle"},context({prop:e,bindable:t}){return{focusedValue:t(()=>({defaultValue:null,sync:!0,onChange(r){var i;(i=e("onFocusChange"))==null||i({value:r})}})),value:t(()=>({defaultValue:e("defaultValue"),value:e("value"),onChange(r){var i;(i=e("onValueChange"))==null||i({value:r})}}))}},computed:{isHorizontal:({prop:e})=>e("orientation")==="horizontal"},on:{"VALUE.SET":{actions:["setValue"]}},states:{idle:{on:{"TRIGGER.FOCUS":{target:"focused",actions:["setFocusedValue"]}}},focused:{on:{"GOTO.NEXT":{actions:["focusNextTrigger"]},"GOTO.PREV":{actions:["focusPrevTrigger"]},"TRIGGER.CLICK":[{guard:h0("isExpanded","canToggle"),actions:["collapse"]},{guard:d0("isExpanded"),actions:["expand"]}],"GOTO.FIRST":{actions:["focusFirstTrigger"]},"GOTO.LAST":{actions:["focusLastTrigger"]},"TRIGGER.BLUR":{target:"idle",actions:["clearFocusedValue"]}}}},implementations:{guards:{canToggle:({prop:e})=>!!e("collapsible")||!!e("multiple"),isExpanded:({context:e,event:t})=>e.get("value").includes(t.value)},actions:{collapse({context:e,prop:t,event:r}){const i=t("multiple")?N9(e.get("value"),r.value):[];e.set("value",i)},expand({context:e,prop:t,event:r}){const i=t("multiple")?D9(e.get("value"),r.value):[r.value];e.set("value",i)},focusFirstTrigger({scope:e}){var t;(t=q9(e))==null||t.focus()},focusLastTrigger({scope:e}){var t;(t=K9(e))==null||t.focus()},focusNextTrigger({context:e,scope:t}){const r=e.get("focusedValue");if(!r)return;const i=X9(t,r);i==null||i.focus()},focusPrevTrigger({context:e,scope:t}){const r=e.get("focusedValue");if(!r)return;const i=J9(t,r);i==null||i.focus()},setFocusedValue({context:e,event:t}){e.set("focusedValue",t.value)},clearFocusedValue({context:e}){e.set("focusedValue",null)},setValue({context:e,event:t}){e.set("value",t.value)},coarseValue({context:e,prop:t}){!t("multiple")&&e.get("value").length>1&&(F9("The value of accordion should be a single value when multiple is false."),e.set("value",[e.get("value")[0]]))}}}});function p0(e){return new Proxy({},{get(t,r){return r==="style"?i=>e({style:i}).style:e}})}function u0(e,t,r){var B2,I2,R2;const i=e,o=t(),n=C0({id:o.id,ids:o.ids,getRootNode:o.getRootNode??(()=>document)}),a=p=>{var L;const d=t();return(((L=i.props)==null?void 0:L.call(i,{props:d,scope:n}))??d)[p]};function h(p){const d=p(),_=d.isEqual??((b,y)=>b===y),L=d.hash??(b=>String(b)),H={current:d.value!==void 0?d.value:d.defaultValue};return{initial:d.defaultValue,ref:H,get:()=>H.current,set(b){var v1;const y=H.current,w=C1(b)?b(y):b;_(w,y)||(H.current=w,(v1=d.onChange)==null||v1.call(d,w,y),r())},invoke(b,y){var w;(w=d.onChange)==null||w.call(d,b,y)},hash:L}}h.cleanup=p=>{},h.ref=p=>{const d={current:p};return{get:()=>d.current,set:_=>d.current=_}};const C=(B2=i.context)==null?void 0:B2.call(i,{prop:a,bindable:h,scope:n,flush:p=>p(),getContext:()=>g,getComputed:()=>S1,getRefs:()=>t1,getEvent:()=>k()}),g={get:p=>C==null?void 0:C[p].get(),set:(p,d)=>C==null?void 0:C[p].set(d),initial:p=>C==null?void 0:C[p].initial,hash:p=>{const d=C==null?void 0:C[p].get();return C==null?void 0:C[p].hash(d)}};let m=new Map;const v={current:null},f={current:null},u={current:{type:""}},k=()=>({...u.current,current:()=>u.current,previous:()=>f.current}),B=()=>({get:()=>U.get(),matches:(...p)=>p.some(d=>a0(U.get(),d)),hasTag:p=>c0(i,U.get(),p)}),t1=((I2=i.refs)==null?void 0:I2.call(i,{prop:a,context:g}))??{},E=()=>({state:B(),context:g,event:k(),prop:a,send:T2,action:P,guard:P2,track:()=>{},refs:t1,computed:S1,flush:p=>p(),scope:n,choose:O2}),P=p=>{var _,L;const d=C1(p)?p(E()):p;if(d)for(const H of d){const b=(L=(_=i.implementations)==null?void 0:_.actions)==null?void 0:L[H];b==null||b(E())}},P2=p=>{var d,_,L;return C1(p)?p(E()):(L=(_=(d=i.implementations)==null?void 0:d.guards)==null?void 0:_[p])==null?void 0:L.call(_,E())},z2=p=>{var L,H;const d=C1(p)?p(E()):p;if(!d)return;const _=[];for(const b of d){const y=(H=(L=i.implementations)==null?void 0:L.effects)==null?void 0:H[b],w=y==null?void 0:y(E());w&&_.push(w)}return()=>_.forEach(b=>b==null?void 0:b())},O2=p=>B9(p).find(d=>d!=null&&d.guard?j9(d.guard)?!!P2(d.guard):C1(d.guard)?d.guard(E()):!1:!0),S1=p=>{var _;const d=(_=i.computed)==null?void 0:_[p];return d==null?void 0:d({context:g,event:k(),prop:a,refs:t1,scope:n,computed:S1})},U=h(()=>({defaultValue:V2(i,i.initialState({prop:a})),onChange(p,d){var H,b;const{exiting:_,entering:L}=n0(i,d,p,(H=v.current)==null?void 0:H.reenter);if(_.forEach(y=>{var w;(w=m.get(y.path))==null||w(),m.delete(y.path)}),_.forEach(y=>{var w;return P((w=y.state)==null?void 0:w.exit)}),P((b=v.current)==null?void 0:b.actions),L.forEach(y=>{var v1;const w=z2((v1=y.state)==null?void 0:v1.effects);if(w){const D2=m.get(y.path);m.set(y.path,D2?b2(D2,w):w)}}),d===V1){P(i.entry);const y=z2(i.effects);if(y){const w=m.get(V1);m.set(V1,w?b2(w,y):y)}}L.forEach(y=>{var w;return P((w=y.state)==null?void 0:w.entry)})}}));let Z1=g1.NotStarted;function q0(){Z1=g1.Started,U.invoke(U.initial,V1)}function K0(){Z1=g1.Stopped,m.forEach(p=>p==null?void 0:p()),m=new Map,v.current=null,P(i.exit)}const T2=p=>{if(Z1!==g1.Started)return;f.current=u.current,u.current=p;const d=U.get(),{transitions:_,source:L}=o0(i,d,p.type),H=O2(_);if(!H)return;v.current=H;const b=V2(i,H.target??d,L);b!==d?U.set(b):H.reenter?U.invoke(d,d):P(H.actions)};return(R2=i.watch)==null||R2.call(i,E()),{state:B(),send:T2,get event(){return k()},context:{get:g.get,set:g.set},prop:a,scope:n,refs:t1,computed:S1,start:q0,stop:K0,getStatus:()=>Z1}}const v0=p0(e=>e);var m0=Object.defineProperty,f0=Object.getOwnPropertyDescriptor,X=(e,t,r,i)=>{for(var o=i>1?void 0:i?f0(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&m0(t,r,o),o};let y0=0;const b0=s.html`
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const x2=Symbol.for(""),$0=e=>{if((e==null?void 0:e.r)===x2)return e==null?void 0:e._$litStatic$},S2=e=>({_$litStatic$:e,r:x2}),Z2=new Map,k0=e=>(t,...r)=>{const i=r.length;let o,n;const a=[],h=[];let C,g=0,m=!1;for(;g<i;){for(C=t[g];g<i&&(n=r[g],(o=$0(n))!==void 0);)C+=o+t[++g],m=!0;g!==i&&h.push(n),a.push(C),g++}if(g===i&&a.push(t[i]),m){const v=a.join("$$lit$$");(t=Z2.get(v))===void 0&&(a.raw=a,Z2.set(v,t=a)),r=h}return e(t,...r)},U1=k0(h9);var L0=Object.defineProperty,H0=Object.getOwnPropertyDescriptor,p1=(e,t,r,i)=>{for(var o=i>1?void 0:i?H0(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&L0(t,r,o),o};const M0=["1","2","3","4","5","6"];c.CtHeading=class extends s.LitElement{constructor(){super(...arguments),this.theme="light",this.content="",this.level="2",this.modifierClass=""}render(){const t=M0.includes(this.level)?this.level:"2",r=S2(`h${t}`),i={"ct-heading":!0,[`ct-theme-${this.theme}`]:!0,[`ct-heading--level-${t}`]:!0,[this.modifierClass]:!!this.modifierClass};return this.content?U1`<${r} class=${x(i)} data-component-name="heading">${this.content}<slot></slot></${r}>`:s.nothing}},c.CtHeading.styles=s.css`
    :host {
      display: block;
    }
  ...
  `,p1([l({type:String})],c.CtHeading.prototype,"theme",2),p1([l({type:String})],c.CtHeading.prototype,"content",2),p1([l({type:String})],c.CtHeading.prototype,"level",2),p1([l({type:String,attribute:"modifier-class"})],c.CtHeading.prototype,"modifierClass",2),c.CtHeading=p1([M("ct-heading")],c.CtHeading);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class F1 extends d2{constructor(t){if(super(t),this.it=$,t.type!==C2.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===$||t==null)return this._t=void 0,this.it=t;if(t===W)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const r=[t];return r.raw=r,this._t={_$litType$:this.constructor.resultType,strings:r,values:[]}}}F1.directiveName="unsafeHTML",F1.resultType=1;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class G1 extends F1{}G1.directiveName="unsafeSVG",G1.resultType=2;const V0=h2(G1),x0=["account","approve","bars","bullet","calendar-1","calendar-2","call","cancel","checked","close-outline","close","document","down-arrow-1","down-arrow-2","download-file","download","exclamation-mark-1","exclamation-mark-2","exclamation-mark-3","eye","facebook","help","image","information-mark","instagram","layer","layers","left-arrow-outline","left-arrow","linkedin","lock-file","lock-gallery","magnifier","map","megaphone","message","mobile","mortarboard","newspaper","open-source","pdf-file","progress","right-arrow-1","right-arrow-2","select-box","share","square","to-do","twitter","up-arrow","upper-arrow","upper-right-arrow","users","watch","water-drop","web","word-file","x","youtube"],A2={account:`<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<path d="M23 9.70998C23.0495 8.27864 22.7365 6.858 22.09 5.57998C21.6514 5.05558 21.0427 4.70169 20.37 4.57998C17.5875 4.32751 14.7936 4.22403 12 4.26998C9.21667 4.22194 6.43274 4.32208 3.66003 4.56998C3.11185 4.6697 2.60454 4.92683 2.20003 5.30998C1.30003 6.13998 1.20003 7.55998 1.10003 8.75998C0.954939 10.9175 0.954939 13.0824 1.10003 15.24C1.12896 15.9154 1.22952 16.5858 1.40003 17.24C1.5206 17.745 1.76455 18.2123 2.11003 18.6C2.51729 19.0034 3.03641 19.2752 3.60003 19.38C5.75594 19.6461 7.92824 19.7564 10.1 19.71C13.6 19.76 16.67 19.71 20.3 19.43C20.8775 19.3316 21.4112 19.0595 21.83 18.65C22.11 18.3699 22.3191 18.0271 22.44 17.65C22.7977 16.5526 22.9733 15.4041 22.96 14.25C23 13.69 23 10.31 23 9.70998ZM9.74003 14.85V8.65998L15.66 11.77C14 12.69 11.81 13.73 9.74003 14.85Z" />
</svg>`};var S0=Object.defineProperty,Z0=Object.getOwnPropertyDescriptor,x1=(e,t,r,i)=>{for(var o=i>1?void 0:i?Z0(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&S0(t,r,o),o};c.CtIcon=class extends s.LitElement{constructor(){super(...arguments),this.modifierClass=""}render(){const t=this.name?A2[this.name]:void 0;if(!t)return s.nothing;const r=["ct-icon",this.size?`ct-icon--size-${this.size}`:"",this.modifierClass].filter(Boolean).join(" "),i=t.replace(/^<svg /,`<svg class="${r}" aria-hidden="true" role="img" `);return s.html`${V0(i)}`}},c.CtIcon.styles=s.css`
    :host {
  ...
  `,x1([l({type:String})],c.CtIcon.prototype,"name",2),x1([l({type:String})],c.CtIcon.prototype,"size",2),x1([l({type:String,attribute:"modifier-class"})],c.CtIcon.prototype,"modifierClass",2),c.CtIcon=x1([M("ct-icon")],c.CtIcon);var A0=Object.defineProperty,E0=Object.getOwnPropertyDescriptor,S=(e,t,r,i)=>{for(var o=i>1?void 0:i?E0(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&A0(t,r,o),o};c.CtLink=class extends s.LitElement{constructor(){super(...arguments),this.theme="light",this.label="",this.newWindow=!1,this.external=!1,this.active=!1,this.disabled=!1,this.iconPlacement="after",this.iconGroupDisabled=!1,this.iconSingleOnly=!1,this.modifierClass=""}renderContent(){const t=this.external&&this.iconSingleOnly?"upper-right-arrow":this.icon,r=!!t||this.external,i=this.newWindow?s.html`<span class="ct-visually-hidden">(Opens in a new tab/window)</span>`:s.nothing;if(!r)return s.html`<span class="ct-link__text">${this.label}</span>${i}`;const o=t?s.html`<ct-icon class="ct-link__icon" name=${t}></ct-icon>`:s.nothing;if(!this.label)return s.html`${o}${i}`;const n=this.label.trim().split(/\s+/),a=n[n.length-1]??"",h=n.slice(0,-1).join(" "),C=this.iconGroupDisabled||this.iconPlacement==="before"&&!this.external,g=this.iconPlacement==="before"?o:s.nothing,m=s.html`
    ...
    `;return C?s.html`${g}<span class="ct-link__text">${this.label}</span>${m}${i}`:s.html`
      ${g}<span class="ct-link__text">${h} </span
      ><span class="ct-link__group"><span class="ct-link__text">${a}</span> ${m}</span
      >${i}
    `}render(){const t=!!this.icon&&!this.label,r={"ct-link":!0,[`ct-theme-${this.theme}`]:!0,"ct-link--external":this.external,"ct-link--active":this.active,"ct-link--disabled":this.disabled,"ct-link--only-icon":t,[this.modifierClass]:!!this.modifierClass};return!this.label&&!this.icon?s.nothing:s.html`
      <a
        ...
        href=${V(this.url)}
        title=${V(this.linkTitle)}
        target=${V(this.newWindow?"_blank":void 0)}
        rel=${V(this.newWindow?"noopener noreferrer":void 0)}
  ...
  `,S([l({type:String})],c.CtLink.prototype,"theme",2),S([l({type:String})],c.CtLink.prototype,"label",2),S([l({type:String})],c.CtLink.prototype,"url",2),S([l({type:String,attribute:"title"})],c.CtLink.prototype,"linkTitle",2),S([l({type:Boolean,attribute:"new-window"})],c.CtLink.prototype,"newWindow",2),S([l({type:Boolean})],c.CtLink.prototype,"external",2),S([l({type:Boolean,reflect:!0})],c.CtLink.prototype,"active",2),S([l({type:Boolean,reflect:!0})],c.CtLink.prototype,"disabled",2),S([l({type:String})],c.CtLink.prototype,"icon",2),S([l({type:String,attribute:"icon-placement"})],c.CtLink.prototype,"iconPlacement",2),S([l({type:Boolean,attribute:"icon-group-disabled"})],c.CtLink.prototype,"iconGroupDisabled",2),S([l({type:Boolean,attribute:"icon-single-only"})],c.CtLink.prototype,"iconSingleOnly",2),S([l({type:String,attribute:"modifier-class"})],c.CtLink.prototype,"modifierClass",2),c.CtLink=S([M("ct-link")],c.CtLink);var P0=Object.defineProperty,z0=Object.getOwnPropertyDescriptor,J=(e,t,r,i)=>{for(var o=i>1?void 0:i?z0(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&P0(t,r,o),o};c.CtAttachment=class extends s.LitElement{constructor(){super(...arguments),this.theme="light",this.title="",this.content="",this.withBackground=!1,this.verticalSpacing="none",this.modifierClass=""}_files(){return Array.from(this.querySelectorAll(":scope > ct-attachment-file"))}render(){const t=this._files();if(t.length===0)return s.nothing;const r={"ct-attachment":!0,[`ct-theme-${this.theme}`]:!0,"ct-attachment--with-background":this.withBackground,[`ct-vertical-spacing-inset--${this.verticalSpacing}`]:this.verticalSpacing!=="none",[this.modifierClass]:!!this.modifierClass};return s.html`
      <div class=${x(r)}>
  ...
  `,O([l({type:String})],c.CtChip.prototype,"theme",2),O([l({type:String})],c.CtChip.prototype,"kind",2),O([l({type:String})],c.CtChip.prototype,"size",2),O([l({type:String})],c.CtChip.prototype,"content",2),O([l({type:String})],c.CtChip.prototype,"url",2),O([l({type:String})],c.CtChip.prototype,"label",2),O([l({type:Boolean,reflect:!0})],c.CtChip.prototype,"selected",2),O([l({type:Boolean,reflect:!0})],c.CtChip.prototype,"disabled",2),c.CtChip=O([M("ct-chip")],c.CtChip);var R0=Object.defineProperty,D0=Object.getOwnPropertyDescriptor,j=(e,t,r,i)=>{for(var o=i>1?void 0:i?D0(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&R0(t,r,o),o};c.CtContentLink=class extends s.LitElement{constructor(){super(...arguments),this.theme="light",this.text="",this.newWindow=!1,this.external=!1,this.modifierClass=""}renderContent(){const t=this.newWindow?s.html`<span class="ct-visually-hidden">(Opens in a new tab/window)</span>`:s.nothing;if(!this.external)return s.html`<span class="ct-content-link__text">${this.text}</span>${t}`;const r=this.text.trim().split(/\s+/),i=r[r.length-1]??"",o=r.slice(0,-1).join(" "),n=s.html`<ct-icon class="ct-content-link__icon" name="upper-right-arrow"></ct-icon>`;return s.html`
  ...
  `,j([l({type:String})],c.CtContentLink.prototype,"theme",2),j([l({type:String})],c.CtContentLink.prototype,"text",2),j([l({type:String})],c.CtContentLink.prototype,"url",2),j([l({type:String,attribute:"title"})],c.CtContentLink.prototype,"linkTitle",2),j([l({type:Boolean,attribute:"new-window"})],c.CtContentLink.prototype,"newWindow",2),j([l({type:Boolean})],c.CtContentLink.prototype,"external",2),j([l({type:String,attribute:"modifier-class"})],c.CtContentLink.prototype,"modifierClass",2),c.CtContentLink=j([M("ct-content-link")],c.CtContentLink);var N0=Object.defineProperty,j0=Object.getOwnPropertyDescriptor,u1=(e,t,r,i)=>{for(var o=i>1?void 0:i?j0(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&N0(t,r,o),o};const E2={information:"information-mark",warning:"exclamation-mark-3",error:"close-outline",success:"approve"};c.CtFieldMessage=class extends s.LitElement{constructor(){super(...arguments),this.theme="light",this.type="information",this.content="",this.modifierClass=""}render(){if(!this.content)return s.nothing;const t=this.type in E2?this.type:"information",r=E2[t],i={"ct-field-message":!0,[`ct-theme-${this.theme}`]:!0,[`ct-field-message--${t}`]:!0,[this.modifierClass]:!!this.modifierClass};return s.html`
  ...
  `,u1([l({type:String})],c.CtFieldMessage.prototype,"theme",2),u1([l({type:String})],c.CtFieldMessage.prototype,"type",2),u1([l({type:String})],c.CtFieldMessage.prototype,"content",2),u1([l({type:String,attribute:"modifier-class"})],c.CtFieldMessage.prototype,"modifierClass",2),c.CtFieldMessage=u1([M("ct-field-message")],c.CtFieldMessage);var U0=Object.defineProperty,F0=Object.getOwnPropertyDescriptor,T=(e,t,r,i)=>{for(var o=i>1?void 0:i?F0(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&U0(t,r,o),o};c.CtLabel=class extends s.LitElement{constructor(){super(...arguments),this.theme="light",this.tag="label",this.content="",this.size="regular",this.required=!1,this.requiredText="(required)",this.modifierClass=""}render(){if(!this.content)return s.nothing;const t=this.tag==="legend"?"legend":"label",r={"ct-label":!0,[`ct-theme-${this.theme}`]:!0,[`ct-label--${this.size}`]:!0,"ct-label--required":this.required,[this.modifierClass]:!!this.modifierClass},i=this.required?U1`<span class="ct-label__required">${this.requiredText}</span>`:s.nothing,o=S2(t);return U1`
      <${o}
        class=${x(r)}
        for=${V(t==="label"?this.for:void 0)}
  ...
  `,T([l({type:String})],c.CtLabel.prototype,"theme",2),T([l({type:String})],c.CtLabel.prototype,"tag",2),T([l({type:String})],c.CtLabel.prototype,"content",2),T([l({type:String})],c.CtLabel.prototype,"size",2),T([l({type:Boolean})],c.CtLabel.prototype,"required",2),T([l({type:String,attribute:"required-text"})],c.CtLabel.prototype,"requiredText",2),T([l({type:String})],c.CtLabel.prototype,"for",2),T([l({type:String,attribute:"modifier-class"})],c.CtLabel.prototype,"modifierClass",2),c.CtLabel=T([M("ct-label")],c.CtLabel);var G0=Object.defineProperty,W0=Object.getOwnPropertyDescriptor,A=(e,t,r,i)=>{for(var o=i>1?void 0:i?W0(t,r):t,n=e.length-1,a;n>=0;n--)(a=e[n])&&(o=(i?a(t,r,o):a(o))||o);return i&&o&&G0(t,r,o),o};c.CtTag=class extends s.LitElement{constructor(){super(...arguments),this.theme="light",this.variant="primary",this.label="",this.iconPlacement="after",this.newWindow=!1,this.external=!1,this.modifierClass=""}render(){if(!this.label)return s.nothing;const t={"ct-tag":!0,[`ct-theme-${this.theme}`]:!0,[`ct-tag--${this.variant}`]:!0,[`ct-tag--icon-${this.iconPlacement}`]:!!this.icon,"ct-tag--external":this.external,[this.modifierClass]:!!this.modifierClass},r=this.icon?s.html`<ct-icon class="ct-tag__icon" name=${this.icon} size="small"></ct-icon>`:s.nothing,i=s.html`<span class="ct-tag__text">${this.label}</span>`,o=this.url&&this.newWindow?s.html`<span class="ct-visually-hidden">(Opens in a new tab/window)</span>`:s.nothing,n=this.external?s.html`<ct-icon class="ct-tag__icon" name="upper-right-arrow" size="small"></ct-icon>`:s.nothing,a=s.html`
    ...
    `;return this.url?s.html`
        <a
          ...
          title=${this.label}
          target=${V(this.newWindow?"_blank":void 0)}
          aria-label=${V(this.newWindow?"Opens in a new tab":void 0)}
  ...
  `,A([l({type:String})],c.CtTag.prototype,"theme",2),A([l({type:String})],c.CtTag.prototype,"variant",2),A([l({type:String})],c.CtTag.prototype,"label",2),A([l({type:String})],c.CtTag.prototype,"icon",2),A([l({type:String,attribute:"icon-placement"})],c.CtTag.prototype,"iconPlacement",2),A([l({type:String})],c.CtTag.prototype,"url",2),A([l({type:Boolean,attribute:"new-window"})],c.CtTag.prototype,"newWindow",2),A([l({type:Boolean})],c.CtTag.prototype,"external",2),A([l({type:String,attribute:"modifier-class"})],c.CtTag.prototype,"modifierClass",2),c.CtTag=A([M("ct-tag")],c.CtTag),c.ICON_NAMES=x0,c.ICON_SOURCES=A2,Object.defineProperty(c,Symbol.toStringTag,{value:"Module"})});
