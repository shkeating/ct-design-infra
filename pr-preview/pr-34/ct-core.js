...
import { BreakpointM as O, BreakpointL as ne, BreakpointXl as hr, BreakpointXs as pi, BreakpointS as gi, BreakpointXxl as ui } from "@ct-infra/tokens";
/**
 * @license
 ...
 */
const L = (t) => t ?? W;
var No = Object.defineProperty, qo = Object.getOwnPropertyDescriptor, it = (t, e, r, i) => {
...
var na = Object.defineProperty, ca = Object.getOwnPropertyDescriptor, ot = (t, e, r, i) => {
...
let lt = class extends H {
  ...
  render() {
    ...
    return p`
      <video
        class=${A(t)}
        title=${L(this.videoTitle)}
        ?controls=${this.hasControls}
        poster=${L(this.poster)}
        width=${L(this.width)}
        height=${L(this.height)}
        data-component-name="video"
      >
        <source src=${this.src} type=${L(this.type)} />
        ${this.fallbackText}
      </video>
    `;
  }
...
function Ni(t, e, r) {
  ...
  const u = { current: null }, m = { current: null }, g = { current: { type: "" } }, v = () => ({
  ...
  }, V = (k) => on(k).find((w) => w != null && w.guard ? dn(w.guard) ? !!M(w.guard) : _e(w.guard) ? w.guard(C()) : !1 : !0), $ = (k) => {
    var T;
    const w = (T = i.computed) == null ? void 0 : T[k];
    return w == null ? void 0 : w({ context: d, event: v(), prop: n, refs: x, scope: a, computed: $ });
  }, E = l(() => ({
    ...
    onChange(k, w) {
      ...
      if (T.forEach((B) => {
        ...
        var Te;
        const q = P((Te = B.state) == null ? void 0 : Te.effects);
        if (q) {
...
let J = class extends H {
  ...
  render() {
    ...
    `;
    return this.url ? p`
        <a class=${A(r)} href=${this.url} title=${L(this.title)}>
          ${o}
        </a>
  ...
  render() {
    ...
    const t = this.theme === "dark" ? "dark" : "light", e = !!this.imageUrl, r = !!this.linkUrl, i = r && !this.isTitleClick, o = {
      ...
      [this.modifierClass]: !!this.modifierClass
          ...
          href=${this.linkUrl}
          target=${L(this.linkNewWindow ? "_blank" : void 0)}
          >${this.title}</a
        >` : this.title;
    return p`
      ...
      <div class=${A(h)} data-component-name="publication-card">
        ${r ? p`
              <div class="ct-publication-card__image">
                <ct-image theme=${t} url=${L(this.imageUrl)} alt=${this.imageAlt} fill></ct-image>
        ...
        <div class="ct-subject-card__content">
          ${e ? p`
                <div class="ct-subject-card__image">
                  <ct-image theme=${this.theme} url=${L(this.imageUrl)} alt=${this.imageAlt}></ct-image>
                </div>
              ` : b}
...
async function Fc(t, e) {
  ...
  } : n.reference, M = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(l.floating)), P = await (a.isElement == null ? void 0 : a.isElement(M)) && await (a.getScale == null ? void 0 : a.getScale(M)) || {
    x: 1,
    y: 1
  ...
  return {
    top: (C.top - V.top + v.top) / P.y,
    bottom: (V.bottom - C.bottom + v.bottom) / P.y,
    left: (C.left - V.left + v.left) / P.x,
    right: (V.right - C.right + v.right) / P.x
  };
}
const Gc = 50, Kc = async (t, e, r) => {
  ...
  for (let f = 0; f < a.length; f++) {
    ...
    h = M ?? h, u = P ?? u, v[C] = {
      ...v[C],
      ...V
    }, $ && g < Gc && (g++, typeof $ == "object" && ($.placement && (m = $.placement), $.rects && (d = $.rects === !0 ? await n.getElementRects({
      reference: t,
      floating: e,
      strategy: o
    }) : $.rects), {
  ...
  async fn(e) {
    ...
    const u = Xi(h), m = {
      x: r,
      y: i
    }, g = Or(o), v = Sr(g), f = await n.getDimensions(d), x = g === "y", C = x ? "top" : "left", y = x ? "bottom" : "right", M = x ? "clientHeight" : "clientWidth", P = a.reference[v] + a.reference[g] - m[g] - a.floating[v], V = m[g] - a.reference[g], $ = await (n.getOffsetParent == null ? void 0 : n.getOffsetParent(d));
    let E = $ ? $[M] : 0;
    (!E || !await (n.isElement == null ? void 0 : n.isElement($))) && (E = l.floating[M] || a.floating[v]);
    const N = P / 2 - V / 2, G = E / 2 - f[v] / 2 - 1, S = Xt(u[C], G), R = Xt(u[y], G), U = E - f[v] - R, K = E / 2 - f[v] / 2 + N, F = Ki(S, K, U), k = !s.arrow && ze(o) != null && K !== F && a.reference[v] / 2 - (K < S ? S : R) - f[v] / 2 < 0, w = k ? K < S ? K - S : K - U : 0;
    return {
      [g]: m[g] + w,
      data: {
        [g]: F,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((r = a.arrow) != null && r.alignmentOffset)
        return {};
      const C = Yt(o), y = _t(l), M = Yt(l) === l, P = await (s.isRTL == null ? void 0 : s.isRTL(d.floating)), V = m || (M || !f ? [$1(l)] : Bc(l)), $ = v !== "none";
      !m && $ && V.push(...Uc(l, f, v, P));
      const E = [l, ...V], N = await s.detectOverflow(e, x), G = [];
      let S = ((i = a.flip) == null ? void 0 : i.overflows) || [];
      if (h && G.push(N[C]), u) {
        const F = Ic(o, n, P);
        G.push(N[F[0]], N[F[1]]);
      }
      if (S = [...S, {
        ...
        S.every((j) => _t(j.placement) === y ? j.overflows[0] > 0 : !0)))
          return {
            data: {
              index: F,
              overflows: S
        ...
        let w = (U = S.filter((T) => T.overflows[0] <= 0).sort((T, j) => T.overflows[1] - j.overflows[1])[0]) == null ? void 0 : U.placement;
        if (!w)
          switch (g) {
            case "bestFit": {
              var K;
              const T = (K = S.filter((j) => {
                if ($) {
...
const t2 = function(t) {
  ...
  return t === void 0 && (t = {}), {
    ...
    fn(e) {
      ...
      if (h) {
        const V = v === "y" ? "height" : "width", $ = l.reference[v] - l.floating[V] + y.mainAxis, E = l.reference[v] + l.reference[V] - y.mainAxis;
        f < $ ? f = $ : f > E && (f = E);
      }
      if (u) {
        var M, P;
        const V = v === "y" ? "width" : "height", $ = Yi.has(Yt(n)), E = l.reference[g] - l.floating[V] + ($ && ((M = s.offset) == null ? void 0 : M[g]) || 0) + ($ ? 0 : y.crossAxis), N = l.reference[g] + l.reference[V] + ($ ? 0 : ((P = s.offset) == null ? void 0 : P[g]) || 0) - ($ ? y.crossAxis : 0);
        x < E ? x = E : x > N && (x = N);
      }
      return {
        [v]: f,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const x = g - s.top - s.bottom, C = m - s.left - s.right, y = Xt(g - s[v], x), M = Xt(m - s[f], C), P = e.middlewareData.shift, V = !P;
      let $ = y, E = M;
      P != null && P.enabled.x && (E = C), P != null && P.enabled.y && ($ = x), V && !h && (u ? E = m - 2 * Vt(s.left, s.right) : $ = g - 2 * Vt(s.top, s.bottom)), await n({
        ...e,
        availableWidth: E,
        availableHeight: $
      });
...
function Ji(t) {
  return j1() ? t instanceof Node || t instanceof et(t).Node : !1;
}
function Ot(t) {
  return j1() ? t instanceof Element || t instanceof et(t).Element : !1;
}
function re(t) {
  return j1() ? t instanceof HTMLElement || t instanceof et(t).HTMLElement : !1;
}
function oi(t) {
  return !j1() || typeof ShadowRoot > "u" ? !1 : t instanceof ShadowRoot || t instanceof et(t).ShadowRoot;
}
function D1(t) {
  const {
    overflow: e,
...
function e1(t, e, r) {
  ...
  const o = Qi(t), a = o === ((i = t.ownerDocument) == null ? void 0 : i.body), n = et(o);
  if (a) {
    const l = dr(n);
...
function s2(t, e, r) {
  return e === void 0 && (e = !1), !!r && e && r === et(t);
}
function be(t, e, r, i) {
  ...
  if (a && i) {
    const m = et(a), g = Ot(i) ? et(i) : i;
    let v = m, f = dr(v);
    for (; f && g !== v; ) {
      const x = $e(f), C = f.getBoundingClientRect(), y = Pt(f), M = C.left + (f.clientLeft + parseFloat(y.paddingLeft)) * x.x, P = C.top + (f.clientTop + parseFloat(y.paddingTop)) * x.y;
      s *= x.x, d *= x.y, h *= x.x, u *= x.y, s += M, d += P, v = et(f), f = dr(v);
    }
  }
  return S1({
    width: h,
...
function u2(t, e, r) {
  r === void 0 && (r = "viewport");
  const i = r === "layoutViewport", o = et(t), a = Rt(t), n = o.visualViewport;
...
function k2(t, e, r) {
  ...
  function l(h, u) {
    ...
    if (h || e(), !f || !x)
      return;
    const C = h1(v), y = h1(a.clientWidth - (g + f)), M = h1(a.clientHeight - (v + x)), P = h1(g), $ = {
      rootMargin: -C + "px " + -y + "px " + -M + "px " + -P + "px",
      threshold: Vt(0, Xt(1, u)) || 1
    };
    let E = !0;
    function N(G) {
      const S = G[0].intersectionRatio;
...
function T2(t, e) {
  return {
    ...
    fn(r) {
      var G, S, R, U;
      const { elements: i, middlewareData: o, placement: a, rects: n, y: l } = r, s = a.split("-")[0], d = E2(s), h = ((G = o.arrow) == null ? void 0 : G.x) || 0, u = ((S = o.arrow) == null ? void 0 : S.y) || 0, m = (e == null ? void 0 : e.clientWidth) || 0, g = (e == null ? void 0 : e.clientHeight) || 0, v = h + m / 2, f = u + g / 2, x = Math.abs(((R = o.shift) == null ? void 0 : R.y) || 0), C = n.reference.height / 2, y = g / 2, M = ((U = t.offset) == null ? void 0 : U.mainAxis) ?? t.gutter, P = typeof M == "number" ? M + y : M ?? y, V = x > P, $ = {
        top: `${v}px calc(100% + ${P}px)`,
        bottom: `${v}px ${-P}px`,
        left: `calc(100% + ${P}px) ${f}px`,
        right: `${-P}px ${f}px`
...
function Y2(t, e, r = {}) {
  const i = () => (typeof e == "function" ? e() : e) ?? null, o = () => {
    ...
    return ((R = r.getAnchorElement) == null ? void 0 : R.call(r)) ?? S;
  }, a = () => {
    const S = o();
    return !S && !r.getAnchorRect ? null : z2(S, r.getAnchorRect);
  }, n = Object.assign({}, B2, r);
  let l = [], s = null, d, h;
  function u(S) {
    d == null || d(), h == null || h(), s = S, d = n.restoreStyles ? si(S, K2) : void 0;
    const R = S.querySelector("[data-part=arrow]");
    h = n.restoreStyles ? si(R, X2) : void 0, l = [
      N2(R, n),
      q2(n),
      U2(n),
      R2(R, S.ownerDocument, n),
      j2(R),
      T2(
  ...
  let x, C, y = !1, M, P, V = Ei;
  const $ = G2(n.listeners);
  function E() {
    if (!n.listeners) return;
    const S = o(), R = a(), U = i();
    if (!R || !U) return;
    (di(S) !== di(M) || U !== P) && (V(), M = S, P = U, V = x2(R, U, G, $));
  }
  async function N() {
    var w;
    E();
    ...
    const R = a();
    if (!R) return;
    const U = await V2(R, S, {
      placement: m,
      middleware: l,
      strategy: g
    });
    v == null || v(U);
    const K = $t(S), F = li(K, U.x), k = li(K, U.y);
    if (xe(x, F) || (S.style.setProperty("--x", `${F}px`), x = F), xe(C, k) || (S.style.setProperty("--y", `${k}px`), C = k), n.hideWhenDetached && (((w = U.middlewareData.hide) == null ? void 0 : w.referenceHidden) ? (S.style.setProperty("visibility", "hidden"), S.style.setProperty("pointer-events", "none")) : (S.style.removeProperty("visibility"), S.style.removeProperty("pointer-events"))), !y) {
      const T = S.firstElementChild;
      T && (S.style.setProperty("--z-index", Va(T).zIndex), y = !0);
    }
  }
  async function G() {
...
function ol(t, e) {
  ...
  return {
    ...
    getTriggerProps(C = {}) {
      const { value: y } = C, M = y == null ? !1 : u === y, P = Ar(a, y);
      return e.button({
        ...Be.trigger.attrs,
        id: P,
        "data-ownedby": a.id,
        ...
        onClick(V) {
          ...
          const $ = h && y != null && !M;
          o({ type: $ ? "triggerValue.set" : "close", src: "trigger.click", value: y, triggerId: P });
        },
        onFocus(V) {
          if (V.defaultPrevented || f || !lr()) return;
          const $ = h && y != null && !M;
          o({ type: $ ? "triggerValue.set" : "open", src: "trigger.focus", value: y, triggerId: P });
        },
        onBlur(V) {
          if (V.defaultPrevented || f || s !== ct.get("id")) return;
          const $ = V.relatedTarget ?? a.getDoc().activeElement;
          ($ == null ? void 0 : $.closest(`[data-ownedby="${a.id}"]`)) != null || o({ type: "close", src: "trigger.blur", value: y, triggerId: P });
        },
        onPointerDown(V) {
          V.defaultPrevented || f || Wa(V) && n("closeOnPointerDown") && s === ct.get("id") && o({ type: "close", src: "trigger.pointerdown", value: y, triggerId: P });
        },
        onPointerMove(V) {
          if (V.defaultPrevented || f || V.pointerType === "touch") return;
          const $ = h && y != null && !M;
          o({ type: $ ? "triggerValue.set" : "pointer.move", value: y, triggerId: P });
        },
        onPointerOver(V) {
          V.defaultPrevented || f || V.pointerType !== "touch" && o({ type: "pointer.move", value: y, triggerId: P });
        },
        onPointerLeave() {
    ...
    return p`
      <div class=${A(n)} data-component-name="tooltip">
        <button
          ...
          data-scope="tooltip"
          data-part="trigger"
          aria-describedby=${L(e["aria-describedby"])}
          aria-label=${L(this.label || void 0)}
          title=${L(this.label || void 0)}
          data-state=${L(e["data-state"])}
          @click=${e.onClick}
          @focus=${e.onFocus}
          @blur=${e.onBlur}
...
let Ct = class extends H {
  ...
  render() {
    ...
    return p`
      <div
        class=${A(t)}
        data-alert-id=${L(this.identifier || void 0)}
